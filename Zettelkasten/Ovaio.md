...
- Le cisti ovariche da inclusione corticale originano da ==invaginazioni dell’epitelio celomatico== [^1], che successivamente perdono ogni connessione con la superficie.
	- L'epitelio è di solito piatto, ma può essere talvolta cuboidale o colonnare. 
		- Può risultare da una *metaplasia mülleriana* dell’epitelio di superficie ovarico, oppure può derivare dalla ==migrazione di epitelio tubarico o endometriale== alla superficie ovarica.
	- Inoltre, ==in rari casi== si possono repertare nidi di ==epitelio transizionale== (simile all’urotelio) e di ==cellule mucinose==.
	- Le inclusioni epiteliali sono solitamente disperse: quando sono numerose tendono ad aggregarsi in un contesto di stroma ialinizzato.
- **Epidemiologia**
	- Queste lesioni sono comuni in peri- e post-menopausa, ma si possono talvolta osservare in donne giovani e persino in età adolescenziale.
...
##### Cisti follicolari
###### Epidemiologia
- Si osservano ==di solito nella donna in età riproduttiva==, ma possono essere diagnosticate anche in età peri-menopausale e in rari casi in età pediatrica.
- ==Di frequente si associano a irregolarità mestruali==.
###### Eziologia
- La formazione della cisti sembra causata da un ==insufficiente picco di secrezione dell’ormone LH che si ha al momento dell’ovulazione==.
###### Evoluzione
