...
- Le tre isoforme generano NO a partire dalla *L-arginina*
	- reazione $O_2$- e NADPH-dipendente
	- richiede cofattori quali
		- *eme*
		- *tetraidrobiopterina*
		- *FAD*
- Nel caso di nNOS ed eNOS, la sintesi è stimolata da sostanze o processi che determinano
	1. aumento del $Ca^{2+}$ intracellulare
	2. si formano *complessi $Ca^{2+}$-calmodulina*
	3. i complessi si legano a eNOS e nNOS, aumentandone l'attività enzimatica
- D'altro canto, la iNOS non è regolata da ioni $Ca^{2+}$, ma è inducibile:
	1. i mediatori dell'infiammazione inducono l'attivazione trascrizionale del gene iNOS
	2. successivo aumento della popolazione di tale proteina e successiva aumentata sintesi di NO
## Meccanismi di segnalazione
- L'ossido nitrico determina i suoi effetti attraverso il suo legame covalente con le proteine
- I suoi bersagli principali sono tre
### Metalloproteine
- NO ==interagisce coi metalli==, specialmente l'atomo di $Fe$ presente nei gruppi eme
- Interazione con la *guanilil ciclasi* solubile (*sGC*)
	- enzima che genera cGMP a partire da GTP
	1. contiene il gruppo prostetico eme, cui NO si lega prontamente, determinando l'attivazione dell'enzima ed il successivo aumento dei livelli intracellulari di cGMP
	2. il cGMP attiva la *protein chinasi G* (*PKG*), che causa la fosforilazione di proteine specifiche
- Ruolo del cGMP:
	- ↑ cGMP NO-dipendente → ↑ PKG → fosforilazione di specifiche proteine → ↓ $Ca^{2+}$ intracellulare → ==↓ contrazione delle cellule muscolari lisce vascolari== (nei vasi)
	- attivazione dei canali regolati da nucleotidi ciclici, attraverso cui svolge effetti a carico del SNC
- **Citotossicità di NO**
	- riscontrabile in determinati casi:
		- se generato in grandi quantità (es. attivazione macrofagica)
		- se la cellula si trova in condizioni redox sfavorevoli (es. risposta infiammatoria)
	- es. inibisce le metalloproteine coinvolte nella respirazione cellulare (es. *aconitasi* e *citocromo ossidasi*, coinvolte rispettivamente nel *ciclo dell'acido citrico* e nella *catena di trasporto mitocondriale degli elettroni*)
		- questo tipo di reazione contribuisce all'azione battericida dell'[[isoniazide]]
	- l'==inibizione di CYP450== da parte di NO è un meccanismo di primo piano nella patogenesi di malattie epatiche di natura infiammatoria
### Tioli
#### Nitrosilazione
- L'ossido nitrico reagisce coi tioli[^2] per formare *nitrosotioli*
	- nelle proteine, il gruppo tiolico si trova principalmente nella *L-cisteina*
- Questa modificazione post-translazionale, denominata *S-nitrosilazione* o *S-nitrosazione*[^3], richiede la presenza di $O_2$ o metalli (ferro, rame) che fungano da catalizzatori
	- reazione altamente specifica: solo alcune cisteine possono venire nitrosilate
	- può influire sulla funzionalità, stabilità e localizzazione delle proteine bersaglio
- In aggiunta, NO può andare incontro a redox, con formazione di un certo numero di ossidi dell'azoto che possono
	- nitrosilare gruppi tiolici
	- nitrare residui tirosinici
	- essere stabili
#### Proteine attivate
>Sebbene il ruolo fisiologico della nitrosilazione di proteine non sia ancora completamente chiarito, alcune di esse sono degne di menzione
##### H-ras
- Regola la proliferazione cellulare
- Attivato dalla S-nitrosilazione
##### Parkina
- Fattore di trascrizione coinvolto nella degradazione di proteine anomale e nella patogenesi del [[Malattia di Parkinson|morbo di Parkinson giovanile]]
...
- Breve $t_{1/2}$ dovuta alla sua ==elevata reattività con metalli o ROS==
	...
	- questa reazione avviene più facilmente in caso di ridotta tensione di ossigeno, mentre, alle normali pressioni parziali di tale gas, prevale la formazione di *meta-emoglobina*
...
- ==Nitrito d'amile== → **sostanza di abuso per gli effetti euforizzanti**
	- associazione con inibitori delle fosfodiesterasi (es. ==sildenafil== e atri suoi analoghi): può causare **ipotensione anche letale**
...
- Ruolo di primaria importanza nel ==controllo del tono della muscolatura liscia della pressione arteriosa==
	...
	2. l'aumento della sintesi di NO e la sua diffusione nello strato muscolare liscio determina vasodilatazione
...
- Nel corso di infiammazione, sia acuta che cronica, la prolungata o eccessiva produzione di NO può aggravare il danno tissutale
...
- Esempio di risposta determinata dal rilascio di NO da parte dei neuroni NANC
	...
	- ==inibitori della NOS== sono in grado di prevenire l'erezione successiva alla stimolazione del nervo pelvico
