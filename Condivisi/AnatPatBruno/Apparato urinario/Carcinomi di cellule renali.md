...
##### CCR papillare
- ==Alterazioni dei cromosomi 7 e 17==
- ==Perdita del cromosoma Y==
	- meno frequentemente dei cromosomi 8, 12, 16 e 20
##### CCR cromofobo
- Frequenti ==monosomie dei cromosomi 1, 2, 6, 10, 13, 17==
- Perdita del cromosoma Y
## Morfologia
### Carcinoma di cellule chiare
- Il tipo di lesione differisce in base alla forma
	- sporadica → singola, con una certa predilezione per la sede polare
	- familiare → multiple o bilaterali
#### Quadro macroscopico
>[!info]- Aspetto
>La neoplasia si presenta come una **nodosità, talora policiclica**, a margini netti, con aspetti di *crescita espansiva* e presenza di *pseudocapsula*.
>- ![Rene, carcinoma a cellule renali](https://i.imgur.com/WIyNQ19.png)
- Dimensioni da pochi mm a 15 cm
- Colore giallo-oro
	- marezzature grigiastre → fenomeni di ==necrosi==
	- marezzature rossastre → fenomeni di ==emorragia==
- Talora si riscontrano *calcificazioni* e *aspetti cistici*
- Progressione
	- estensione al tessuto adiposo perirenale
		- organi quali surreni
		- rene sx → coda del pancreas e diaframma
	- ==trombosi neoplastica della vena renale e delle sue diramazioni==
		- caratteristica
		- riportata, in alcune casistiche, fino al 45% dei casi
#### Quadro microscopico
> Proliferazione con aspetti solidi, alveolari, trabecolari o acinari
- Stroma interposto
	- scarso
	- fittamente solcato da vasellini a sottile parete
	- in rari casi, più abbondante
		- componente cellulare atipica di tipo sarcomatoide
			- elemento prognostico peggiorativo
- Cellule con *citoplasma chiaro*
	- abbondante contenuto in lipidi e colesterolo, che si dissolvono durante la processazione del materiale
	- ![Rene, carcinoma di cellule chiare.](https://i.imgur.com/DBXe6UI.png)
- Peculiare profilo immunotipico
	- per lo più a basso peso molecolare (*CK8*, *18*, *19*)
	- *vimentina*
		- filamento intermedio proprio delle cellule di origine stromale
### Carcinoma papillare
- Neoplasia singola, ma anche multipla o bilaterale
#### Quadro macroscopico
- Nodosità > 15 mm
	- ben circoscritta
	- con focolai di necrosi, emorragia e involuzione cistica
#### Quadro microscopico
- Papille dotate di un esile asse stromale
	- numerosi macrofagi con citoplasma schiumoso
	- rivestite da cellule epiteliali
		- in alcuni casi piccole, con scarso citoplasma
		- in altri casi ampie, con citoplasma intensamente eosinofilo e nuclei atipici
##### Carcinoma papillare a cellule chiare
- Sporadicamente associato alla sindrome di von Hippel-Lindau
- Presenza di **strutture papillari e tubulari** di cellule epiteliali chiare con scarse atipie nucleari
