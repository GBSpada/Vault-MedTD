...
# Patologie autosomiche e legate a cromosomi sessuali: mendeliane
## Patologie autosomiche
### Dominanti
#### Acondroplasia
##### Clinica
- Mancata trasformazione della cartilagine in tessuto osseo 
- Genotipo AA incompatibile con la vita
###### Aspetti fenotipici
- Possibile restringimento del forame magno e compressione del tronco encefalico (10% dei casi)
- Accorciamento rizomelico di braccia e gambe ([[Talidomide]])
- Genu varum 
- Game of thrones
##### Mutazione
- FGFR3 sul ==cromosoma 4==:
	- Recettore del fattore di crescita dei fibroblasti
	-  Sostituzione di una glicina con un arginina
- In caso di coinvolgimento di altri domini, in:
	- ==Displasia tanatoforica==
	- ==Ipocondroplasia==

###### Ereditarietà
- Spesso mutazione de novo nella linea germinale paterna
#### Ipercolesterolemia familiare
##### Mutazione
- Recettore per la captazione delle LDL sul cromosoma 19
##### Clinica
###### Iperlipoproteinemia
- Manifestazioni
	- Colesterolemia tra 300 e 500
	- Aterosclerosi
	- Arco corneale e xantomi tendinei
- Altri geni molto importanti nella diagnosi
	- **PCSK9**
		- Codifica per una convertasi capace di indirizzare il recettore delle LDL alla degradazione
	- **LDLRAP1**
		- Codifica per una proteina coinvolta nell'internalizzazione del recettore delle LDL nelle vescicole rivestite
#### Retinoblastoma
- Tumore oculare
	- Penetranza del 90%
#### Malattia del rene policistico o ADPKD
- Si osserva un progressivo accumulo di cisti renali
	- Oltre ad esse si possono sviluppare cisti epatiche, ipertensione, aneurismi cerebrali e difetti delle valvole cardiache
##### Mutazioni
- Possono essere sia sul gene PKD1 sul cromosoma 16, sia sul PKD2 sul cromosoma 4
	- [[Fenomeni che complicano l'ereditarietà#Eterogeneità del locus]]
	- Questi geni codificano per glicoproteine (policistine) che attraversano la membrana e sono coinvolte nelle vie di segnalazione cellulare
>[!warning] Nota bene - Modello dei due colpi :
> Entrambi gli alleli in PKD1 o PKD2 devono perdere funzionalità contemporaneamente affinché si formino le cisti
...
Nel 30-50% dei maschi portatori e nell'80-90% delle femmine portatrici, la malattia non provoca cecità completa, ma può causare una significativa riduzione del campo visivo.

###### Recupero dell'Acutezza Visiva

Il miglioramento del campo visivo è solitamente parziale, ma il recupero dell'acutezza visiva può essere sorprendente.

##### Trattamento e Supporto

Attualmente, non esiste una cura per la LHON, ma ci sono opzioni di trattamento per il sollievo dei sintomi e il supporto visivo.

###### Ausili per la Vista

Gli ausili per la vista sono il trattamento sintomatico di elezione per i pazienti affetti da LHON.

###### Composti per il Recupero Visivo

Sono stati identificati alcuni composti che possono favorire il recupero visivo nei pazienti affetti da LHON.

###### Trasmissione della Malattia

Poiché la LHON è una malattia a trasmissione materna, le donne portatrici possono trasmettere la mutazione a tutti i loro figli, mentre i maschi portatori non trasmettono la malattia.
### Recessive
#### Albinismo
##### Clinica
- Oculocutaneo oppure oculare
##### Mutazione
- Non unica ma la principale è quella della ==tirosinasi==
	- Non può più trasformare la ==tirosina in dopachinone e in melanina==
- In realtà i geni implicati sono molteplici
###### Cromosoma
- 11
#### Fibrosi cistica
##### Clinica
- Disfunzione polmonare e pancreatica
	- Ostruzione intestinale
		- Meconio ritardato
	- Insufficienza respiratoria
		- Suscettibilità ad infezioni croniche
	- Malattia epatica
##### Mutazione
- Gene ==CFTR==: 
	- Cystic fibrosis transmembrane conductance regulator
###### Classi di mutazioni
- Una riduce la funzionalità delle proteine sulla superficie cellulare
- L'altra riduce la quantità di proteine funzionali che raggiungono l'epitelio
	- Le 1, 2, 3 implicano ==presenza o assenza del recettore== e sono le più gravi
	- Le 4,5 sono associate a un fenotipo più lieve
###### Cromosoma
- 7
##### Terapia
- Lumacaftor
...
- Osteomalacia/rachitismo (adulti/bambini)
- Ipofosfatemia
- Deficit riassorbimento del calcio 
- Non responsivo alla vitamina D
#### Sindrome di Rett
- Colpisce lo sviluppo neurologico ma non è neurodegenerativa
##### Clinica
- Rallentamento della crescita
- Perdita di abilità manuali acquisite in precedenza
- Perdita di impegno sociale
- Cambiamento del linguaggio
- Spesso letale nei maschi
##### Mutazione
- Geni
	- MECP2
		- ==Lettore di metilazione==
		- Interviene nella lettura di errori derivanti da metilazioni
	- CDKL5
	- FOXG
##### Ereditarietà
- Spesso generata da mutazioni de novo
...
##### A
###### Mutazione
- A carico del fattore VIII della coagulazione
- Due possibili casi
	- Inversione cromosomica che distrugge tutto il fattore VII: ==grave==
	- Delezioni: ==lieve==
##### B
###### Mutazione
- A carico del fattore IX della coagulazione

##### Terapia
- Anticorpo monoclonale
- Somministrazione dei fattori

#### Malattia di Duchenne
##### Clinica
- Si manifesta intorno ai 5 anni nelle forme più gravi
- Progressiva perdita di forza muscolare causata da disgregazione del tessuto
- Il bambino presenta il [[Segno di Gowers]]
- Pseudoipertrofia dl polpaccio per infiltrazione di grasso e connettivo
##### Gene
- Gene della distrofina DM, alterazione frameshift
	- 79 esoni che codificano per un trascritto di 14 kilobasi
- Codifica per un complesso che lega glicoproteine che stanno sulla membrana cellulare a quelle che stanno nel citoplasma
#### Distrofia di Becker
- Meno grave di quella di duchenne, alterazione in frame
	- La distrofina è presente in quantità ridotta, non è assente 
- Insorge in adolescenza
#### Daltonismo 
#### Favismo
#### Malattia di Fabry
