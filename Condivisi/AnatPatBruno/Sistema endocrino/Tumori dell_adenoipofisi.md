...
- *Consistenza molle* e *colorito biancastro*
	...
	- frequente riscontro di ==emorragie==
		...
		- talora assumono particolare imponenza → distruzione della compagine tumorale
			- ![Ipofisi, voluminoso adenoma ipofisario non secernente, con emorragia intraparenchimale. Tale evenienza (cosiddetta **apoplessia**) causa un improvviso e grave aumento di volume e, quindi, della pressione endocranica.](https://i.imgur.com/vdLbojf.png)
### Quadro microscopico
#### Cellularità
...
3. Maggiore capacità espansiva verso le pareti e il fondo della sella:
	...
	2. eventuale penetrazione in
		...
		- epifaringe
		- cavità nasali
### Manifestazioni cliniche legate alla produzione di specifici ormoni
- Adenomi multiormonali
	- producenti più ormoni
- Adenomi producenti un unico ormone
#### Adenomi secernenti prolattina
- Più frequenti
- Costituiti da **cellule debolmente acidofile** o **cromofobe** (dotate di scarsi granuli secretori)
##### Sintomi
- La loro intensità è correlata ai livelli di ==prolattinemia==
###### Amenorrea
###### Galattorrea
###### Perdita di libido
###### Infertilità
##### Diagnosi
- I sintomi permettono una diagnosi relativamente precoce in donne in età premenopausale
	- in donne più anziane e negli uomini, sono più sfumati → diagnosi fatta tardivamente
- Riconoscimento basato anche sulla presenza di **calcificazioni**
	- anche massive
	- riscontrabili all'esame radiologico
##### Altre cause di iperprolattinemia
- Interferenza con la normale inibizione della produzione di prolattina da parte del nucleo ipotalamico producente PIF (dopamina)
	- cause
		- danno dei neuroni dopaminergici
		- compressione del peduncolo da parte di altre neoplasie
			- intorno al quale passano i vasi portali
	- l'==effetto inibitorio della dopamina== persiste anche nelle cellule tumorali
		- vengono bloccate funzionalmente
		- vanno incontro a regressione in seguito a trattamento con la ==*bromocriptina*==
			- azione agonista sui recettori dopaminergici
#### Adenomi producenti ormone adrenocorticotropo
- Costituiti da cellule basofile
	- immunoreattive per *ACTH*, *endorfina* e *lipotropina*
- Tumori piccoli
	- diametro di ca. 0,5 cm
	- responsabili delle manifestazioni cliniche della [[sindrome di Cushing]]
#### Adenomi producenti ormone della crescita (GH)
- Costituiti da
	- **cellule intensamente acidofile**
		- ricche di granuli secretori
	- **cellule debolmente acidofile** (o **cromofobe**)
		- scarsi granuli
		- debole reattività alla colorazione immunoistochimica per il GH
- ==Adenomi mammo-somatotropi==
	- alcune lesioni mostrano doppia reattività immunoistochimica per GH e prolattina
##### Presentazione
- Sottoforma di micro- o macroadenomi
	- gli ultimi sono invasivi di
		- osso
		- meningi
		- seni cavernosi
##### Manifestazioni cliniche
- ==Gigantismo== in soggetti giovanili
- ==Acromegalia== in soggetti adulti
##### Decorso clinico
