...
- Lega ca. il 90% dell'ormone circolante
	- il rimanente è libero (ca. il 5-10%) o legato in maniera labile all'*albumina* (ca. il 5%) e rappresenta la quota di ormone biologicamente attiva
...
4. In forma di omodimero, interagisce con
	...
	2. altri recettori formanti complessi influenzanti la funzione di altri fattori di trascrizione (*AP1* e *NF-κB*)
...
- **CLOCK**: acetiltrasferasi che acetila la regione cerniera (tra dominio di legame al DNA e quello d'interazione col ligando) del GR
...
##### Risultati
- Si rilevano in massimo grado durante lo stato di digiuno → maggiore apporto di glucosio al cervello:
...
>[!info]
>La produzione di *anticorpi* è ridotta da forti dosi di glucocorticoidi, ma non è interessata da dosi modeste (es. 20 mg/die di ==prednisone==).
##### Effetti sui vasi
- ==Vasocostrizione== quando applicati direttamente sulla cute
	- probabilmente per ==inibizione della degranulazione di mastociti tissutali==
- ==↓↓ permeabilità vascolare==
	- riduzione della quantità di istamina rilasciata da basofili e mastociti
#### Altri effetti
##### SNC
- Insufficienza corticosurrenalica
	- **marcato rallentamento del ritmo α dell'EEG**
	- **depressione**
- Elevati livelli di glucocorticoidi
	- **disturbi comportamentali** (inizialmente insonnia ed euforia, poi depressione)
	- elevati dosaggi
		- aumento della pressione endocranica (*pseudotumor cerebri*)
		- soppressione della secrezione ipofisaria di
			- ACTH
			- GH
			- TSH
			- LH
##### Stomaco
- Dosi elevate sono state associate allo sviluppo di [[Gastrite#Gastrite da Zettelkasten/Helicobacter pylori H. pylori|ulcera peptica]]
	- forse per la soppressione della risposta immune locale nei confronti di [[Helicobacter pylori|H. pylori]]
##### Tessuto adiposo
- Promozione della ridistribuzione del grasso corporeo
	- ↑↑ a livello viscerale, facciale, nucale e sopraclavicolare
##### Ossa
- Antagonismo verso l'effetto della *vitamina D* sull'assorbimento del $Ca^{2+}$
##### Sistema emopoietico
- ↑↑ piastrine ed eritrociti
##### Rene
- ↓↓ funzione renale
	- in particolare della filtrazione glomerulare
- ↑↑ secrezione di *vasopressina*
- ↓↓ capacità di eliminare un carico d'acqua
##### Sviluppo del polmone fetale
- Stimolano le modifiche strutturali e funzionali verso il termine della gravidanza
	- inclusa la produzione di *surfattante*
## Glucocorticoidi di sintesi
>[!info]- Attività, posologia e impieghi
>![Steroidi corticosurrenalici e antagonisti: attività, posologia e impieghi di alcuni glucocorticoidi naturali e sintetici di impiego corrente.](https://i.imgur.com/GlDfq4E.png)
#### Farmacocinetica
##### Fonti
- Le preparazioni farmaceutiche sono, in genere, sintetizzate a partire da
	- *acido colico* (ottenuto a partire dal bestiame)
	- *sapogenine steroidee* (in alcune piante)
- Ulteriori modificazioni di questi steroidi hanno portato all'immissione sul mercato di un numeroso gruppo di steroidi di sintesi con particolari caratteristiche di interesse farmacologico e terapeutico
##### Destino
- I corticosteroidi di sintesi[^5] sono, nella maggior parte dei casi, assorbiti rapidamente e completamente quando dati *per os*
	- sebbene siano veicolati e metabolizzati in maniera simile agli steroidi endogeni, presentano importanti differenze rispetto ad altri
- Modifiche nella molecola
	- influenzano
...
#### Effetti sfavorevoli
- Tossicità nettamente inferiore al mitotano
...
- Somministrato *per os* a molti pazienti con [[sindrome di Cushing]] da produzione ectopica di ACTH o carcinoma corticosurrenalico, è stato in grado di
	...
	- correggere la soppressione tiroidea e gonadica
	- migliorare il quadro dei disturbi psichici
- Attualmente, l'uso è indicato solo nei pazienti inoperabili con ==secrezione ectopica di ACTH== o con ==carcinoma corticosurrenalico== che non hanno risposto ad altri tipi di trattamento
	- per questo scopo, autorizzato dalla FDA
### Mitotano
- Composto correlato alla classe di insetticidi DDT, ha proprietà adrenolitiche
- Ritirato dal commercio USA, ma disponibile per uso compassionevole[^6]
#### Usi clinici
- Somministrato *per os* in dosi frazionate, fino a un massimo di 12 g/die
- Ca. 1/3 dei pazienti con [[carcinoma corticosurrenalico]] risponde con una riduzione della massa tumorale
#### Effetti sfavorevoli
- Nell'80% dei pazienti, gli effetti sono tali da richiedere una riduzione dei dosaggi
- Si osservano diarrea, nausea, vomito, depressione, sonnolenza ed eruzioni cutanee
### Pasireotide
- *Analogo somatostatinico* particolarmente attivo sul *recettore 5 della somatostatina* espresso su [[Adenoma corticosurrenalico|adenomi corticotropi]] in pazienti con sindrome di Cushing
- Studi:
	- avendo come *end point* il tasso di cortisolo urinario, si è avuta la normalizzazione in 6 mesi nel 20% di partecipanti ad uno studio di fase III
	- i migliori risultati terapeutici sono stati ottenuti con una dose giornaliera di 900 $\mu$g
- Registrato come un farmaco orfano per i casi non sottoponibili a chirurgia o in cui questa si è rivelata inutile
- Effetti sfavorevoli più caratteristicamente rivelati: **iperglicemia** e **sofferenza epatica**
## Antagonisti dei mineralcorticoidi
- Il *progesterone* ha una debole attività in tal senso
### Spironolattone
- Un *7α-acetiltiospironolattone*
- ![Spironolattone](https://i.imgur.com/exM9KIo.png)
#### Meccanismo d'azione
- Inizio lento: gli effetti durano 2-3 gg dopo che il farmaco è sospeso
#### Usi clinici
##### Diagnostico
- Trovato utile per precisare la diagnosi in molti pazienti e migliorare segni e sintomi qualora la rimozione chirurgica dell'[[Adenoma corticosurrenalico|adenoma]] sia ritardata
