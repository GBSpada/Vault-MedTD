...
- Le strutture presenti possono essere variamente interessate dall'infiltrato
...
- Spesso si giunge alla diagnosi mediante il rilievo accidentale di alterazioni ematochimiche per esami routinari o per altra patologia
###### Estremo aggravarsi col progredire verso la cirrosi
- Estrema astenia
- Anoressia
- Calo ponderale
- Disturbi gastrointestinali
- Sintomi extraepatici, con coinvolgimento di altri organi e apparati (reni, cute e articolazioni), fino all'==encefalopatia epatica==
- **Emoftoe** per rottura di varici esofagee
	- episodio di particolare rilievo clinico
	- fortemente ridotto dall'esofagoscopia diagnostica
##### Alterazioni biochimiche
- Aumento delle [[Patologia clinica - Fegato#Marcatori di citolisi|aminotransferasi sieriche]] e delle fosfatasi alcaline
#### Grado di attività
- Esprime l'entità dell'infiammazione e del danno epatocitario
	- lieve, moderata o intensa
- Elementi determinanti:
	- **necrosi della lamina limitante**
	- **necrosi intracinare**
##### Sistemi di valutazione
###### Knodell (1981)
- ![Fegato, stadiazione della fibrosi.](https://i.imgur.com/IpuOFxf.png)
- Lo stadio della fibrosi ne esprime l'estensione e, di conseguenza, l'alterazione dell'architettura epatica e lo stadio di avvicinamento dell'epatite verso la cirrosi
	- la stadiazione si esegue con l'analisi dell'*impregnazione argentica*, che ben evidenzia i setti fibrosi e il livello di alterazione dell'architettura epatica
###### Desmet (1994)
- ![Fegato, indice di attività e correlazione tra grado di attività e definizione dell'epatite (Desmet, 1994).](https://i.imgur.com/9GbUoJP.png)
###### Ishak (1995)
- ![Fegato, indice di attività nelle epatiti croniche (Ishak, 1995).](https://i.imgur.com/egzeKSi.png)
###### Bedossa (1996)
- Partendo dall'esperienza maturata nell'applicazione dei vari sistemi di valutazione semiquantitativa nella pratica clinica, si è evidenziato come **non esista uno schema valido per tutte le epatiti**
- Ha proposto un algoritmo valido per graduare l'attività nelle epatiti da virus C
- ![Fegato, algoritmo per la valutazione istologica dell'attività nell'epatite da virus C (Bedossa, 1996).](https://i.imgur.com/6RgqK0c.png)
### Epatite cronica autoimmune
>[!info]
> L'epatite autoimmune è una malattia cronica, caratterizzata dalla persistenza per oltre 6-12 mesi di necrosi epatocitaria, risultato di un attacco immunologico cellulo-mediato diretto contro le cellule epatiche.
- Una delle molteplici entità costituenti lo spettro delle malattie autoimmuni del fegato (**Autoimmune Liver Desease**, **AILD**)
	- assieme a ==colangite biliare primitiva== (==PBC==), ==colangite sclerosante primitiva== (==PSC==), ==colangite autoimmune== (==AIC==) e la ==malattia epatica da IgG4== (==IgG4-RSC==)
	- non sono rare le sindromi da overlap
		- ![Epatite cronica autoimmune, schema della sindrome da overlap](https://i.imgur.com/zBJQNyI.jpeg)
#### Eziopatogenesi
##### Predisposizione congenita
##### Fattori ambientali
#### Morfologia
- Quadro istologico caratterizzato da un'attività di grado elevato con
	- ==infiltrato linfocitico periportale==
	- ==peripolesi==
	- ==necrosi epatocitaria==
	- N.B. ciò non vale in ambito pediatrico, in cui il grado di attività è, spesso, lieve-moderato
- Casi più gravi
	- epatite panacinare
	- necrosi confluente in ponti che uniscono tra loro le varie formazioni vascolari
- Segni contraddistintivi
	- **plasmacellule nell'infiltrato infiammatorio**
		- soprattutto se aggregate in gruppi e localizzate in stretto contatto con la lamina limitante periportale o perisettale
		- ![Fegato, plasmacellule in cluster suggestiva per eziologia autoimmune. CD138.](https://i.imgur.com/PbOnczy.png)
	- **epatociti giganti multinucleati**
		- occasionalmente
		- ![Fegato, epatite a cellule giganti multinucleate](https://i.imgur.com/HhN0pXE.png)
	- aspetti marcati di necrosi perivenulare
>[!warning]
> L'osservazione di cluster di plasmacellule nel tessuto bioptico di pazienti con epatite virale (di qualunque origine) va segnalata: si può avere sovrapposizione tra le due entità, in quanto l'epatite virale può essere causa scatenante di una reazione autoimmune.
#### Correlazioni anatomocliniche
- Quadro clinico simile a quello delle epatiti croniche virali
##### Decorso
...
##### Forme
- Sempre più frequente l'osservazione di "forme atipiche"
###### Tipo 1
- Forma più comune
- Anticorpi SMA (anti-muscolo liscio) e/o ANA
- Donne sui 40 anni
- Manifestazione d'esordio come epatite acuta
###### Tipo 2
- Anticorpi anti-LKM1
- Prevalentemente bambini tra i 12 e i 14 anni
	- frequentemente associata a ==tiroidite==
###### Tipo 3
- Anticorpi anti-SLA/LP (*Solubile Liver Antigen/Liver Pancreas*) contro le citocheratine 8 e 18
- Prevalentemente donne sui 40
## Infezioni batteriche e infestazioni parassitarie ed elmintiche
>[!info]
> Piuttosto rare nei Paesi occidentali. La manifestazione più comune è rappresentata dall'*ascesso epatico* e, più raramente, da infezioni granulomatose o diffuse. 
### Ascesso epatico
#### Eziologia
