...
---
# Farmacologia
- Fin dalla loro introduzione negli anni '80, hanno assunto rapidamente un ruolo di scelta nel trattamento delle patologie acido-peptiche
## Chimica e farmacocinetica
### Struttura
- Quelli disponibili per l'uso sono sei: ==omeprazolo==, ==lansoprazolo==, ==rabeprazolo==, ==pantoprazolo==, ==esomeprazolo== e ==dexlansoprazolo==[^1]
	- sono tutti *benzimidazoli sostituiti*, simili, per caratteristiche strutturali, agli [[Antagonisti dei recettori per l'istamina (antistaminici)#Antagonisti ai recettori H$_2$|H2-antagonisti]]
	- nello specifico:
		- omeprazolo e lansoprazolo sono *miscele racemiche di R- e S-isomeri*
		- esomeprazolo = *S-isomero* dell'omeprazolo
		- dexlansoprazolo = *R-isomero* del lansoprazolo
- ![Bloccanti di pompa protonica: strutture molecolari.](https://i.imgur.com/5S5j4IM.png)
### Farmacocinetica
#### Somministrazione
- Sono tutti disponibili in ==forme farmaceutiche per la somministrazione orale==
	- esomeprazolo, pantoprazolo ed omeprazolo sono anche disponibili per IV
- Raggiungimento del circolo:
	1. sono tutti *==profarmaci==*
		- (inattivi come tali)
		- ==acido-labili== → capsule/compresse, a rilascio ritardato, con *rivestimento enterico gastro-resistente*
		- bambini V pazienti disfagici V pazienti intubati per la nutrizione enterale
			- le capsule possono essere aperte
			- i microrganuli possono essere miscelati con
				- succo di mela o arancia
				- alimenti molli (es. purea di mela)
	2. dopo che i microrganuli sono passati attraverso lo stomaco ed hanno raggiunto il lume intestinale, ==l'ambiente alcalino scioglie il rivestimento enterico==
	3. assorbimento
- Ulteriori formulazioni:
	- ==lansoprazolo==: *compresse che si disgregano* nel cavo orale o che possono essere messe in acqua e somministrate con una siringa orale od un tubo enterale
	- ==omeprazolo==:
		1. disponibile anche in polvere senza rivestimento enterico (*capsule* o *bustine*), associato a $NaHCO_3$ (1100-1680 mg o 304-460 mg di $Na^+$) → protezione dalla degradazione
		2. la ==sospensione risultante== quando la polvere viene messa in acqua determina un =="rilascio immediato"== del farmaco
		3. rapido assorbimento ($T_{max}$ < 30 min) e rapido inizio dell'inibizione
#### Diffusione
- Essendo ==basi deboli== ($pK_a$ 4-5) ==lipofile==, post assorbimento intestinale ==diffondono facilmente== attraverso le membrane lipidiche nei compartimenti acidi
1. Nei canalicoli secretori[^2] delle cellule parietali
	- diventano in brevissimo tempo protonati
	- sono concentrati più di 1000 volte per *intrappolamento ionico* (secondo l'[[Introduzione - farmacologia#Ionizzazione di acidi e basi deboli; l'equazione di Henderson-Hasselbalch|equazione di Henderson-Hasselbalch]])
	- sono soggetti rapidamente ad una trasformazione molecolare in *cationi sulfonamidici*[^3]
		- altamente reattivi coi *gruppi sulfidrilici*
		- costituiscono le ==forme attive==
2. Le sulfonamidi reagiscono con l'ATPasi $H^+/K^+$-dipendente
	- formano un *legame covalente disulfuro*
	- ==inattivano irreversibilmente l'enzima==
...
>[!info]
>Agenti più efficaci nel trattamento della GERD, delle complicanze esofagee (stenosi peptica o [[esofago di Barret]]) e delle manifestazioni extraesofagee della patologia da reflusso.
...
## Azioni sfavorevoli
### Generali
- Farmaci dall'==elevato profilo di sicurezza==
...
>[!info]
>Una commissione consultiva costituita *ad hoc* dalla FDA è arrivata alla conclusione che non vi siano prove definitive che la terapia a lungo termine produca gastrite atrofica multifocale o metaplasia.
