...
>[!info]
> Usata in pazienti con neoplasie localizzate che non rispondono completamente alla chirurgia o altre terapie ad azione locale.
...
- Purtroppo, la maggioranza dei tumori solidi umano non cresce esponenzialmente: andrebbe applicato un **modello Gompertziano di crescita e regressione**:
	- ==la frazione di crescita non è costante, ma diminuisce esponenzialmente nel tempo==
...
- In molti casi, è dovuto all'instabilità genomica dei tumori
	...
	- es. mutazioni nei [[Mutazioni e sistemi di riparazione del DNA#Sistemi di riparazione del DNA|sistemi di riparazione del DNA]], correlate con lo sviluppo di neoplasie del colon sporadiche o familiari (vedi [[Carcinoma colorettale#Sindromi poliposiche geneticamente determinate|qui]]) → resistenze a ==fluoropirimidine==, ==tiopurine==, ==derivati del Pt==
### Acquisita
...
- Altre indicazioni:
	- ==[[Linfoma-leucemia linfoblastica acuta (ALL)|ALL]] in ricaduta o refrattaria==
	- ==leucemia eosinofila cronica==[^2]
	- ==dermatofibrosi==
>[!warning]
>Sia nella LMC che nel GIST non è consigliabile l'impiego dell'imatinib a dosi di 600-800 mg al dì, essendo la dose standard di 400 mg.
##### Dasatinib
- Inibitore di numerose chinasi, tra cui *BCR-ABL*, *SRC*, *c-kit* e *PDGFR-α*
- Anch'esso disponibile *per os*
###### Usi clinici
- Indicato nel trattamento di
	- ==LMC resistenti o refrattarie ad altre terapie== (imatinib compreso)
	- ==ALL== con cromosoma Filadelfia resistenti a imatinib
>[!warning]
>Non è raccomandato dal NICE in quei pazienti con LMC in fase cronica che non hanno ricevuto terapie precedenti.
##### Nilotinib
- *Fenilamino-pirimidina* di seconda generazione che inibisce i domini tirosinchinasici di *BCR-ABL*, *c-kit* e *PDGFR-β*
- Rispetto a imatinib, è ca. 20-50 volte più affine alla chinasi ABL
	- riesce ad inibirla anche nel caso di mutazioni imatinib-resistenti
	- importante opzione per un impiego di prima linea nella ==fase cronica della LMC== con resistenza o intolleranza a precedente terapia con imatinib
###### Metabolismo
- Come anche imatinib e dasatinib, è metabolizzato nel fegato, principalmente dal *CYP3A4*
	- eliminati principalmente con le feci attraverso le vie biliari
	- prima di iniziare la terapia, è importante accertare se il paziente stia assumendo altri farmaci che potrebbero interferire
		- **non ingerire** succo di pompelmo o erba di San Giovanni (vedi [[Biotrasformazione dei farmaci#CYP3A|qui]])
##### Ponatinib
- Inibitore tirosinchinasico registrato più recentemente
- Interessante per la sua capacità di esplicare azione terapeutica anche in pazienti con
	- LCM Ph+ resistenti ad altri inibitori tirosinchinasici
	- la mutazione BCR-ACR T3151
	- ALL Ph+ poco o per nulla sensibile ad altri inibitori tirosinchinasici
###### Effetti collaterali
- **[[Pancreatite]]**: più frequente, controllabile
- **Rischi trombotici e cardiovascolari** tali da indurre la FDA a sospenderne la commercializzazione
#### Gefitinib ed erlotinib (ed altri inibitori)
##### Gefitinib ed erlotinib
- Inibitori a basso peso molecolare del dominio tirosinchinasico di *EGFR*
###### Usi clinici
- Entrambi indicati nel trattamento di [[Vie aeree#Tumori polmonari|tumori polmonari non a piccole cellule]] (NSCL) localmente avanzati o metastatizzati, con mutazione attivante di EGFR
	- ==erlotinib== è anche indicato nel carcinoma polmonare NSCL localmente avanzato o metastatizzato che
		- ha fallito almeno una prima linea chemioterapica
		- si mantiene stabile dopo 4 cicli di una chemioterapia standard a base di [[Agenti alchilanti#Composti del platino|Pt]]
- ==Erlotinib== in associazione con [[Antimetaboliti#Gemcitabina|gemcitabina]], è indicato anche per il trattamento del [[Carcinoma pancreatico|carcinoma pancreatico avanzato]]
###### Farmacocinetica
- Entrambi sono metabolizzati dal *CYP3A4* ed eliminati prevalentemente con le feci attraverso le vie biliari
	- è necessaria cautela quando sono somministrati assieme ad altri farmaci metabolizzati dal sistema citocromiale epatico (es. ==fenitoina== e ==warfarin==)
	- anche l'uso di succo di pompelmo dovrebbe essere evitato
###### Effetti avversi
- Reazioni cutanee acneiformi
- Diarrea
- Anoressia
- Senso di affaticamento
##### Everolimus
- Raccomandato nel [[Carcinomi di cellule renali|carcinoma renale]] in progressione malgrado terapie antiVEGF
- Indicato in ==tumori neuroendocrini del pancreas== bene o moderatamente
	- differenziati, inoperabili o metastatizzati
	- specie in associazione all'==ocreotide==
- Utilizzato nel [[Carcinoma della mammella|carcinoma mammario]] metastatizzato HER2- e con stato recettoriale ormonale positivo
	- in combinazione con ==exemestane==
##### Lapatinib
- Consigliato per ==neoplasie del seno in fase avanzata o metastatizzante== in pazienti che sovraesprimono *HER2/neu*
- Associabile con ==capecitabina==
	- per pazienti precedentemente trattate con un'[[Antibiotici antitumorali#Antracicline|antraciclina]], un [[Prodotti naturali con attività antineoplastica#Tassani e farmaci correlati|tassano]] o [[Anticorpi monoclonali (MAB)#Trastuzumab|trastuzumab]]
	- per donne in post menopausa in associazione con un ==inibitore dell'aromatasi==
- Risultati particolarmente favorevoli sono segnalati per l'associazione ==trastuzumab-lapatinib==
##### Regorafenib
###### Meccanismo d'azione
- Piccola molecola inibente una serie di chinasi legate a membrane o intracellulari
	- RET, VEGFR-1-2 e -3, KIT, PDGFR-α e -β, TIE2, DDR2, Trk2A, Eph2A, RAF-1, B-RAF, B-RAFV600E, SAPK2, PTK5 e Abl
	- la stessa inibizione può essere dai suoi due metaboliti M-2 e M-5
###### Usi clinici
- Consigliato per via orale per il trattamento di seconda o terza linea di pazienti con [[Carcinoma colorettale|carcinoma colorettale]] metastatizzato
	- precedentemente trattati con chemioterapia basata su fluoropirimidine, oxaliplatino e [[Prodotti naturali con attività antineoplastica#Irinotecan|irinotecan]] (fattore anti-VEGF)
	- può estendere la OS di tali pazienti e la PFS[^3] di pazienti con GIST non resecati o metastatizzati dopo trattamento con imatinib
	- i benefici sono modesti in termini di sopravvivenza
###### Somministrazione
- Dosaggio raccomandato: 160 mg (4 compresse da 40 mg) una volta al dì
	- con colazione povera di grassi
- L'assunzione deve avvenire per i primi 21 gg di un ciclo di 28 gg
###### Azioni sfavorevoli
- In almeno il 30% dei pazienti: affaticabilità, perdita di peso, anoressia, diarrea, disfonia, sindrome palmoplantare, infezioni, mucositi, ipertensione e perdita di peso
- Più serie: **emorragie**, **perforazioni gastrointestinali** ed **epatotossicità grave**
##### Temsirolimus
- Inibitore di proteinchinasi approvato per il trattamento di prima linea del ==carcinoma renale in fase avanzata== e per il [[linfoma mantellare]]
- Dà, dopo infusione endovena, serie [[Immunofarmacologia#Reazioni immunitarie ai farmaci e farmacoallergia|reazioni di ipersensibilità]]
##### Vemurafenib
- Inibitore BRAF autorizzato per il trattamento di [[melanoma]] inoperabile o metastatizzato positivo per la mutazione BRAFV600
#### Inibitori tirosinchinasici anti-VEGF e bevacizumab
- Tra le strategie adottate vanno ricordate
	- inibizione del legame di VEGF al suo recettore (tramite anticorpi anti-VEGF o proteine chimeriche recettoriali solubili)
	- inibizione del dominio tirosinchinasico del recettore (attraverso inibitori a basso peso molecolare)
##### Bevacizumab
- Anticorpo monoclonale umanizzato che lega tutte le forme di VEGF-A e ne impedisce il legame ai recettori bersaglio
###### Usi clinici
- Può essere associato a [[Antimetaboliti#5-Fluorouracile|5-FU]], [[Agenti alchilanti#Oxaliplatino|oxaliplatino]] e [[Prodotti naturali con attività antineoplastica#Irinotecan|irinotecan]] nel trattamento del ==cancro colorettale metastatizzato==
	- con buona efficacia e tollerabilità
	- per lo stesso tumore, è formalmente approvata l'associazione del bevacizumab con un qualsivoglia schema terapico contenente fluoropirimidine
- Approvato in associazione a chemioterapia per il trattamento del ==carcinoma mammario== o ==polmonare NSCLCL metastatizzato==
###### Effetti sfavorevoli
- I principali variano da **ipertensione** a **eventi tromboembolici arteriosi** (attacchi ischemici transitori, angina, infarto del miocardio), **disturbi della cicatrizzazione**, **perforazioni gastrointestinali**, **proteinuria**
##### Axotinib
- Inibitore del dominio tirosinchinasico dei recettori per VEGF (VEGFR-1, VEGRF-2, VEGRF-3)
- Indicato nel ==carcinoma renale==
###### Effetti collaterali
- Ipertensione, nausea, anoressia, diarrea, stipsi, affaticamento, disfonia, sindrome palmo-plantare, convulsioni a volte fatali, emottisi
##### Pazopanib
- Imidazolpirimidina che inibisce numerose chinasi di recettori, in particolare *VEGF-R2* e *VEGF-R3*, *PDGFR-β* e *RAF*
###### Usi clinici
- Somministrabile per os e approvato per il trattamento di prima linea del ==carcinoma renale avanzato==
- Buona opzione per pazienti con ==sarcomi delle parti molli non adipocitici o GIST==
###### Effetti sfavorevoli
- **Diarrea**, **perdita di peso e dell'appetito**, **nausea** e **vomito** sono stati più frequentemente ed intensamente superiori a quelli rilevati nei controlli
##### Sorafenib
- Inibitore a basso peso molecolare di numerose chinasi di recettori, tra cui *VEGF-R2* e *VEGF-R3*, il *PDGF-β* e *RAF*
- Inizialmente approvato per il ==carcinoma renale avanzato o metastatizzato==, fu approvato anche per il trattamento del ==carcinoma epatocellulare in fase avanzata==
##### Sunitinib
- Simile a sorafenib, ma inibisce *PDGFR-α* e *PDGFR-β*, *VEGFR1*, *VEGFR2*, *VEGFR-3* e *c-kit*
###### Usi clinici
- Approvato in
	- carcinoma renale avanzato
	- sarcomi gastrointestinali (GIST) in progressione dopo fallimento di imatinib ed in caso di intolleranza a questo
	- tumori pancreatici neuroendocrini inoperabili o metastatizzati
###### Farmacocinetica
- ==Pazopanib==, ==sorafenib== e ==sunitinib== sono metabolizzati dal *CYP3A4* ed eliminati con le feci attraverso le vie biliari
###### Effetti collaterali
- Tutti e tre possono portare frequentemente a **ipertensione**, **sanguinamenti** e **astenia**
- Ca. il 30-50% dei pazienti trattati con ==sorafenib== può sviluppare **eruzioni cutanee** o **sindrome palmo-plantare**
- ==Sunitinib== può portare a **disfunzione cardiaca**, che, a volte, progredisce verso **insufficienza cardiaca**
- ==Sunitinib== e ==sorafenib== possono causare ipotiroidismo
##### Vandetanib
- Inibitore orale delle tirosinchinasi, capace di inattivare *VEGFR-2*, *EGFR* e *RET*
###### Usi clinici
- Primo farmaco consigliato per il trattamento del [[carcinoma midollare|carcinoma midollare tiroideo]] aggressivo e sintomatico, in pazienti non operabili o con metastasi
	- contro di esso è risultato attivo anche un altro TKI, il ==cabozantinib==
- Sviluppi:
	- in uno studio doppio cieco, controllato con placebo, i pazienti trattati hanno presentato
		- una maggiore percentuale di risposte obiettive (45% rispetto a 13%)
...
- Somministrazione IV alle dosi di 1,3 mg/m$^2$ due volte la settimana per 2 settimane
...
#### Nuove opzioni per il melanoma metastatizzato
