...
- Seconda causa di IRC nella popolazione mondiale
	...
	- ponendosi al primo posto in Australia
		- e al terzo, dopo [[Diabete mellito]] e [[Ipertensione arteriosa]] negli USA
...
>[!warning]
>Poiché la *catena α3* è presente anche nella membrana basale degli [[Apparato respiratorio#Alveoli polmonari|alveoli polmonari]], trovano spiegazione le contemporanee manifestazioni a carico di rene e polmone in alcuni pazienti.
...
- Formato da un gruppo di oltre 30 proteine (in parte con ruoli attivatori o inibitori) coinvolte in successione sequenziale
	- **C3**: ruolo chiave, dalla sua scissione originano i fattori che portano all'attivazione del *sistema effettore C5-C9* (complesso di attacco alla membrana, *MAC*)
##### Effetti sortiti dal MAC:
###### Immunoaderenza di polimorfonucleati (PMN)
- Dotati di recettori per il *C3b* → in grado di legarsi agli IC
###### Attività anafilatossinica delle frazioni C3a e C5a
- Provocano liberazione di *amine vasoattive* da parte dei granulociti basofili
###### Chemiotassi verso PMN e monociti
- Si accumulano nel lume dei capillari glomerulari e del mesangio
###### Azione diretta del MAC sulle MBG
1. Aumento di permeabilità
	- soprattutto sulle membrane delle cellule epiteliali ed endoteliali → ==necrosi==
2. Lesioni epiteliali → ==proteinuria== + lesioni endoteliali → ==coagulazione==
##### Via classica
- Attivazione in presenza di
	- IC (in particolare con IgG e IgM)
	- molecole di natura antigenica non aggregate in IC
		- DNA, enzimi vari, proteina stafilococcica, polisaccaridi batterici)
##### Via alternativa
- IC a componente anticorpale IgA
	- autoanticorpi quali *C3 Nephritic Factor* (*C3NeF*)
	- alterazioni di struttura, su base genetica, di
		- C3
		- fattori inibenti l'attivazione incontrollata della cascata complementare (cosiddetta *disregolazione*)
### Meccanismi patogenetici secondari
#### Ruolo degli elementi circolanti
##### Polimorfonucleati
###### Neutrofili
- Enzimi lisosomiali
	- *elastasi*, *collagenasi*, *proteasi* (del tipo della chemotripsina)
- Peptidi ad azione vasodilatatrice
- ROS
- Sostanze ad azione chemiotattica sui macrofagi
###### Basofili
- Amine con azione permeabilizzante
- *Fattore attivante le piastrine* (*PAF*)
##### Piastrine
- *Istamina* e *serotonina*
- Enzimi lisosomiali
	- *catepsine*
- Proteine cationiche ad azione permeabilizzante
- Proteasi neutre
- Azione sul fattore di Hageman → coagulazione
##### Monociti
- In alcune forme di GN, principali responsabili
- Da un lato
	- danno della parete capillare → liberazione di enzimi, ROS, citochine, eicosanoidi
	- innesco della proliferazione delle cellule autoctone → fattori di crescita
- Dall'altro
	- favoriscono la regressione della malattia → fagocitosi degl'IC
#### Ruolo degli elementi cellulari residenti nel glomerulo
##### Cellule endoteliali
1. Aumentata sintesi o neosintesi di molecole recettoriali (*ICAM1* e *2*, *ELAM-1*)
	- modulate dalle citochine (*IL1* e *TNF*) prodotte da cellule ematiche/residenti nel glomerulo
2. Adesione precoce dei leucociti
3. Progressivo declino di espressione delle molecole recettoriali neoformate (*ELAM-1*)
4. Migrazione dei leucociti al di fuori del lume capillare
	- il contemporaneo aumento di *VCAM-1* concorre al reclutamento dei linfociti
##### Monociti residenti e cellule mesangiali
...
- Instaurate nella fase acuta
	- anche in assenza di [[Ipertensione arteriosa]]
...
- Quali
	- *Insulin-like growth factor* (*GF-1*)
	- *Growth hormon* (*GH*)
	- *Transforming Growth Factor β* (*TGFβ*)
- Stimolano le cellule mesangiali
- Favoriscono la trasformazione [[Ipertensione arteriosa#Arteriosclerosi ialina|scleroialina]] del glomerulo
###### Proteinuria
1. Stimola e danneggia l'epitelio tubulare
2. Conseguente liberazione di molecole di adesione, fattori di crescita, citochine proinfiammatorie e chemochine
3. Vengono attirati elementi infiammatori nell'interstizio
4. Induzione della fibrosi
5. Atrofia tubulare e sclerosi glomerulare
### **Approfondimento 1: ruolo del patologo - biopsia renale**
#### Modalità di esecuzione
- Attualmente eseguita quasi esclusivamente con *ago rigido*
	- riservando la biopsia chirurgica incisionale a situazioni cliniche particolari
- Vantaggi dell'agobiopsia:
	- minore invasività
	- possibilità di prelevare campioni anche profondi di tessuto renale
		- comprendono anche corticale iuxtamidollare e midollare
		- consentono valutazioni più attendibili riguardo tipo e gravità del danno
#### Indicazioni
- Diagnosi più rilevanti alla biopsia:
	- GN
...
##### Biopsia
- Meno indicata nel sospetto di malattie tubulo-interstiziali
	- presentano lesioni a distribuzione focale, con possibilità di interpretazioni falsamente negative
- Procedura diagnostica fondamentale nel trapianto renale
	- può essere eseguita sui reni del potenziale donatore per accertare l'idoneità dell'organo
	- diventata sempre più comune per via dell'aumento dei *donatori marginali*
		- soggetti che potrebbero presentare lesioni renali (età avanzata o concomitanti situazioni patologiche)
	- sul rene trapiantato, fondamentale per sospetto di
		- [[Malattie del sistema immunitario#Rigetto dei trapianti|rigetto]]
		- tossicità da farmaci
		- recidiva della malattia del rene nativo nell'organo impiantato
		- infezioni intercorrenti
###### Biopsia protocollare
- Impiegata soprattutto per motivi di studio
- Ripetizione a scadenze prefissate
- Indipendentemente dalle condizioni cliniche del paziente
#### Materiali e metodi
- Bisogna poter disporre di materiale per
##### Indagini di microscopia ottica (m.o.)
- Lo studio istologico richiede l'utilizzo di varie colorazioni per lo studio
###### Ematossilina-eosina
###### Reazione PAS + impregnazione argentica
- Studio delle alterazioni delle membrane basali
###### Colorazioni tricromiche
- Valutazione della *fibrosi*
###### Metodo dell'acido fosfotungstico-ematossilina (PTAH)
- Identificazione della *necrosi fibrinoide* e sede di eventuali depositi
##### Indagini immunoistochimiche e ultrastrutturali
- Da eseguire su materiale incluso in resine epossidiche
- Indispensabili per la diagnosi di malattie identificabili solo con la microscopia elettronica (m.e.)
	- ematurie familiari
	- GN fibrillari e immunotattoidi
- Forniscono un utile supporto in casi particolarmente difficili o con quadro morfologico comunque complesso (es. GN doppie, GN lupica, ecc.)
>[!info]- Anticorpi fluorescinati applicati su tessuto congelato
>Utilizzo di anticorpi
>- *anti-IgA*,
>- *anti-IgG*,
>- *anti-IgM*,
>- *anti-frazioni $C_3$, $C_4$* e *$C_1q$ del complemento,*
>- *anti-fibrinogeno*,
>- *anti-catene leggere immunoglobuliniche $\kappa$* e *$\lambda$*.
>
>Impiego di ulteriori anticorpi necessario in casi particolari
>- anti-componente P e anti-componente A → tipizzazione dell'[[Amiloidosi|amiloide]],
>- *anti-C4d* → indicatore di patogenesi umorale nei casi di rigetto,
>- particelle virali (soprattutto per *BK virus*).
### **Approfondimento 2: danno glomerulare: lesioni morfologiche elementari**
#### Proliferazione cellulare
- Il processo coinvolge
	- *cellule endoteliali* → occlusione dei lumi dei capillari
	- *cellule mesangiali* → allargamento dell'asse mesangiale
	- *cellule epiteliali parietali* → formazione di semilune/ostruzione dello spazio urinifero
##### Semilune
- Alla loro formazione partecipano in varia misura anche polimorfonucleati e macrofagi di origine ematica
###### Semilune cellulari (o floride)
- Tendono ad evolvere in forme fibrocellulari
	1. deposizione intercellulare di *collagene*
	2. evoluzione in forme fibrose per la sua permanenza
#### Infiltrazione di polimorfonucleati e monociti
- In sede endocapillare e mesangiale (in minor misura)
- Responsabili delle lesioni essudative
#### Modificazioni della membrana basale
- Ispessimento per cause intrinseche
	- glomerulopatia diabetica
	- [[Ipertensione arteriosa]]
	- presenza di depositi (come nelle glomerulonefriti)
#### Depositi
- Per lo più costituiti da IC
	- fra membrana basale e podociti (*extramembranosi*)
	- nel contesto della membrana (*intramembranosi*)
	- fra la membrana e l'endotelio (*sottoendoteliali*)
	- nella sostanza fondamentale del mesangio (*mesangiali*)
- Depositi nastriformi intramembranosi
	- di natura non immunologica
	- nella malattia a depositi densi e in quella da deposizione di Ig monoclonali
#### Necrosi
- ==Frammentazione dei nuclei== delle cellule glomerulari
- ==Rottura e disgregazione delle membrane basali==
- Deposizione di fibrina in
	- lumi capillari
	- spazio urinifero
#### Ialinosi
- Accumulo di *materiale acellulare*, anisto
	- positivo al metodo PAS
	- negativo alle impregnazioni argentiche
	- composto da glicoproteine e, talora, lipidi
#### Sclerosi
