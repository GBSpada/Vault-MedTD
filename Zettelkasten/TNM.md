...
| Categoria | Descrizione |
|---|---|
| **pNX** | I linfonodi loco-regionali non possono essere valutati (ovvero non rimossi per lo studio anatomopatologico o rimossi in precedenza) |
| **pN0** | Assenza di metastasi nei linfonodi loco-regionali o presenza di cellule tumorali isolate (ITC, Isolated Tumor Cells)³ <br> - pN0(i+): ITC nei linfonodi loco-regionali <br> - pN0(mol+): Esame molecolare positivo (RT-PCR)⁴; assenza di ITC |
| **pN1** | Micrometastasi; oppure metastasi in 1-3 linfonodi ascellari; e/oppure micrometastasi o macrometastasi nei linfonodi sentinella mammari interni clinicamente non evidenti <br> - pN1mi: Micrometastasi (aggregati di cellule tumorali di approssimativamente 200 cellule, del diametro maggiore superiore a 0,2 mm, ma nessuno superiore a 2 mm) <br> - pN1a: Metastasi in 1-3 linfonodi ascellari (almeno una metastasi del diametro maggiore superiore a 2 mm) <br> - pN1b: Metastasi nei linfonodi sentinella mammari interni omolaterali, ITC escluse <br> - pN1c: pT1a e pT1b |
| **pN2** | Metastasi in 4-9 linfonodi ascellari; oppure linfonodi mammari interni clinicamente evidenti in assenza di metastasi nei linfonodi ascellari <br> - pN2a: Metastasi in 4-9 linfonodi ascellari (almeno un aggregato di cellule tumorali del diametro maggiore superiore a 2,0 mm) <br> - pN2b: Linfonodi mammari interni clinicamente evidenti con o senza conferma istologica in assenza di metastasi nei linfonodi ascellari |
| **pN3** | Metastasi in 10 o più linfonodi ascellari; oppure metastasi nei linfonodi sottoclaveari (linfonodi ascellari di III livello); oppure linfonodi mammari interni clinicamente evidenti in presenza di 1 o più metastasi nei linfonodi ascellari di I, II livello; oppure metastasi in più di 3 linfonodi ascellari e micrometastasi o macrometastasi nei linfonodi sentinella mammari interni clinicamente non evidenti; oppure metastasi nei linfonodi sopraclaveari omolaterali <br> - pN3a: Metastasi in 10 o più linfonodi ascellari (almeno un aggregato di cellule tumorali del diametro maggiore superiore a 2,0 mm) o metastasi nei linfonodi sottoclaveari (linfonodi ascellari di III livello) <br> - pN3b: pN1a o pN2a in presenza di cN2b (linfonodi mammari interni clinicamente evidenti); oppure pN2a in presenza di pN1b <br> - pN3c: Metastasi nei linfonodi sopraclaveari omolaterali |


## Classificazione M (Metastasi a distanza)
...
## Stadiazione Anatomica

La stadiazione anatomica del carcinoma della mammella si basa sulla combinazione delle categorie T, N e M. Si prega di consultare le linee guida specifiche per la stadiazione completa.

**Note:**

¹ I tumori associati a malattia di Paget sono classificati secondo le dimensioni della malattia del parenchima. La presenza della malattia di Paget viene tuttavia segnalata.

² Qualora la biopsia del linfonodo sentinella venga eseguita prima dell’escissione del tumore, come in caso di chemioterapia neoadiuvante.

³ Per ITC si intendono singole cellule o piccoli aggregati di cellule tumorali del diametro maggiore non superiore a 0,2 mm.

⁴ RT-PCR (Reverse Transcriptase-Polymerase Chain Reaction) reazione a catena della polimerasi-trascrittasi inversa. 
