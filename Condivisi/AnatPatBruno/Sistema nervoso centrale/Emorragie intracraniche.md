...
- **Insorgenza** a livello delle principali **biforcazioni del poligono di Willis** (in ordine decrescente di frequenza):
	...
	- ![Emorragia subaracnoidea: rappresentazione schematica della distribuzione degli aneurismi a bacca, che ne mostra la maggiore incidenza nel sistema carotideo rispetto a quello vertebrobasilare.](https://i.imgur.com/8Dc6DSG.png)
- Nel 10-30% dei casi, gli aneurismi sono multipli
##### Decorso e diagnosi
- La maggior parte dei pazienti con aneurisma a bacca giunge all'attenzione clinica in età compresa tra i 40 e i 70 anni
- Definiti come congeniti, ma non si osservano mai alla nascita o in bambini
	- si formano nel corso degli anni per un ==difetto della tonaca media==
		- questo probabilmente congenito
		- rappresenta un *locus di minore resistenza alla pressione endoarteriosa*
##### Fattori di rischio
###### Malattie ereditarie
- [[Malattia renale policistica|Rene policistico]]
- Sindrome di Marfan
...
2. Conseguenze dell'emorragia:
	1. improvvisa cefalea, con rigidità nucale e perdita di coscienza
	2. ==notevole vasospasmo delle arterie subaracnoidee==
		- può causare gravi danni ischemico-infartuali
			- possono rappresentare una complicanza mortale
		- causa da ascrivere a mediatori presenti nel sangue
			- *endotelina 1* → effetto vasocostrittivo sull'avventizia vasale
			- *NO* → vasodilatatore, i cui livelli sono ridotti
3. L'emorragia può fermarsi spontaneamente, con riassorbimento completo del sangue in circa tre settimane
4. Il risanguinamento a distanza di 10-15 giorni dalla prima emorragia è relativamente frequente
>[!warning]- Renato ha la face deformata, mi sa che il cervello gli ha preso un po' d'acqua
>Nei pazienti che sopravvivono a una emorragia subaracnoidea può instaurarsi un ==idrocefalo== quale causa di una *fibrosi meningea* con **ostruzione della via liquorale**.
#### Aneurismi aterosclerotici
- Localizzazione a livello delle **grosse arterie cerebrali**
	- *vertebrale*
	- *basilare*
	- *carotidi interne*
- Tipicamente fusiformi, possono raggiungere grosse dimensioni
	- causando ==fenomeni compressivi delle strutture adiacenti==
	- la principale complicanza non è la rottura, bensì l'==occlusione trombotica==
#### Aneurismi micotici
- In genere associati a [[endocardite infettiva]]:
	1. l'embolizzazione del materiale trombotico contenente batteri può localizzarsi a livello della parete dei vasi cerebrali
	2. il processo infiammatorio conseguente determina un indebolimento della parete
	3. dilatazione [[Aneurismi e dissecazioni|aneurismatica]] della parete
