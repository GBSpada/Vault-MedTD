...
- Interessa esclusivamente gli alveoli distali del lobulo
...
### Enfisema secondaria a ostruzione
...
## Approfondimento: deficit di $α_1$-antitripsina
### $α_1$-antitripsina
- Glicoproteina codificata da un *gene localizzato sul cromosoma 14*
	- note almeno 75 varianti genetiche
		- 20 possono associarsi ad alterazioni della funzionalità
	- classificazione degli alleli:
		- normale (M)
		- deficitario (Z, S)
		- nullo
#### Secrezione
- Fegato
- Macrofagi
- Cellule epiteliali respiratorie
#### Funzione
- Inibizione delle *proteasi sieriche*
	- fondamentale affinché l'*elastasi neutrofila* (una proteasi) non danneggi gli [[Apparato respiratorio#Alveoli polmonari|alveoli polmonari]]
		- normalmente frammenta le fibre elastiche settali, favorendone prima il cedimento e poi la distruzione
	- maggiore sistema di difesa delle vie respiratorie contro i danni da loro causati
### Rischio di malattia
- Riguarda le persone con fenotipo
	- nullo-nullo
	- Z-nullo
	- ZZ
- Varia tra i soggetti portatori dello stesso fenotipo
### Varianti
#### M-Malton/M-Cagliari
- Particolarmente frequente nella popolazione sarda
#### Più rare
- Definite *Null*
- Si associano ad elevato rischio di enfisema o epatopatia
### Sintomatologia
#### Forma polmonare
- Il fenotipo eterozigote SZ causa enfisema nei soggetti fumatori
- Determinata da insufficienza di $α_1$-antitripsina funzionante
- Si manifesta con [[Zettelkasten/Enfisema polmonare#Enfisema panacinare (o panlobulare)|enfisema panacinare]]
	- prevalentemente localizzato alle basi polmonari
	- ad insorgenza precoce
		- il *fumo*
			- aumenta la produzione di proteasi da parte delle cellule del sistema immunitario
			- ossida (inattivandola) la già scarsa $α_1$-antitripsina
#### Forma epatica
- Il 20% dei soggetti con fenotipo omozigote ZZ sviluppa ==epatopatia==
	- ==epatite colestatica neonatale==
	- ==epatopatia cronica==
	- fino a ==cirrosi epatica==
		- predispone ad epatocarcinoma negli adulti
- Determinata da accumulo epatico negli epatociti di una forma anomala
