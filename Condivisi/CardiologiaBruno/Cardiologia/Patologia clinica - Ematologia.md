...
- Campione che non coagula
	...
	- Spesso non è una problematica a carico del paziente ma si tratta di errori nel prelievo
	- Il laboratorio nel dubbio richiede altri prelievi per presenza di coaguli o alterate modalità di prelievo
- Sangue diluito con fisiologica
	- Andrebbe fatto smaltire il volume in eccesso

### Fase analitica
#### Valutazione quantitativa
- Può verificarsi una ==pseudopiastrinopenia da EDTA==
	- In alcuni soggetti le piastrine coagulano più facilmente con EDTA
		- Da 150-450.000 si passa 70, 60, 50.000
	- L'aggregato potrebbe essere dato da basse temperature quindi si riscalda e si rianalizza
	- Altra opzione è controllare al microscopio la presenza di aggregati piastrinici
		- Prima però spesso si richiedono altri campioni al citrato
#### Parametri quantitativi e qualitativi
- **Volume piastrinico medio** (**MPV**)
	- Omogeneità del volume dei frammenti 
- **Ampiezza di distribuzione piastrinica**
	- Quantità
#### Test di aggregazione piastrinica
- Valutazione della **fase vaso-piastrinica**
##### Tempo di emorragia (anticamente)
- Taglio sull'avambraccio con sfigmomanometro a 40mmHg
- Sempre associato ad
	- Alterazioni strutturali e funzionali dell'enddotelio
	- Riduzione della funzioanalità
	- Malattia di von Willebrand
	- vasculopatie croniche
##### Test della trasmittanza per l'aggregazione piastrinica
- In generale
- Si effettua *in vitro*
	- su un'aliquota di plasma ricco di piastrine
	- con un potente induttore dell’aggregazione piastrinica
		- es. *ADP*
- Si valuta la **trasmittanza** tramite sistema ottico
	- capacità di farsi attraversare dalla luce
	- aumenta man mano che si formano gli aggregati piastrinici
###### Step
1. Una sorgente luminosa incide sulla provetta contenente il campione
2. Vengono aggiunti, al sangue nella provetta (mantenuta in agitazione da un agitatore), sostanze aggreganti
	- *ADP*, *epinefrina*, *collagene*
	- l’aggregazione consente il passaggio della luce
	- man mano che gli aggregati si formano, la soluzione diviene più liquida
3. Il rilevatore posto a fine percorso rileva la luce trasmessa
- Si valuta quanto ci mette la luce a passare attraverso il campione
	- Perché essenzialmente la coagulazione libera spazio per far passare la luce
- ![Test della trasmittanza per l’attivazione piastrinica](https://i.imgur.com/AGAVinG.png)
###### Grafico esplicativo
![Test della trasmittanza per l’aggregazione piastrinica, grafo](https://i.imgur.com/l9JVQmi.png)
##### Platelet function analyzer (PFA-100)
- Strumento automatico
- Si misura il tempo di chiusura di un orifizio attraverso cui passa il campione di sangue nello strumento (come nella citofluorimetria):
	1. il flusso, ad un certo punto, trova membrane che sono impregnate di induttori dell'aggregazione piastrinica (*epinefrina* o *ATP*)
	2. le piastrine si attivano e si aggregano, tappando il flusso
	3. viene calcolato il tempo di chiusura (==TC==)
- ![](https://i.imgur.com/4X0cYsE.png)
#### Test della cascata coagulativa
##### Tempo di protrombina
- Molto breve
...
> Concentrazione normale 0-500 $ng/mL$
...
- $$MCV = \frac{Hct\cdot 10}{RBC}$$
- Permette di distinguere le cellule in 
	- Normocitiche
		- Talassemia 
		- Anemia sideropeniche
	- Macrocitiche
		- Anemia da carenza di B12
		- Volume oltre i 115 femtolitri
	- Microcitiche

#### Indice di anisocitosi eritrocitaria
$$RDW =\frac{\text{Deviazoine standard MCV}}{\text{Media MCV}}\cdot \,100$$
- Red cell distribution width
- Ci dice se la popolazione è omogenea a livello volumetrico
##### Alterazioni
- Problemi a livello eritropoietico

#### La descrizione della popolazione delle piastrine
##### Conteggio
- Fornisce informazioni anche sul volume piastinico medio e sull'indice di anisocitoisi piastrinica
##### Valori
• Lieve: quando le piastrine sono < 150.000 su microlitro;
• Moderata: per piastrine comprese tra le 50.000 e le 100.000 su microlitro; 
• Grave: se le piastrine sono < 50.000 su microlitro; 
• Gravissima: quando le piastrine sono < 20.00 su microlitro, in questo caso possiamo dire che il paziente è scoagulato.
#### La presenza dei reticolociti
#### La formula leucocitaria
- Distingue le 5 sottopopolazioni dei bianchi sia in valore assoluto (il numero di cellule/microlitro), che in valore percentuale rispetto alla distribuzione della popolazione.

### Striscio di sangue periferico
#### Step
1. Si lascia asciugare lo striscio per 10 minuti
2. Si procede con il reattivo di May Grunwald
	- Blu di metilene e eosina
3. Risciacquo con acqua distillata
4. Si Aggiunge il [[Cromosomi e cariotipo|reattivo di Giemsa]]
	- AzurII ed eosina
...
--- 
# Reference:
[[Patologia Clinica II - ematologia.pdf]]