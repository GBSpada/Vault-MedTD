...
- Principalmente, da tre proteine precursori principali:
	...
	- ==preprodinorfina (proencefalina B)==
		- contiene molti peptidi oppioidi attivi contenenti la sequenza della leu-encefalina, ovvero *dinorfina A*, *dinorfina B* e $\alpha$- e $\beta$-*neoendorfine*
### Funzione
...
- Altre vie di somministrazione:
	...
	- N.B. recentemente è stato introdotto un ==sistema iontoforetico transdermico==[^4] che permette il rilascio di ==fentanil== per un'analgesia controllata dal paziente
### Distribuzione
...
- Citocromi responsabili:
	- CYP3A4 → metabolismo del fentanil per *N-dealchilazione*
		- presente anche nella mucosa dell'intestino tenue, dove contribuisce al metabolismo di primo passaggio del fentanil assunto oralmente
...
- La maggior parte degli analgesici oppioidi attualmente disponibili agisce principalmente a livello del recettore $\mu$
...
- Bloccanti dei canali del $Ca^{2+}$
	...
	- [[Gabapentin e pregabalin|gabapentin/pregabalin]]
...
- ==Effetto dose-dipendente==, significativamente influenzato dall'intensità di altre afferenze sensoriali presenti nello stesso periodo di tempo
...
- Viene influenzato in maniera trascurabile del circolo cerebrale
	- fatta eccezione per i casi in cui la $PCO_2$ si eleva in seguito a depressione respiratoria:
		...
		- parallelamente riduce le resistenze vascolari cerebrali, aumenta il flusso ematico ed innalza la pressione del liquido cefalorachidiano (pressione endocranica)
##### Apparato gastrointestinale
- Recettori oppioidi esistono in grande quantità a livello del tratto gastrointestinale; gli effetti costipanti sono mediati attraverso azioni sul SNE e sul SNC
	- la **stipsi** è l'effetto principale e non diminuisce con l'impiego prolungato
- Più nello specifico:
	- stomaco
		- la motilità può diminuire, ma il tono (contrazione persistente) può aumentare
		- la secrezione di $HCl$ è ridotta
	- tenue
		- tono basale aumentato con spasmi periodici
		- ampiezza delle onde propulsive diminuita in maniera marcata
	- crasso
		- onde peristaltiche propulsive diminuite e tono aumentato
			- ritardo del passaggio della massa fecale e aumento dell'assorbimento di acqua
		- effetti responsabili dell'==attività antidiarroica==, mentre la stipsi è un problema di primo piano nell'impiego di oppioidi per il controllo del dolore serio da neoplasie
##### Vie biliari
- Contrazione delle muscolatura liscia, che può essere responsabile di una colica
- Contrazione dello sfintere di Oddi
	- riflusso biliare e delle secrezioni pancreatiche
	- aumento dei livelli plasmatici di amilasi e lipasi
##### Apparato urinario
- ==Depressione della funzionalità renale==
	- per riduzione del flusso plasmatico renale
- Gli agenti $\mu$-agonisti hanno dimostrato ==effetto antidiuretico==
- Gli oppioidi aumentano anche il riassorbimento tubulare di $Na^
>[!warning]
>- Un aumento del tono dello sfintere uretrale può precipitare una ritenzione urinaria, specialmente nella fase postoperatoria
>- Occasionalmente, una colica uretrale provocata da un calcolo renale può essere aggravata dall'aumento del tono ureterale.
##### Utero
- Gli oppioidi **possono prolungare il travaglio**
- Il tono uterino può, comunque, essere ridotto con meccanismi sia centrali che periferici
##### Apparato neuroendocrino
- Gli analgesici oppioidi
	- ==stimolano== la liberazione di *ADH*, *prolattina* e *somatotropina*
	- ==inibiscono== il rilascio di *LH*
- Tali effetti indicano azione di regolazione a livello ipotalamico
##### Prurito
- Dosi terapeutiche possono indurre **arrossamenti cutanei** talora accompagnati da **sudorazione** e **prurito**
	- reazioni che sembrano essere dovute ad effetti centrali e liberazione di istamina
	- il prurito (occasionalmente orticaria) compare più frequente quando la somministrazione avviene per via parenterale
- Quando gli oppioidi fenantrenici sono ==somministrati al neurasse== (per via spinale o epidurale) la loro utilità può essere limitata dall'**intenso prurito su labbra e dorso**
##### Altri effetti
- Modulano le azioni del sistema immune
	- effetti su proliferazione linfocitaria, produzione di anticorpi e chemiotassi
	- leucociti migrano al sito di lesioni tissutali e rilasciano da sè peptidi oppioidi
- Questi effetti sono mediati da
	- sistema nervoso simpatico nel caso di somministrazione acuta
	- asse ipotalamo-ipofisi-surrene in caso di somministrazione prolungata
#### Effetti degli oppioidi agonisti-antagonisti
##### Buprenorfina
- Agonista oppioide provvisto di alta affinità di legame, ma bassa attività intrinseca per il recettore $\mu$
	- la bassa velocità di dissociazione la rende un'interessante alternativa al ==metadone== per il trattamento dell'astinenza
...
- Dovrebbe essere trattato aggressivamente e, spesso, richiede un ==approccio multidisciplinare== per un trattamento effettivo
	- tale condizione può richiedere l'uso continuo di analgesici oppioidi potenti e sarà associata a un certo grado di abitudine e dipendenza
		- *ciò non dovrebbe rappresentare un impedimento al fornire ai pazienti la migliore cura e qualità della vita possibili*
...
- Frequente utilizzo degli oppioidi per via delle loro proprietà ==sedative==, ==ansiolitiche== e ==analgesiche==
	...
	- utilizzati in massimo grado in chirurgia cardiovascolare e in altri interventi chirurgici ad alto rischio in cui è indispensabile ridurre il più possibile la depressione cardiovascolare
		- in questi casi, è richiesta un'assistenza respiratoria meccanica
##### Somministrazione epidurale/subaracnoidea
- A causa della loro azione diretta sui neuroni superficiali delle corna dorsali del midollo spinale, gli oppioidi possono essere utilizzati come ==analgesici regionali==
- Analgesia prolungata con effetti collaterali trascurabili
	- può essere indotta
		1. somministrando morfina per via epidurale alle dose di 3-5 mg
		2. seguita da una lenta infusione attraverso un catetere posizionato nello spazio epidurale
	- tale applicazione può determinare selettivamente analgesia, ==senza danneggiamenti delle funzioni motorie, vegetative o sensoriali diverse dal dolore==
###### Effetti sfavorevoli
- Alcune ore dopo la somministrazione epidurale, può manifestarsi depressione respiratoria
	- può richiedere antagonismo con ==naloxone==
- Prurito, nausea e vomito possono essere parimenti eliminati dal naloxone, se necessario
- Comunemente, è favorita la via epidurale su quella subaracnoidea:
	1. ==le azioni sfavorevoli sono meno frequenti==
	2. riduzione significativa della mortalità perioperatoria e della morbilità[^6]
###### Ulteriori considerazioni
- L'uso di basse dosi di ==anestetici locali in combinazione col fentanil== infuso attraverso un ==catetere toracico epidurale== è diventato un metodo accettato per il controllo del dolore in pazienti convalescenti da grandi interventi sul torace o sull'addome superiore
- In casi rari, gli specialisti possono impiantare chirurgicamente una ==pompa ad infusione programmabile connessa ad un catetere spinale== per l'==infusione continua== di oppioidi o altri composti analgesici
#### Vie di somministrazione alternative
##### Supposte
- Di ==morfina== e ==idromorfone==
- A lungo usate qualora fossero controindicate le vie parenterali od orali
##### Transdermica
- Vantaggi:
	- permette un livello ematico stabile del farmaco e un miglior controllo del dolore
	- evita la necessità di ripetute iniezioni
- ==Fentanil==
	- ha avuto molto successo in questa applicazione e trova grande impiego nell'alleviare il dolore persistente che non recede
	- a causa della depressione respiratoria indotta, la FDA raccomanda che l'introduzione del cerotto transdermico del fentanil (25 $\mu$g/h) sia riservata a pazienti con un fabbisogno richiesto di morfina >= 60 mg/g per una settimana o più
	- la più grande cautela dev'essere posta in ogni paziente che inizia la terapia o che va incontro ad un aumento di dose
		- gli effetti massimi possono non esser raggiunti fino a 24-48 h dall'applicazione del cerotto
##### Intranasale
- Ha il vantaggio di evitare
	- iniezioni parenterali ripetute di farmaco
	- metabolismo di primo passaggio che si ha con farmaci somministrati *per os*
- Il ==butorfanolo== è l'unico oppioide attualmente disponibile in USA per questa applicazione
	- si prevede che ne seguiranno altri
##### Orale transmucosale
- Utilizza una ==pasticca== di fentanil citrato o un ==lecca-lecca== fissato ad un bastoncino
##### Analgesia controllata dal paziente (PCA)
- Il paziente controlla un sistema di somministrazione parenterale (di solito IV) premendo un bottone per somministrare una dose preprogrammata dell'oppioide desiderato
- Approccio molto utile per via dell'evidenza di un **miglior controllo del dolore con un minor utilizzo di oppioidi**
>[!warning]
>Tuttavia, il personale sanitario deve avere una perfetta pratica nell'uso di tale apparecchiatura, per evitare sovradosaggi dovuti alla non corretta programmazione del sistema.
>- Vi è un concreto rischio di depressione respiratoria con ipossia.
>- Vi è bisogno di un attento controllo di
>	- segnali vitali,
>	- livello di sedazione
>	- fornitura supplementare di $O_2$.
...
- Approcci:
	- =="rotazione dell'oppioide"==
		...
		- un paziente in cui si evidenzi una diminuzione dell'efficacia a un determinato regime di dosaggio di un oppioide viene "ruotato" verso un altro analgesico oppioide
...
- Il sottogruppo del fentanil comprende ==sufentanil==, ==alfentanil== e ==remifentanil==
...
- La ridotta suscettibilità all'abuso è dovuta alla sua ==scarsa capacità di raggiungere il cervelletto==
- Trattamento
