...
---
# Basi biologiche del sistema cardiovascolare
## Il vaso sanguigno
### Ultrastruttura vascolare
>Descrizione dall'interno all'esterno
![Vasi sanguigni, struttura di varie tipologie.](https://i.imgur.com/KN2Fihv.png)
#### Capillari
1. Monostrato di cellule endoteliali
2. *Periciti*
	- elementi simili a cellule muscolari lisce presenti lungo le pareti capillari
	- non rivestono l'intero microvaso a formare una guaina continua
#### Vene e arterie
1. *tunica intima*: monostrato di cellule endoteliali che si continuano con quelle dei capillari
	- contiene spesso occasionali ==cellule muscolari lisce== sotto il monostrato di cellule endoteliali
2. *tunica media*: costituito da strati di cellule muscolari lisce
	- nelle vene, può contenere solo pochi strati cellulari
	- nelle arterie di dimensioni maggiori, è nutrita dai *vasa vasorum*
3. *tunica avventizia*: matrice extracellulare più lassa, in cui sono occasionalmente presenti ==fibroblasti==, ==mastociti== e ==terminazioni nervose==
##### Arteriole
...
- *Tunica media molto più strutturata*, costituita da
	...
	- strati continui di muscolatura liscia
##### Arterie di dimensioni maggiori
- *Lamina elastica interna* → barriera fra intima e media
- *Lamina elastica esterna* → separa la media dall'avventizia circostante
### Origine delle cellule vascolari
- L'origine embrionale delle cellule muscolari è differente nei vari tipi arteria:
	- parte superiore del corpo → ==cresta neurale==
	- porzione inferiore del corpo → ==strutture mesodermiche circostanti== (es. somiti[^1])
>[!info]- Ruolo del midollo nella genesi delle cellule muscolari intimali
>Il midollo osseo può dare ==origine== sia a ==cellule endoteliali vascolari== che ==muscolari lisce==, soprattutto in caso di riparazione di danni o di formazione di lesioni vascolari.
>- La sua capacità di ricostruire un monostrato endoteliale danneggiato può
>	- contribuire al mantenimento dello stato di salute vascolare,
>	- favorire la patologia arteriosa se fallisce;
>- Le fonti precise delle cellule sono tuttora oggetto di attive ricerche.
### Biologia delle cellule vascolari
#### Cellule endoteliali
- Dotate di numerose funzioni:
...
>Valutazione di un unico indice del comportamento endoteliale in vivo, la ==vasodilatazione endotelio-indipendente==: utilizzando agonisti farmacologici o meccanici, l'endotelio viene stimolato a rilasciare acutamente effettori molecolari che alterano il tono della muscolatura liscia sottostante
##### Metodica invasiva
...
- =="Picchi di calcio"==
	...
	- conseguenze:
		- ulteriore aumento diretto della concentrazione intracellulare di Ca$^{2+}$ → attivazione dei canali del Cl$^-$
...
## Controllo della performance e della gittata cardiaca
...
- Quando la contrattilità miocardica è compromessa e il ventricolo si dilata, il postcarico aumenta[^6] e limita la GS
...
3. Sono possibili diverse opzioni per il loro trattamento:
