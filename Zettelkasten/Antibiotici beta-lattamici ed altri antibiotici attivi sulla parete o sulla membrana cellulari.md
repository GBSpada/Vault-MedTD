...
- L'attività biologica della penicillina G è stata, inizialmente, definita in termini di unità
...
#### $\beta$-lattamasi
- Meccanismo di resistenza più comune
- Ne sono state identificate centinaia differenti
	- alcune di esse sono relativamente specifiche per il substrato, preferendo le penicilline alle cefalosporine
		- es. quelle prodotte da [[Staphylococcus aureus]], Haemophilus sp. ed [[Escherichia#Escherichia coli (E. coli)|E. coli]]
	- altre idrolizzano sia le cefalosporine che le penicilline
		- es. *β-lattamasi AmpC* prodotta da [[Pseudomonas aeruginosa e batteri correlati|P. aeruginosa]] e da Enterobacter sp.
		- es. *β-lattamasi a spettro esteso*
- I ==carbapenemi== sono
	- altamente resistenti all'idrolisi delle *penicillinasi* e *cefalosporinasi*
	- idrolizzati da *metallo-β-lattamasi* e *carbapenemasi*
#### PBP modificate
- Responsabile della resistenza a
	- ==meticillina== negli [[Stafilococchi]]
	- ==penicillina== negli [[Pneumococchi - Streptococcus pneumoniae|Pneumococchi]] ed Enterococchi
- Hanno una bassa affinità di legame con gli antibiotici $\beta$-lattamici
	- i microrganismi che le producono non sono inibiti, eccetto che a concentrazioni di farmaco relativamente elevate (non raggiungibili normalmente nell'uso clinico)
#### Ridotta penetrazione del farmaco
- Si verifica **solo nei batteri gram-negativi**, a causa della presenza della membrana esterna impermeabile (struttura assente nei gram-positivi)
- I $\beta$-lattamici attraversano la membrana esterna e penetrano nei batteri gram-negativi tramite alcuni canali formati da porine presenti nella membrana esterna
	- l'assenza della porina appropriata o una sua diminuita produzione possono ridurre notevolmente l'ingresso nella cellula
>[!warning]
>La sola alterazione della permeabilità **non conferisce resistenza**: una parte di antibiotico può comunque permeare.
>- Questa barriera può diventare importante in presenza di $\beta$-lattamasi (anche se poco attiva), in quanto idrolizzano l'antibiotico più velocemente di quanto riesca a penetrare nella cellula.
#### "Pompa di efflusso"
- Costituita da componenti proteici citoplasmatici e periplasmatici
- Trasporta efficacemente, attraverso la membrana esterna, alcuni $\beta$-lattamici dall'interno della cellula nuovamente nell'ambiente extracellulare
### Farmacocinetica
#### Somministrazione
##### Per os
- Assorbimento
	- differisce grandemente tra le diverse penicilline, dipendendo in gran parte da
		- stabilità a pH acido
		- legame alle proteine
	- diminuito dal cibo, **dovrebbero** perciò **essere assunti almeno 1-2 h prima o dopo i pasti** (l'==amoxicillina== costituisce un'eccezione)
		- onde ridurre il legame con le proteine alimentari e l'inattivazione da parte del succo gastrico
- Esempi:
	- ==nafcillina== → piuttosto irregolare, per cui non è idonea l'assunzione per os
	- ==dicloxacillina==, ==ampicillina== e ==amoxicillina==
		- stabili a pH acido, relativamente ben assorbite
		- producono concentrazioni sieriche di 4-8 $\mu$g/mL dopo una dose orale di 500 mg
##### Parenterale
- Assorbimento completo e rapido
###### Somministrazione IV
>Preferita all'IM, che, in dosi elevate, causa irritazione e dolore localizzato nel punto d'iniezione
- Concentrazioni sieriche
	- dopo 30 min dall'iniezione endovenosa di 1g di penicillina[^2], sono di 20-50 $\mu$g/mL
	- soltanto una frazione è presente in forma libera ed è determinata dal legame alle proteine plasmatiche:
...
- La maggior parte delle azioni sfavorevoli serie è dovuta a *reazioni di ipersensibilità*
	...
	- determinanti antigenici
		- prodotti di degradazione della penicillina (soprattutto *acido penicilloico* e prodotti derivati dall'idrolisi alcalina) che si legano alle proteine dell'ospite
...
- ==Doripenem==, ==ertapenem==, ==imipenem==, ==meropenem==
	...
	3. ertapenem
		...
		- non è degradato dalle diidropeptidasi renali
- Farmacocinetica
...
>[!info]
>Poiché il farmaco è potenzialmente [[Teratoma|teratogeno]], è da **evitare la somministrazione in gravidanza**.
## Dalbavancina
- *Lipoglicopeptide semisintetico* derivato dalla teicoplanina
### Meccanismo d'azione
- Medesimo della vancomicina e teicoplanina
- Presenta maggiore attività nei confronti dei batteri gram+ (compresi MRSA, che siano completamente resistenti o a resistenza intermedia)
- **Non attiva** nei confronti della maggior parte dei ceppi di enterococco vancomicina-resistenti
### Caratteristiche farmacocinetiche
- $t_{1/2}$ estremamente lunga, di 6-11 g
	- consente una singola somministrazione IV/settimana
# Altri agenti attivi sulla parete o sulla membrana
## Daptomicina
- Nuovo lipopeptide ciclico prodotto di fermentazione di *Streptomyces roseosporus*
	- scoperta decine di anni fa, ma sviluppata solo di recente (necessità di farmaci attivi nei confronti di microrganismi resistenti)
	- ![Antibiotici agenti sulla parete o sulla membrana, struttura della daptomicina.](https://i.imgur.com/cWPVwxy.png)
>[!info]
>La daptomicina è considerata un'**efficace alternativa terapeutica alla** [[vancomicina]] e il suo ruolo clinico è in continua evoluzione.
### Azione
- Spettro d'azione simile a quello della vancomicina, con delle eccezioni:
	- è più rapidamente battericida in vitro
	- è **attiva contro** i ceppi di **Enterococchi e di S. aureus resistenti alla meticillina**
- Meccanismo d'azione
	- non completamente noto
	1. sembra che il farmaco *leghi la membrana* cellulare attraverso *inserzione della sua coda lipidica mediante un meccanismo che richiede il calcio*
	2. ==depolarizzazione della membrana== → perdita di K$^+$ → morte della cellula
	- ![Antibiotici agenti sulla parete o sulla membrana, meccanismo d'azione proposto della daptomicina.](https://i.imgur.com/MqWkXMU.png)
### Clearance
- Per via renale
### Dosaggio
>Negli studi clinici, la daptomicina ha presentato efficacia simile alla vancomicina
- Quantitativi:
	- 4 mg/kg → trattamento delle ==infezioni della cute e dei tessuti molli==
	- 6 mg/kg → trattamento di ==batteriemia e di endocardite==
	- > 6 mg/kg → terapia delle **infezioni serie**
- Somministrazione:
	- una volta/g → pazienti con funzione renale integra
	- a giorni alterni → pazienti con clearance della creatinina < 30 mL/min
### Azioni sfavorevoli
#### Muscolari
- Può causare ==miopatia==
	- dovrebbero essere controllati i valori sierici di *creatina-fosfochinasi*
#### Polmonari
- Il *fattore surfattante polmonare* antagonizza la daptomicina
	- dovrebbe essere **evitata** per le [[Polmoniti infettive|polmoniti]]
- Può causare ==alveolite allergica== in pazienti sottoposti a terapia prolungata (> di 2 settimane)
#### Insuccesso terapeutico
- Ne sono stati riportati rari casi associati ad un aumento dei valori di MIC negl'isolamenti clinici durante la terapia
...
- Altamente **nefrotossica** se somministrata per via sistemica
	- è ==utilizzata solamente per via topica== ed è ==scarsamente assorbita==
>[!info]
