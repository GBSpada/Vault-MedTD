...
- Morfologia
	- aggregati di **cellule rotonde di piccola taglia**
		...
		- organizzate in *strutture cordoniformi*, *nidi* e *isolotti* separati da una delicata trama fibrosa riccamente vascolarizzata
...
- Si presenta alla periferia del polmone
	- spesso in *sede sottopleurica*
- Tipica dell'adenocarcinoma e di una piccola percentuale di carcinoidi (10%), ma anche delle metastasi (soprattutto se multiple)
##### Forma simil-polmonite
- Sono presenti molte aree di consolidamento parenchimale, spesso confluenti
	- si configura un quadro simile alla [[Polmoniti infettive#Broncopolmonite|polmonite a focolai multipli]] o alla [[Polmoniti infettive#Polmonite lobare|polmonite lobare]]
- Forma macroscopica con cui si presenta l'==adenocarcinoma mucinoso==
#### Istotipi principali
##### [[Carcinoma squamocellulare polmonare]]
##### [[Adenocarcinoma polmonare]]
##### [[Carcinoma a grandi cellule]]
##### [[Carcinoma a piccole cellule del polmone]]
#### Istotipi meno frequenti
##### [[Carcinoma adenosquamoso (polmone)|Carcinoma adenosquamoso]]
##### [[Carcinoma sarcomatoide (polmone)|Carcinoma sarcomatoide]]
#### Eziopatogenesi
- Teorie
	- sviluppo di lesioni precancerose (==displasia epiteliale==)
		- displasia e carcinoma squamoso in situ → carcinomi squamosi
		-  iperplasia adenomatosa atipica/adenocarcinoma in situ→ adenocarcinomi
		- iperplasia polmonare diffusa idiopatica a cellule neuroendocrine (*DIPNECH*) → carcinoidi
	- *evoluzione non lineare nello sviluppo dei tumori*
		- il tipo di alterazione genica iniziale influenza il successivo sviluppo di lesioni invasive
#### Vie di metastatizzazione
- Diffusione per via linfatica, a linfonodi
	- ilari e mediastinici (carcinoma squamocellulare)
	- sopraclaveari (adenocarcinoma)
- Diffusione per via ematogena attraverso
	- vene bronchiali
	- vene polmonari
##### Organi "privilegiati"
- Encefalo
...
- Calo ponderale
- Emoftoe
##### Sindromi determinate
- ==Sindrome della vena cava superiore==
	- indotta da compressione od ostruzione
	- caratterizzata da
		- congestione ed edema del volto e del collo
		- cefalea
		- vertigini
- ==Sindrome di Pancoast==
	- determinata da tumori che insorgono nei lobi superiori polmonari, per compressione o infiltrazione del plesso brachiale
	- caratterizzata da
		- sintomatologia dolorosa
		- parestesie delle aree di innervazione del nervo ulnare
- ==Sindrome di Horner==
	- caratterizzata da
