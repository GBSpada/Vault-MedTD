2025-01-17 00:05
Stato: #idealibro 
Tag: #Farmacologia #ApparatoRespiratorio 
...
- Respiro sibilante,
- Dispnea,
- Colpi di tosse episodici e ricorrenti
#### Fisiologiche
- Diffuso reversibile restringimento delle vie aeree
- Marcato aumento della sensibilità bronchiale a stimoli broncocostrittori
#### Patologiche
- ==Infiammazione linfocitica ed eosinofila della mucosa bronchiale==
- ==Rimodellamento della mucosa bronchiale==:
	- ispessimento della lamina reticolare al di sotto dell'epitelio bronchiale
	- iperplasia delle cellule di tutti gli elementi strutturali delle vie aeree (vasi, muscolatura liscia, ghiandole secretorie e cellule a calice)
### Presentazione dei sintomi
#### Asma lieve
- Si verificano solo di rado, conseguentemente a
	- esposizione ad allergeni o ad alcuni inquinanti atmosferici
	- attività fisica
	- dopo un'infezione virale delle vie respiratorie superiori
#### Forme più gravi
- ==Attacchi frequenti di dispnea con sibili==, soprattutto di notte
- Ostruzione cronica delle vie respiratorie → ==riduzione persistente della funzione respiratoria==
### Prevenzione farmacologica
- Serve a prevenire gli attacchi asmatici gravi, data la disponibilità di trattamenti efficaci per
	- broncocostrizione acuta (farmaci per attacco acuto di asma)
	- riduzione dei sintomi e prevenzione degli attacchi (farmaci per il controllo dell'asma a lungo termine)
- La persistenza di un'elevata spesa sanitaria per la cura dell'asma[^1] è conseguenza di una **sottoutilizzazione delle terapie asmatiche disponibili**
- Cause del restringimento delle vie aeree negli attacchi asmatici acuti o "riacutizzazioni di asma":
	- contrazione della muscolatura liscia bronchiale
		- più facilmente antagonizzabile
	- ispessimento di tappi di muco denso nel lume bronchiale
	- ispessimento della mucosa bronchiale da edema, infiltrazione cellulare
		- richiede la somministrazione cronica di [[FANS; farmaci antireumatici; antidolorifici non oppioidi e farmaci usati nella gotta#Agenti antinfiammatori non steroidei|FANS]]
	- iperplasia di cellule secretorie, vascolari e muscolari lisce
#### Sollievo a breve termine (attacco acuto)
- Broncodilatatori (tra cui gli agonisti $\beta$-adrenergici): più ampiamente ed efficacemente utilizzati
- Anche la ==teofillina== e gli [[Farmaci bloccanti i recettori colinergici|antimuscarinici]]
#### Controllo a lungo termine
- Raggiunto più efficacemente con un agente antinfiammatorio (es. [[Gli steroidi corticosurrenalici e antagonisti|glucocorticoide]] per via inalatoria)
- Può essere anche ottenuto, sebbene meno efficacemente, con
	- antagonisti della via dei leucotrieni
	- inibitore della degranulazione mastocitaria (==acido cromoglicico==[^2] e ==nedocromil==)
- Studi clinici hanno dimostrato l'efficacia del trattamento con [[Anticorpi monoclonali (MAB)#Omalizumab|omalizumab]]
>[!warning]- In realtà
...
- In genere, gli agonisti adrenergici sono ==meglio erogati mediante inalazione==: ciò comporta maggiore effetto locale sulle vie aeree, con minore tossicità sistemica
	...
	- anche con particelle della dimensione ottimale di 2-5 $\mu$m, l'80-90% della dose totale è depositato nella bocca o nella faringe
...
### Altri farmaci
- Una più recente generazione d agonisti $\beta_2$-selettivi comprende ==salmeterolo== (agonista parziale), ==formoterolo== (agonista totale) e ==vilanterolo==
...
- ==Effetti cronotropo e inotropo positivi==
	- basse concentrazioni: questi effetti sono il risultato dell'**inibizione dei recettori presinaptici per l'adenosina a livello dei nervi simpatici**, con conseguente **aumento del rilascio di catecolamine a livello delle terminazioni nervose**
...
- Dovrebbe essere somministrata solo dove siano disponibili metodiche per la determinazione delle sue concentrazioni ematiche
...
- Una singola inalazione di glucocorticoide inalatorio e di un broncodilatatore $\beta_2$-agonista a breve durata di azione o 5-10 gg di terapia con budesonide o beclometasone due volte al giorno, somministrati ad alte dosi quando i sintomi di asma peggiorano sarebbero altrettanto efficaci della terapia giornaliera continua in adulti e bambini con asma lieve-moderata, per quanto queste strategie non siano consigliate dalle linee guida e non siano approvate da FDA
	- es. inalazione di ==beclometasone== per ciascuna inalazione di ==salbutamolo==
#### Terapia cronica
- Risultati
...
- Efficaci anche nel ridurre i sintomi delle **rinocongiuntiviti allergiche**
	- applicazione mediante spray nasali o colliri molte volte al giorno
...
- ==Montelukast== è indicato anche nei bambini di 6 anni
	- bambini di 2 < età < 5 anni → compresse masticabili da 4 mg V bustine di granulato da 4 mg
...
- Ruolo del ==tiotropio==
	...
	- nella terapia della BPCO
		- aumenta la funzionalità respiratoria, probabilmente mediante il suo effetto broncodilatatore
...
- L'**elevata prevalenza nel mondo di sviluppo** ed il suo **rapido aumento in quello in via di sviluppo** richiedono una strategia per la prevenzione primaria
	- è stato dimostrato inefficace evitare strettamente gli antigeni durante l'infanzia: crescere in una fattoria con animali domestici o in ambienti domestici ove vi siano gatti e cani può *proteggere* dallo sviluppo di asma
...
- Si è dimostrato efficace nell'aumentare il volume espiratorio forzato nel primo secondo (FEV$_1$) in maniera significativa rispetto al placebo
	...
	- in pazienti affetti dalla patologia suddetta, clinicamente stabili, che presentano la mutazione *G551D* nel gene CTFR in almeno un allele e aventi una previsione di FEV$_1$ >= 40%
