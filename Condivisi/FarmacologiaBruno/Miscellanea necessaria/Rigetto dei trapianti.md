...
- Attacco mediato principalmente dalle *citochine* (prodotte dai CTL) e da reazioni di ipersensibilità ritardata
>[!info]
...
>[!warning]
>È importante riconoscere il rigetto cellulare: in assenza di reazione umorale concomitante, i pazienti rispondono rapidamente alla terapia immunosoppressiva.
>- [[Ciclosporina]] → anche nefrotossica (al rigetto potrebbero sovrapporsi altre alterazioni istologiche)
###### Esame istologico
- Esteso infiltrato interstiziale di cellule mononucleate
- [[Edema]]
- Modesta emorragia interstiziale
###### Immunoistochimica
- Rileva la presenza di CTL CD4+ e CD8+
	- esprimono marcatori di attivazione (es. *catena β del recettore dell'IL-2*)
###### Aspetto
- Capillari glomerulari colpiti e peritubulari
	- cellule mononucleate invadenti i tubuli → **necrosi tubulare focale**
- Vasi colpiti
	- **endotelite**
	- rigonfiamento delle cellule endoteliali
	- incuneamento dei linfociti tra endotelio e parete del vaso
##### Rigetto acuto umorale (vasculite da rigetto)
- Mediato principalmente da *anticorpi antidonatore* → manifestazione con lesioni vasali:
	- vasculite necrotizzante
	- necrosi endoteliale
	- infiltrati ricchi di neutrofili
	- deposizione di immunoglobuline, complemento, fibrina e trombosi
###### Vasculite
- Associabile a
	- **necrosi estesa del parenchima renale**
...
- Indicativi di rigetto umorale: C4d è prodotto dall'attivazione del complemento per la via classica (anticorpo-dipendente)
	- diagnosi importante → indirizzamento verso una ==terapia con agenti causanti deplezione di CBL==
#### Rigetto cronico
>Principale causa del fallimento di trapianto: il rigetto acuto è ben controllato per mezzo terapia immunosoppressiva
- Quadro clinico:
	- **insufficienza renale progressiva** [[Patologia clinica - Rene#Clearance della creatinina|ipercreatininemia]] nell'arco di 4-6 mesi
	- alterazioni vasali
	- ==fibrosi interstiziale==
	- atrofia tubulare con perdita di parenchima
- ![Rigetto dei trapianti, rigetto cronico di trapianto di rene allogenico.](https://i.imgur.com/KG9Btpn.png)
##### Lesioni vascolari
- ==Densa fibrosi intimale obliterante==, soprattutto a carico delle arterie corticali
- Lesioni dei vasi → **ischemia renale** con
	- perdita di glomeruli
	- fibrosi interstiziale
	- atrofia tubulare
	- contrazione del parenchima renale
##### Glomeruli
- Segni di cicatrizzazione con duplicazione della membrana basale
	- un quadro detto *glomerulonefrite cronica da trapianto*
- Infiltrati interstiziali mononucleati
	- ricchi di plasmacellule ed eosinofili
### Metodi utilizzati per aumentare la sopravvivenza nei trapianti
#### Test di compatibilità HLA
- Il valore dei test tra donatore e ricevente varia nei diversi tipi di trapianto
##### Nei trapianti di rene
- Vi è un notevole vantaggio se tutti gli alleli HLA polimorfici sono compatibili
	- (entrambi gli alleli HLA-A, -B e DR di origine materna e paterna)
##### Nei trapianti di fegato, cuore e polmoni
- La tipizzazione HLA non si fa
- Rispetto ai benefici del test, prevalgono altre considerazioni:
	- compatibilità anatomica
	- gravità della malattia di base
	- necessità di minimizzare i tempi di conservazione dell'organo
...
- Farmaci
	...
	- [[Immunofarmacologia#Anticorpi monoclonali (MAB)|anticorpi monoclonali]]
>[!info]
>Un'altra recente strategia consiste nell'impedire che i linfociti T dell'ospite ricevano segnali costimolatori dalle DC all'inizio della sensibilizzazione. Si ottiene bloccando l'interazione tra
>- molecole B7 delle DC del donatore,
>- recettori CD28 dei CTL dell'ospite.
##### Effetti collaterali
- Non è trascurabile l'aumento della suscettibilità alle infezioni opportunistiche
	- [[Herpesvirus#Il virus di Epstein-Barr|EBV]], carcinomi squamosi [[Papillomavirus e Polyomavirus#Papillomavirus umani|HPV-indotti]] e [[Sarcoma di Kaposi|sarcoma di Kaposi]]
	- tutte verosimilmente indotte alla riattivazione di infezioni virali latenti in seguito all'indebolimento delle difese dell'ospite
#### Tecniche per favorire l'aumento della tollerogenicità
- Somministrazione al ricevente di cellule del donatore
	- sperando di causare un *chimerismo misto* a lungo termine
- Inoculo di TCL regolatori contestualmente al trapianto
- Induzione dell'apoptosi dei CTL alloreattivi del ricevente
## Trapianto di altri organi solidi
- Oltre al rene, possono essere trapiantati soprattutto fegato, cuore, polmoni e pancreas
- Il rigetto dei trapianti di sangue non è così violento come ci si potrebbe aspettare
	- basi molecolari di questa situazione privilegiata non chiare
## Trapianto di cellule emopoietiche
### Caratteristiche procedurali
- Sempre più utilizzato nel trattamento di
	- tumori del sangue
	- certe neoplasie dei tessuti solidi
	- aplasie midollari
	- talassemia
	- alcune immunodeficienze
- Differisce da quello degli altri organi solidi per vari aspetti, tra cui
	- ==immunodeficienza (acquisita)==
	- ==malattia causata dalla reazione del trapianto verso l'ospite==
#### Ottenimento delle HSC
- Si ricavano dal midollo, ma possono essere anche recuperate dal sangue periferico dopo essere state mobilizzate dal midollo attraverso somministrazione di fattori di crescita emopoietici
#### Nel paziente ricevente
- Viene irradiato per
	- distruggere il sistema immunitario (e talora anche le cellule neoplastiche)
	- creare un letto per il trapianto
### Reazione di trapianto verso l'ospite (GVH)
>*Si verifica in tutti i casi in cui i CTL immunocompetenti o i loro precursori vengano trapiantati in riceventi immunodepressi e le cellule trapiantate riconoscano gli alloantigeni dell'ospite*
- Osservabile più che altro nei trapianti di midollo, ma, in rari casi, anche
	- post trapianto di organi solidi ricchi di cellule linfoidi (es. fegato)
	- post trasfusioni di sangue non irradiato
- Minimizzazione della malattia → trapianti tra donatore e ricevente istocompatibili
#### GVH acuta
- Si manifesta dopo pochi gg o settimane dal trapianto di midollo allogenico
- Qualsiasi organo può essere colpito, ma soprattutto *sistema immunitario*, *epiteli della cute*, *del fegato* e *dell'intestino*
- Si ritiene che gran parte del danno sia causato da
	- *citochine* rilasciate dai CTL del donatore
	- citotossicità diretta da CTL CD8+
##### Lesioni cutanee
- Rappresentate da ==eritema generalizzato==
	- nei casi gravi, porta a desquamazione
##### Distruzione dei canalicoli biliari
- Causa l'ittero
##### Ulcere della mucosa intestinale
- Provocano diarrea emorragica
##### Lesioni tissutali
- Possono essere gravi, ma non sono caratterizzate da un consistente infiltrato linfocitario
#### GVH cronica
- Può seguire la sindrome acuta o avere un esordio insidioso
- Quadro morfologico:
	- estese lesioni cutanee
		- con distruzione degli annessi cutanei e fibrosi del derma
		- possono somigliare a quelle della ==sclerodermia==
	- [[Epatiti#Epatite cronica|epatopatia cronica]] con ==ittero colestatico==
	- lesioni gastrointestinali → ==stenosi esofagea==
- Sistema immunitario compromesso, con **involuzione del [[timo]]** e **deplezione linfocitaria linfonodale**
	- i pazienti sono soggetti a infezioni ricorrenti potenzialmente letali e alcuni sviluppano reazioni autoimmuni
#### Deplezione dei CTL del donatore
- ==Risultati contrastanti==
	- GVH ridotta
	- aumento di
		- numero di insuccessi dei trapianti
		- incidenza di linfomi di tipo B da EBV
		- recidive nei pazienti leucemici
- Sembra che i CTL siano necessari[^2] a
	- attecchimento HSC
	- soppressione dei cloni di CBL infettati da EBV
	- controllo delle cellule leucemiche
### Immunodeficienza (acquisita)
- Complicanza frequente
- Può essere dovuta a
	- terapia
	- trattamento mieloablativo di preparazione al trapianto
	- ritardo nel ripopolamento del sistema immunitario del paziente
	- aggressione del sistema immunitario dell'ospite da parte dei linfociti trapiantati
- Infezione da [[Herpesvirus#Citomegalovirus|citomegalovirus]]
	- più comune
	- generalmente dovuta alla riattivazione di una pregressa infezione latente
