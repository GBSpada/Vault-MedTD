...
##### pulsus parvus
- piccolo e debole
- frequentemente osservabile nelle condizioni di
...
>[!info]
>La valutazione palpatoria di sede, ampiezza, durata e direzione dell'itto cardiaco è, in genere, ottimale se effettuata coi polpastrelli. Il ==normale itto dell'apice ventricolare sx== è rilevabile sulla linea emiclaveare sx (o leggermente all'interno di questa) nel ==IV-V spazio intercostale==.
>- La ==percussione== dovrebbe essere eseguita in ogni paziente al fine di identificare la posizione, normale o anomala, di cuore, stomaco e fegato.
#### Condizioni patologiche
##### Ipertrofia ventricolare sx
- Aumento di ampiezza, durata e dimensioni del normale itto ventricolare
	- potrà essere rilevato in posizione anomala più laterale o caudale nel VI-VII spazio intercostale
	- particolarmente nei pazienti con sovraccarico di volume ventricolare (es. [[insufficienza aortica]] o [[cardiomiopatia dilatativa]])
##### Ipertrofia ventricolare dx
- Itto prolungato in regione parasternale inferiore sx
	- sincrono con l'itto apicale del ventricolo sx
##### Pulsazioni precordiali anomale
- Rilevabili durante la sistole in pazienti con *dissinergie ventricolari sx* secondarie a
	- [[Cardiopatia ischemica (IHD)|cardiopatia ischemica]]
	- miocardiopatie diffuse di altra natura
- Nella maggior parte dei casi, sono reperibili in ==regione precordiale sx==, ==uno o due spazi intercostali al di sopra dell'apice del ventricolo sx==
##### Grave insufficienza mitralica
>Vedi [[insufficienza mitralica]]
- Frequentemente osservato un ==itto parasternale sx== dovuto allo spostamento anteriore del ventricolo dx determinato dall'espansione dell'atrio sx allargato
- La *pulsazione dell'arteria polmonare* è spesso visibile e palpabile nel secondo spazio intercostale sx
	- denota, in genere, ipertensione o iperflusso polmonare
#### Fremiti
>[!info]
>Vibrazioni palpabili a bassa frequenza associate ai soffi cardiaci.
##### Insufficienza mitralica
- Soffio sistolico cupo, può essere palpato all'apice cardiaco
##### Stenosi aortica
- Il fremito s'irradia verso la parte dx del collo
##### Stenosi polmonare
...
>2. per rilevare un tono o un soffio di bassa intensità, si deve focalizzare l'attenzione sulla particolare fase del ciclo cardiaco durante la quale è possibile rilevare la presenza di quello specifico evento auscultatorio;
>3. L'accurata valutazione temporale di un tono o di un soffio cardiaco deve necessariamente passare attraverso la determinazione della sua correlazione con gli altri eventi del ciclo cardiaco clinicamente rilevabili (es. [[Diagnosi delle malattie cardiovascolari#Polso arterioso|polso arterioso carotideo]], [[Diagnosi delle malattie cardiovascolari#Polso venoso giugulare|PVG]] o itto apicale).
### Toni cardiaci
>I tawney tawney tawney cardiaci

>![ECG a confronto con altri tracciati.](https://i.imgur.com/3EwB2H3.png)

>[!info]
>**Toni cardiaci**: risultato di vibrazioni determinate dalla brusca accelerazione o decelerazione del sangue all'interno del sistema cardiovascolare:
>- T$_1$ → chiusura delle valvole AV;
>- T$_2$ → chiusura delle valvole semilunari.
#### Primo tono
- L'intensità è influenzata da
	1. posizione dei lembi mitralici all'inizio della sistole ventricolare
	2. velocità di ascesa dell'onda pressoria ventricolare sx
	3. presenza o assenza di alterazioni strutturali della valvola mitrale
	4. quantità di tessuto, aria o liquido tra cuore e stetoscopio
##### Aumento d'intensità
- Aumenta se
	- la diastole è accorciata (es. *tachicardia*)
	- il flusso atrioventricolare è
		- aumentato a causa di una gittata cardiaca elevata
		- protratto a causa di stenosi mitralica
	- le contrazioni atriali sono rapidamente seguite da quelle ventricolari a una distanza di tempo insolitamente breve (==intervallo PR accorciato==)
- Se *aumentato in presenza di stenosi mitralica*, generalmente significa che la *valvola* è **mobile** e **rimane aperta** all'inizio della contrazione isometrica a causa dell'elevata pressione atriale sx
##### Riduzione d'intensità
- Può essere dovuta a
	- diminuita conduzione di suoni attraverso le strutture toraciche
	- lenta ascesa dell'onda pressoria vetricolare sx
	- lungo intervallo PR
	- imperfetta chiusura secondaria a diminuzione della struttura vascolare (es. insufficienza mitralica)
- Può essere ridotto d'intensità anche nella *stenosi mitralica*: il lembo mitralico anteriore è ipomobile a causa di rigidità o calcificazioni
##### Sdoppiamento
- In due componenti ad alta frequenza? Con un intervallo di 10-30 ms? Stai chill, è normale
- Componenti
	- prima → chiusura della valvola mitrale
	- seconda → chiusura della valvola tricuspide
- ==Ampliamento della separazione delle componenti==: spesso dovuto a blocco di branca dx completo
#### Sdoppiamento del secondo tono cardiaco
- Normalmente rilevabile durante l'inspirazione:
	1. il maggiore ritorno venoso aumenta il volume di sangue contenuto nel ventricolo dx
	2. il periodo di eiezione viene aumentato, ritardando la chiusura della valvola polmonare
- Sdoppiamento in due componenti distinte:
	- A$_2$ → aortica
	- P$_2$[^1] → polmonare
		- coincide con l'==incisura caratterizzante la curva di pressione arteriosa polmonare==, separata dal tracciato pressorio ventricolare dx da un *intervallo* definito *"di distensione"* (*hangout time*), il cui valore assoluto riflette
			- la resistenza al flusso ematico polmonare
			- l'impedenza caratteristica del letto vascolare polmonare
	- P$_2$ < A$_2$ nel II spazio intercostale
		- se P$_2$ > A$_2$ in quest'area → ipertensione polmonare
##### Modificazioni dell'intervallo "di distensione"
###### Allungamento
- Aumento della separazione fisiologica di T$_2$
- Avviene in condizioni di sovraccarico di volume ventricolare dx con letto vascolare polmonare distensibile
###### Riduzione
- Associata a riduzione dello sdoppiamento di T$_2$
- Avviene nei pazienti con aumento delle resistenze vascolari polmonari
##### Sdoppiamento persistente durante l'inspirazione
- Anomalo quando il paziente è in posizione eretta
- Può essere dovuto a numerose condizioni:
	- ritardo di attivazione del ventricolo dx (blocco di branca dx)
	- extrasistoli ventricolari sx
	- presenza di pacemaker nel ventricolo sx
	- prolungamento della contrazione ventricolare dx a causa di un aumento del carico pressorio ventricolare
	- ritardo della chiusura della valvola polmonare a causa di un sovraccarico del volume ventricolare dx associato a insufficienza ventricolare dx
	- diminuita impedenza del letto vascolare polmonare e prolungamento dell'intervallo di distensione (difetto del setto interatriale)
##### Ipertensione polmonare
- P$_2$ aumentato d'intensità
- Lo sdoppiamento può essere diminuito, normale o accentuato
>[!warning]
>La chiusura precoce della valvola aortica, osservabile nell'insufficienza mitralica o nel difetto del setto interventricolare, può anch'essa determinare uno ==sdoppiamento persistente anche in espirazione==.
##### Sdoppiamento fisso del secondo tono
- Pazienti con ==ampia comunicazione interatriale==:
	1. il contributo al riempimento atriale dx determinato dallo shunt sx-dx e dal ritorno venoso sistemico varia in maniera reciproca durante le fasi del ciclo respiratorio
		- per cui l'afflusso all'atrio rimane quasi costante
	2. sia volume che durata dell'eiezione non aumentano in modo significativo
	3. si rileva una ==modesta variazione inspiratoria==
>Valore diagnostico particolarmente importante
##### Inversione dello sdoppiamento
- Determinato dal prolungamento meccanico della sistole ventricolare sx
	- esso può essere causato da
		- grave ostruzione all'efflusso aortico
		- ampio shunt aorta-arteria polmonare
		- ipertensione sistolica
		- cardiopatia ischemica
		- miocardiopatia primitiva con insufficienza ventricolare sx
#### Toni sistolici
##### Tono da eiezione
>[!info]
>Rumore ad alta frequenza, udibile in fase protosistolica, immediatamente dopo il primo tono cardiaco.
- Rilevabile in
	- *stenosi delle valvole semilunari* → schiocco di apertura
	- *dilatazione di aorta e arteria polmonare*
##### Click non da eiezione (mesosistolico)
- Accompagnato o meno da soffio telesistolico
- Denota spesso prolasso di uno o entrambi i lembi della valvola mitrale
	- risultato dell'==ineguale lunghezza funzionale== delle ==corde tendinee== di una o entrambe le valvole AV
	- meglio udibili lungo il margine sternale inferiore sx e all'apice
#### Toni diastolici
##### Schiocco di apertura (SA)
- Tono breve, protodiastolico, ad alta frequenza
- Generalmente dovuto a stenosi valvolare (soprattutto [[Stenosi mitralica|mitralica]])
###### Auscultazione
- Meglio udibile al *margine sternale inferiore sx*
- S'irradia bene verso la base del cuore
- Intervallo A$_2$-SA
	- inversamente proporzionale al valore di pressione media in atrio sx
	- 0,04-0,12 s
###### Implicazioni patologiche
- SA della stenosi tricuspidale → più tardivo in diastole rispetto alla stenosi mitralica, spesso mascherato
...
- Iniziano poco dopo T$_1$, quando la pressione nel ventricolo aumenta fino ad aprire le valvole semilunari
	- ↑ Velocità$_{\text{eiezione}}$ → ↑ soffio
	- ↓ Velocità$_{\text{eiezione}}$ → ↓ soffio
- La maggior parte dei soffi funzionali benigni[^3] è mesosistolica e origina dal tratto di efflusso polmonare
- Soffi aortici e polmonari sono intensificati dall'inalazione di ==nitrito di amile== (vedi [[nitrati e nitriti]])
>[!info]- Età e massima intensità all'auscultazione
>- Giovani adulti con parete toracica sottile e alta velocità del flusso ematico:
>	- soffio mesosistolico debole-moderato, udibile solo in corrispondenza dell'area polmonare, è in genere privo di significato clinico;
>	- soffio un po' più forte rilevabile a livello dell'area aortica può essere segno di *stenosi aortica congenita*
>- Anziani:
>	- soffi di origine polmonare sono rari
>	- soffi sistolici aortici sono frequenti e possono essere dovuti a
>		- dilatazione del vaso
>		- stenosi aortica di grado importante
>		- deformità non stenosanti della valvola

>[!warning]
>Al fine di distinguere con certezza tra un *soffio funzionale di notevole intensità* e un *soffio da stenosi congenita* di una valvola semilunare, possono a volte essere necessari l'[[Diagnosi delle malattie cardiovascolari#Ecocardiografia|ecocardiografia]] o il [[Diagnosi delle malattie cardiovascolari#Angiografia e cateterismo cardiaco diagnostico|cateterismo cardiaco]].
###### Soffio secondario a stenosi aortica
- Rappresenta il prototipo dei soffi mesosistolici sx
- Sede e irradiazione sembrano essere influenzate dalla direzione del "getto" ad alta velocità contro la parete della radice aortica
- Massimo nel 2° spazio intercostale dx, con irradiazione al collo
	- ==fenomeno di Gallavardin==: può scomparire lungo lo sterno ed essere nuovamente rilevabile all'apice, dando la falsa impressione che sia presente un'insufficienza mitralica
>[!warning]
>Nel caso in cui la **VA** sia **immobile** (calcifica), il tono di chiusura aortico (A$_2$) può essere debole o non udibile; in questi casi è difficile determinare lunghezza e configurazione del soffio.
...
- Da correlarsi a *disfunzioni dei muscoli papillari* secondarie a
	- infarto o ischemia
	- dilatazione ventricolare sx
- Possono comparire ==solo durante episodi anginosi==
	- in realtà, frequenti anche in pazienti con [[infarto miocardico]] o miocardiopatia diffusa
>[!warning]
>I soffi telesistolici udibili dopo click mesosistolici sono associati a insufficienza mitralica tardiva causata da prolasso della valvola nell'atrio sx.
#### Soffi diastolici
##### Soffi protodiastolici
- Iniziano con
	- T$_2$ ≡ riduzione della pressione ventricolare al di sotto dei valori di pressione aortica
	- immediatamente dopo ≡ riduzione della pressione ventricolare al di sotto dei valori di pressione polmonare
- I soffi ad alta frequenza di insufficienza aortica e polmonare sono ==in decrescendo==: si ha progressiva riduzione del rigurgito, del volume e della velocità durante la diastole
###### Insufficienza aortica
>[!warning]
>I soffi deboli, ad alta frequenza, sono difficili da udire, a meno che non vengano ricercati appositamente mediante ==compressione del diaframma dello stetoscopio sul tratto medio della linea marginosternale sx== col paziente in posizione seduta, piegato in avanti e col fiato trattenuto al termine dell'espirazione forzata.
...
- Processo di formazione:
	...
	3. continuano durante tutta la diastole o parte di essa
- Derivano da un flusso continuo dovuto a comunicazione tra aree ad alta e bassa pressione con gradiente persistente oltre la fine della sistole
###### Soffio da pervietà del dotto di Botallo
- *Pervietà del dotto arterioso di Botallo* → soffio continuo finché la p$_{\text{arteria polmonare}}$ << p$_{\text{aorta}}$
- Fattori influenzanti:
	- elevazione della p$_{\text{arteriosa}}$ → intensificazione
	- inalazione di ==nitrito di amile== → riduzione
	- l'ipertensione polmonare può far scomparire la parte diastolica del soffio
###### Soffi associati a fistole
- *Fistole arterovenose sistemiche*
	- congenite o acquisite
- *Fistole arterovenose coronariche*
	- origine anomale della coronaria sx dall'arteria polmonare
- *Comunicazione tra il seno di Valsalva e la parte dx del cuore*
###### Soffi da alterazioni di flusso arterioso
- In arterie sistemiche (es. renali) o polmonari, nel caso in cui vi sia una notevole differenza pressoria tra i due estremi di un tratto stenotico
- *Coartazione dell'aorta*: può essere presente un ==soffio continuo udibile al dorso==
###### Embolia polmonare
>Vedi anche [[Trombosi venosa profonda e tromboembolia polmonare#Pneumologia|qui]]
- Può manifestarsi con soffi continui che originano da vari parzialmente occlusi
##### Soffio mammario
- Soffio innocente udibile a livello delle mammelle durante la fine della gravidanza e l'inizio del puerperio[^5]
- Può essere sistolico o continuo
##### Murmure venoso cervicale
- Soffio innocente
- In genere udibile sulla faccia mediale della fossa sovraclaveare dx col paziente in posizione eretta
- In genere più intenso durante la diastole
- Può essere ==istantaneamente abolito== dalla ==compressione digitale della vena giugulare interna omolaterale==
>[!warning]
>La trasmissione di questo suono, se particolarmente intenso, verso l'area al di sotto delle clavicole, può portare all'errata diagnosi di pervietà del dotto arterioso di Botallo.
#### Soffio da sfregamento pericardico
- Diagnosi differenziale:
	- può presentare componenti da sfregamento sistoliche, proto- e telediastoliche
	- può venir confuso con un soffio o un rumore di origine extracardiaca se è udibile solo durante la sistole
- Auscultazione
	- ==meglio udibile== con il ==paziente in posizione eretta e piegato in avanti==
	- può essere ==accentuato durante l'espirazione==
# [[Elettrocardiografia]]
# Tecniche non invasive di imaging cardiaco: ecocardiografia, cardiologia nucleare e imaging RM/TC
## [[Ecocardiografia]]
## [[Cardiologia nucleare]]
## [[Imaging con risonanza magnetica e tomografia computerizzata in cardiologia|Imaging con risonanza magnetica e tomografia computerizzata]]
## Selezione della tecnica di imaging
### Considerazioni preliminari
>[!info]
>La scelta della tecnica ottimale per il singolo paziente dev'essere basata su
>- problematica maggiore da affrontare e altri quesiti clinici concomitanti;
>- esperienza del personale;
>- apparecchiature disponibili nella struttura in cui si opera.
>
>Devono, inoltre, essere considerati l'urgenza e il costo (può essere elevato per alcune tecniche).

>![Cardiologia, selezione della tecnica di imaging.](https://i.imgur.com/u5LTTo5.png)

#### Dimensioni e funzione del ventricolo sx
##### Ecocardiografia bidimensionale
- Tecnica primaria per la valutazione delle dimensioni del ventricolo sx, della sua funzione sistolica e dello spessore parietale
	- tecnica estremamente diffusa, agevole e permette una visualizzazione istantanea del cuore
	- può fornire informazioni utili in pazienti con possibile [[Scompenso cardiaco|insufficienza cardiaca]]
		- funzione valvolare
		- pressioni arteriose polmonari
		- riempimento diastolico
- **Limiti**:
	- ridotta risoluzione endocardica in alcuni pazienti
	- non riproducibilità delle misure quantitative
##### Angiografia radionuclidica
- Può produrre delle misure quantitative accurate della [[Cardiologia nucleare#Valutazione della funzione ventricolare|funzione ventricolare sx]], ma non è diffusamente disponibile e non può essere utilizzata nei pazienti con ritmo irregolare
##### SPECT
- In grado di misurare la frazione di eiezione come parte della valutazione da sforzo
##### RM e TC
- Permettono una maggiore qualità di risoluzione dei confini endocardici (==modalità più accurate==)
- Punti a sfavore (che portano a favorire l'ecocardiografia):
	- hanno un alto costo
	- non sono portatili
	- non forniscono contemporaneamente informazioni emodinamiche
#### Valvulopatie
##### Ecocardiografia bidimensionale e Doppler
- ==Esami di prima scelta==: forniscono sia informazioni emodinamiche sia anatomiche nelle valvulopatie
##### RM
- In grado di visualizzare i movimenti valvolari e determinare eventuali velocità di flusso irregolari attraverso le valvole
	- vi sono **meno conferme delle misurazioni emodinamiche quantitative**
#### Patologie del pericardio
##### Ecografia
- Esame di prima scelta in pazienti con *sospetto versamento pericardico* o *tamponamento cardiaco*
	- per via della portabilità e della rapidità con cui è possibile visualizzare le img
##### TC e RM
- Nei pazienti con *sospetta [[Malattie del pericardio#Pericardite costrittiva|pericardite costrittiva]]*, sono le tecniche che meglio determinano lo spessore del pericardio
##### Ecocardiografia Doppler
- Utile per l'analisi emodinamica dell'aumento dell'interazione ventricolare riscontrabile nella *pericardite costrittiva*
#### Patologia aortica
- Pazienti stabili con sospetto di [[Aneurismi e dissecazioni|aneurisma]] o [[Dissecazione aortica|dissecazione aortica]] → TC ed RM
- Paziente acuto con sospetta dissecazione → ecocardiografia transesofagea o TC
#### Masse cardiache
...
![Valori normali dei parametri emodinamici (tabella).](https://i.imgur.com/NXVTbVg.png)
#### Cateterismo del cuore sx
##### Procedura
4. Accesso dall'arteria femorale, brachiale o radiale
5. Il catetere viene fatto avanzare sotto guida fluoroscopica fino all'aorta e, quindi, in senso retrogrado, attraverso la valvola aortica, nel ventricolo sx
###### Catetere anche nel cuore dx
- Sarà possibile ottenere un profilo emodinamico completo
	- misurando le pressioni cardiache dx, sx e periferiche
	- stimando la portata cardiaca col metodo di Fick o della termodiluizione
###### Stenosi valvolare
- La misurazione delle pressioni a monte e a valle della valvola (quindi pressioni del ventricolo sx e dell'aorta ascendente per la stenosi aortica e la pressione capillare polmonare wedge e quella del ventricolo sx) può essere combinata con la misurazione del flusso ottenuta dalla portata cardiaca per poter calcolare l'area dell'orifizio valvolare stenotico
##### Tracciati
###### Normale
>[!info]- Vedi
>![Tracciati della pressione nel ventricolo sx e nell'arteria radiale e della PICP in un paziente con funzione cardiovascolare nella norma.](https://i.imgur.com/8Eurve4.png)
###### Stenosi mitralica
- Gradiente pressorio diastolico tra atrio sx e ventricolo sx visibile
>[!info]- Vedi
>![Tracciati della pressione di PICP e della VS in una donna di 40 anni con stenosi mitralica.](https://i.imgur.com/bVOydcD.png)
###### Insufficienza mitralica significativa
- *Onda v* marcata nella pressione capillare polmonare wedge che aumenta marcatamente con l'esercizio modesto
>[!info]- Vedi
>![Reperti emodinamici a riposo e durante sforzo in un soggetto con insufficienza mitralica.](https://i.imgur.com/Je3h7GL.png)
###### Stenosi aortica grave
- Gradiente pressorio sistolico tra la cavità ventricolare sx e l'aorta ascendente
>[!info]- Vedi
![Stenosi aortica grave.](https://i.imgur.com/rGpbJQx.png)
###### Insufficienza aortica severa
- Aumento della pressione differenziale, con equalizzazione delle pressioni aortica e ventricolare sx durante la diastole
>[!info]- Vedi
>![Insufficienza aortica grave.](https://i.imgur.com/KK1yJt0.png)
###### Patologia del cuore dx
- Producono alterazioni simili delle pressioni cardiache dx:
	- *insufficienza tricuspidalica* grave →  la pressione atriale dx si avvicina a quella ventricolare dx
	- *stenosi tricuspidalica* → gradiente pressorio diastolico tra l'atrio e il ventricolo dx
### Angiografia aortica e del ventricolo sx
#### Procedura
>Nel caso in cui le dimensioni e la funzionalità del ventricolo sx non siano state precedentemente valutate con tecniche non invasive
- Viene effettuata una ventricolografia sx con l'iniezione a pressione tramite un catetere adatto (generalmente a coda di maiale) di 30-45 mL di mezzo di contrasto nella cavità ventricolare sx a una velocità di 10-12 mL/s:
	- immagini radiografiche = profilo della cavità ventricolare sx durante tutto il ciclo cardiaco
	- tracciato del profilo in telediastole e telesistole → calcolo dei volumi assoluti del ventricolo → ==fraz. d'eiezione==
		- frazione del volume telediastolico espulso durante la sistole (normalmente 50-80%)
		- valutazione qualitativa di anomalie regionali della motilità parietale
- ==Rapida iniezione di mezzo di contrasto nell'aorta ascendente== al fine di rilevare *anomalie dell'aorta ascendente e della valvola aortica*
#### Anomalie della motilità parietale
- Includono
...
- Gravità della lesione
	...
	- *lesioni borderline* possono essere ulteriormente studiate con
		...
		3. utilizzo dell'ultrasonografia intravascolare con possibilità di
			...
			- misurare precisamente il diametro luminale nel punto della lesione borderline
