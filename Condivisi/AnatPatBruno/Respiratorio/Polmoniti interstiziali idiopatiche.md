...
---
# Anatomia patologica
## Di tipo cronico fibrosante
### Polmonite interstiziale comune (UIP)
#### Definizione
- La **UIP** (**Usual Interstitial Pneumonia**) è così definita perché è la più frequente di questa categoria di malattie (ca. 75% dei casi)
- Altri termini utilizzati in passato:
	- *fibrosi polmonare idiopatica*
	- *polmonite interstiziale cronica*
	- *alveolite fibrosante*
	- *alveolite fibrosante criptogenetica diffusa*
#### Epidemiologia ed eziopatogenesi
- Soprattutto maschi attorno ai 60
	- soprattutto fumatori/ex fumatori
- Eziologia
	- idiopatica nella maggior parte dei casi
	- ipotesi patogenetica più attendibile:
		1. deposito di [[Ipersensibilità mediata da immunocomplessi (tipo III)|immunocomplessi]] nell'interstizio
		2. reazione infiammatoria
		3. proliferazione mesenchimale
#### Correlazioni anatomocliniche
##### Decorso
- Anomalie interstiziali bilaterali diffuse con un fine pattern reticolare (fase iniziale)
- Progressivamente diviene più irregolare
- **Rigide dilatazioni irregolari multiple** (quadro tardivo-finale)
	- aspetto *a nido d'ape*
##### Sintomatologia
- Inizialmente
	- blanda e subdola
	- simil-influenzale, con ==tosse secca== e ==lieve dispnea==
- Col progredire della malattia
	- aumenta progressivamente la dispnea
	- compare la cianosi
	- il paziente presenta un'==insufficienza respiratoria ingravescente==
##### Prognosi
- Infausta
- Ca. 4-5 anni di sopravvivenza
	- modesta risposta alla terapia steroidea
#### Morfologia
##### Macroscopicamente
- **Polmone irregolarmente lobulato** sulla superficie esterna (*simile a un fegato cirrotico*)
- Consistenza dura
	- aspetto fibrotico, con multipli spazi cistici irregolari
- Sono prevalentemente colpite le basi polmonari
##### Microscopicamente
###### Fase iniziale
- [[Edema polmonare|Edema alveolare]]
- Infiltrato infiammatorio
	- prevalentemente *linfomonocitario*
- Necrosi e sfaldamento delle cellule alveolari
- Deposizione di *fibrina*
- Iperplasia degli [[Apparato respiratorio#Pneumociti di tipo II|pneumociti di tipo II]]
	- con ampio citoplasma
###### Fase intermedia
- Organizzazione fibroblastica intralveolare
- Ispessimento dei setti alveolari
	- deposizione fibroblastica di *collagene*
	- iperplasia del tessuto muscolare (sia peribronchiale che interstiziale)
	- perdita dei capillari alveolari
###### Fase tardiva
- Fibrosi marcata, con **totale scompaginamento del disegno alveolare**
	- inizia alla periferia del lobulo polmonare
- Il reperto è variegato
	- aree di tessuto ancora conservato
	- aree di fibrosi
		- *eterogeneità temporale*
			- aree sclerotiche ipocellulate
			- aree con una proliferazione fibroblastica-miofibroblastica "giovane"
				- abbondante componente di vasi
				- stroma mixoide
			- corrisponde ai tempi diversi dell'evoluzione della malattia
		- **aspetto a nido d'ape**
			- evoluzione finale di tutte le malattie fibrose polmonari croniche
			- la sua presenza non consente di fare mai una diagnosi specifica
				- necessario un campione tissutale con alterazioni meno avanzate
### Polmonite interstiziale non-specifica
#### Definizione
- Raggruppa forme non classificabili in uno degli altri tipi
- Contrariamente alla UIP, è caratterizzata dalla ==continuità spaziale e temporale della fibrosi polmonare==
	- in contrasto con l'eterogeneità caratteristica della UIP
#### Epidemiologia
- Prevalentemente adulti, con lieve predilezione per le donne
- Insorge in forma idiopatica
	- può associarsi a ==collagenopatie== o ad ==abuso di farmaci==
#### Correlazioni anatomocliniche
- Aree focali di opacità nei lobi inferiori
- Alla TC si osservano alterazioni di tipo *round-glass* alternate con un pattern reticolare
- Prognosi
	- molto diversa dalla UIP
	- una percentuale inferiore di pazienti va incontro a fibrosi progressiva e morte
	- la maggior parte dei pazienti ha andamento stabile
#### Morfologia
##### Microscopicamente
- Infiltrato *linfoplasmacellulare* interstiziale e *fibrosi*
- **Assenza di significativa alterazione del disegno degli spazi aerei**
	- ELEMENTO DIAGNOSTICO IMPORTANTE
- Distinzione in due gruppi:
	- uno meno frequente, caratterizzato da prevalenza di cellule infiammatorie
	- uno più frequente, caratterizzato da prevalenza di fibrosi
- Pattern
	- sempre uniforme e monomorfo
## Di tipo correlato al fumo
### Polmonite desquamativa interstiziale
#### Definizione
- Anche detta **DIP** (**Desquamative Interstitial Pneumonia**)
- Insorge frequentemente in giovani adulti
- Causa
	- sconosciuta
...
- Contrariamente alla DIP, ha 
	...
	- prognosi peggiore
		- possibilità di evoluzione anche dopo la cessazione del fumo di sigaretta (fatevi le canne insomma)
#### Morfologia
