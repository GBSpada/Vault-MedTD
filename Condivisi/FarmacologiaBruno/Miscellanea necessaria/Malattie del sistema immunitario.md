...
- Carboidrato tipico delle glicoproteine microbiche, ma non di quelle dell'ospite
##### Recettori delle opsonine
- Anticorpi
	- tipici dell'immunità acquisita
	- attivano il complemento tramite la **via classica**
- Complemento
	- attivato dai batteri nella **via della lectina** e nella **via alternativa**
#### Proteine circolanti
- *Lectina legante il mannosio* e *proteina C reattiva*
	- entrambe rivestono i batteri, favorendone la fagocitosi
### Epiteli
#### Cutaneo
#### Gastroenterico
#### Respiratorio
- [[Apparato respiratorio#Approfondimento cellule bronchiolari e fibrosi cistica|Surfactante polmonare]]
## Immunità acquisita
- Basata sui linfociti e sui loro prodotti
	- tra cui gli *anticorpi*
### Recettori linfocitari
- Molto più variegati rispetto a quelli del sistema innato
	- pur non essendo intrinsecamente specifici per i batteri, sono in grado di riconoscere una vasta gamma di sostanze estranee
### Tipi di immunità acquisita
#### Immunità umorale
- Protegge dai patogeni e dalle loro tossine
- Mediata dai **linfociti B** e dai loro prodotti di secrezione (*Ig*)
#### Immunità cellulo-mediata (o cellulare)
- Difende dai patogeni intracellulari
- Mediata dai **linfociti T**
## Componenti del sistema immunitario: cellule, tessuti e molecole
### Cellule del sistema immunitario
- *Homing*
	- operato dai linfociti
		- sono cellule "itineranti", poiché non risiedono unicamente in un dato tessuto
		- migrano negli organi linfoidi e negli altri tessuti del sistema circolatorio e linfatico
	- riconoscimento dei focolai d'infezione e migrazione attiva verso di essi
- Linfociti
	1. *vergini*
		- maturi, ma non hanno ancora incontrato i rispettivi antigeni
	2. differenziamento
		- *cellule effettrici*
			- in grado di eliminare gli antigeni
		- *cellule della memoria immunologica*
			- vivono in uno stato di allerta permanente
			- più efficienti nel combattere i patogeni dei quali hanno già avuto esperienza
- ![Linfociti, principali classi](https://i.imgur.com/GbVLet6.png)
#### Linfociti T
- **Linfociti T maturi**
	- presenti in circolo
	- costituenti ca. il 70% dei linfociti circolanti
##### Proteine di membrana
- ![Linfociti T, complesso recettoriale (TCR) e altre molecole implicate nell'attivazione linfocitaria: l'eterodimero TCR, formato da una catena a e una catena p, riconosce l'antigene (sotto forma di complesso MHC-peptide espresso dalle cellule che presentano l'antigene o APC), e l'associazione del complesso CD3 e delle catene J dà inizio alla trasduzione dei segnali di attivazione linfocitaria. Anche CD4 e CD28 sono implicati nell'attivazione dei linfociti T. (Alcuni linfociti T esprimono CD8 e non CD4; le due molecole hanno un ruolo analogo). Le dimensioni molecolari non sono in scala. MHC, complesso maggiore di istocompatibilità.](https://i.imgur.com/RgHYhvZ.png)
	- "Complesso del TCR"
		- **TCR**
...
- Il sangue drenato confluisce in una rete di sinusoidi
...
- Funzione
	...
	3. dopo aver legato il peptide, le molecole MHC-I si associano alla *$β_2$-microglobulina
		- formazione di un trimero stabile, che viene trasferito sulla membrana;
...
> - **Selezione clonale**: i linfociti in grado di riconoscere un'infinità di antigeni si sviluppano nell'organismo prima dell'esposizione agli antigeni e, quando un antigene penetra nell'organismo, seleziona le cellule con la specificità adatta, attivandole.
...
## Meccanismi delle reazioni da ipersensibilità
...
- **Selezione negativa** (o delezione)
	...
	- molti antigeni proteici autologhi sono elaborati e presentati dalle *APC timiche*, associati a *MHC autologhi*
		- capacità di riconoscimento da linfociti T potenzialmente autoreattivi
		- *proteina AIRE*
...
- Meccanismi
	1. espressione della *proteina BIM*
