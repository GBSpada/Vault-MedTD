...
>[!info] Meccanismi compensatori intrinseci
...
- ==Levosimendan==
	- meccanismo d'azione:
		- sensibilizzazione del sistema troponinico al Ca$^{2+}$
		- inibizione della vasodilatazione
	- alcune iniziali indagini cliniche suggeriscono che possa essere utile in pazienti con insufficienza cardiaca
- ==β-agonisti==: sono stati utilizzati come sostituti della digitale, ma possono aumentare la mortalità
### Bipiridine
- ==Inamrinone== (o amrinone) e ==milrinone== sono bipiridine che inibiscono la *PDE-3*
	- attivi per via orale e parenterale, ma disponibili solo per via parenterale
	- t$_{1/2}$ = 3-6h e il 30-40% viene eliminato con le urine
#### Farmacodinamica
- Meccanismo d'azione
	- inibizione della PDE-3 → aumento di cAMP → incremento della contrattilità + vasodilatazione
	- incremento dell'afflusso di Ca$^{2+}$ al cuore durante il potenziale d'azione
>[!info]
>Entrambi i farmaci sono attualmente utilizzati esclusivamente per IV e solo per l'insufficienza cardiaca acuta o esacerbazioni della cronica.
##### Inamrinone
- Tossicità comprendente nausea e vomito; aritmie, trombocitopenia e modifiche negli enzimi epatici
- Ritirato dal commercio in alcuni Paesi (Italia inclusa)
##### Milrinone
- Sembra causare meno tossicità midollare ed epatica, ma causa aritmie
### Stimolanti dei recettori $\beta$-adrenergici
>Vedi anche [[farmaci che attivano i recettori adrenergici ed altri simpaticomimetici]]
- ==Dobutamina==
	- agonista $\beta_1$-selettivo più largamente utilizzato
	- produce
		- aumento della gittata cardiaca
		- riduzione della pressione di riempimento ventricolare
	- è significativa la determinazione di angina/aritmie in pazienti con malattia coronarica, in quanto può causare **tachicardia** o **aumento del consumo miocardico di ossigeno**
- ==Dopamina==
	- usata nell'insufficienza cardiaca acuta
	- può essere particolarmente utile nel caso in cui serva innalzare la pressione arteriosa[^6]
## Farmaci privi di azione inotropo positiva utilizzati nell'insufficienza cardiaca
### Diuretici
- Rappresentano il ==sostegno principale== per il trattamento dell'insufficienza cardiaca
	- specialmente la furosemide
	- meccanismo d'azione:
		- non hanno un effetto diretto sulla contrattilità cardiaca
		- agiscono ==riducendo la pressione venosa e il precarico ventricolare==
			- ↓ ritenzione di sale e acqua + [[edema]]
			- ↓ dimensioni cardiache
- ==Spironolattone== ed ==eplerenone== (diuretici antagonisti dell'aldosterone) riducono anche morbilità e mortalità in pazienti con grave insufficienza cardiaca riceventi anche ACE-inibitori e altra terapia standard
>[!info]
...
- Meccanismo d'azione:
	...
	- ↓ angiotensina a livello tissutale → ↓ attività simpatica
		- (probabilmente attraverso la diminuzione degli effetti presinaptici dell'angiotensina sulla liberazione di adrenalina)
...
- Pazienti con ritmo sinusale normale e *largo intervallo QRS* hanno
	- desincronizzazione della contrazione ventricolare → riduzione della gittata cardiaca
- La ==resincronizzazione ottenuta con segnapassi== riduce la mortalità in pazienti con insufficienza cronica che stanno già ricevendo terapia ottimale
## Trattamento dell'insufficienza cardiaca diastolica
- Pare che i farmaci descritti e il ==nebivolo== siano più che efficaci sia nell'insufficienza diastolica che sistolica
- Risulta particolarmente importante il controllo dell'ipertensione
- Va considerata la ==rivascolarizzazione cardiaca== in presenza di malattia coronarica
## Trattamento dell'insufficienza cardiaca acuta
- Episodi si verificano frequentemente in pazienti con insufficienza cronica
	- di regola associati a
		- aumento di attività
		- emozioni
		- sale nella dieta
		- mancata aderenza alla terapia
		- aumento della domanda metabolica (causata da febbre, anemia, ecc.)
	- una causa particolarmente importante è l'[[infarto miocardico|infarto acuto del miocardio]]
		- trattamento mediante ==rivascolarizzazione di emergenza mediante angioplastica coronarica== ed uno ==stent==
	- molti dei segni e sintomi sono identici, ma le terapie divergono a causa di una risposta più rapida e relativamente maggiore frequenza e gravità della **congestione polmonare** nella forma acuta
>[!info] Pazienti con infarto acuto del miocardio e insufficienza cardiaca acuta
>Sono particolarmente utili misure della pressione arteriosa, della gittata cardiaca, dell'indice di lavoro pulsatorio e della pressione polmonare di incuneamento.
>Questi pazienti possono essere utilmente caratterizzati sulla base di tre misure emodinamiche:
>- pressione arteriosa,
>- pressione di riempimento ventricolare sx,
>- indice cardiaco[^8].
>Quando $p_{riempimento}$ > 15mmHg e IC < 20 gm/m$^2$, la mortalità è alta. Livelli intermedi di queste due variabili implicano una prognosi migliore.

- Trattamento IV = pratica comune
	- diuretici → ==furosemide== (più comunemente usata)
	- ==dopamina== e ==dobutamina==
		- farmaci inotropi positivi con rapido inizio e breve durata d'azione
		- molto utili in pazienti con seria ipotensione
	- ==levosimendan==
		- approvato in Europa per l'insufficienza acuta
		- è stata dimostrata la non inferiorità rispetto alla dobutamina
	- vasodilatatori
		- comprendono ==nitroprussiato==, ==nitroglicerina== e ==nesiritide==
		- riduzione del postcarico → ↑↑ frazione di eiezione, ma non della sopravvivenza
- Tra i pazienti con scompenso acuto, si ritrova, in un piccolo sottogruppo, [[iponatriemia]] (probabilmente per *aumentata attività vasopressinica*)
	- il ==conivaptan== (antagonista dei recettori $V_{1a}$ e $V_2$) è stato approvato
	- anche $V_2$-antagonisti correlati (==tolvaptan==) hanno apportato benefici in alcuni pazienti
# Sommario
![Farmaci usati nell'insufficienza cardiaca, sommario 1.](https://i.imgur.com/7mM4JeK.jpeg)
![Farmaci usati nell'insufficienza cardiaca, sommario 2.](https://i.imgur.com/8li5BHn.jpeg)
# Caso clinico
## Quesito
![Farmaci impiegati nell'insufficienza cardiaca: caso clinico - quesito.](https://i.imgur.com/i0WVBnM.png)
## Risposta
![Farmaci impiegati nell'insufficienza cardiaca: caso clinico - risposta.](https://i.imgur.com/YpvkaDQ.png)
