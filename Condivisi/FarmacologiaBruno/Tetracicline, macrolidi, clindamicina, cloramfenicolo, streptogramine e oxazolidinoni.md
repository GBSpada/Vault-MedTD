...
### Pompa di efflusso
- Le specie di gram- che esprimono la pompa di efflusso *Tet(AE)* sono
...
- Le tetracicline sono **escrete** per la maggior parte **nella bile** e **nelle urine**
	...
	- il **10-40%** del farmaco presente nell'organismo viene escreto **nelle feci**
...
#### Tigeciclina
>Prima *glicilglicina* ad essere impiegata in clinica, possiede caratteristiche uniche
- ==Molti ceppi tetraciclino-resistenti vi sono sensibili==
- Spettro molto ampio:
	- stafilococchi coagulasi-negativi e [[Staphylococcus aureus]]
		- inclusi ceppi meticillino-resistenti, ceppi vancomicina-resistenti e mediamente resistenti
	- [[Streptococchi viridanti|streptococchi]] penicillino-sensibili e resistenti
	- bacilli gram+ e gram-
	- Enterobacteriacee
	- ceppi multiresistenti di *Acinetobacter* sp.
	- anaerobi gram+ e gram-
	- rickettsie
	- Chlamydia sp.
	- *Legionella pneumophila*
	- micobatteri a rapida crescita
- Resistenza da parte di *Proteus* e *P. aeruginosa* (pompa di efflusso multifarmaco, citata prima)
##### Farmacocinetica
- Formulata solo per somministrazione IV, viene somministrata con dose di carico di 100 mg
	- in dosi di 50 mg ogni 12 h
- Come per tutte le tetracicline, la ==penetrazione intracellulare e tissutale== è ==eccellente==
	- volume di distribuzione piuttosto ampio
	- concentrazioni plasmatiche massime piuttosto smorzate
- Eliminazione
	- **prevalentemente biliare**
	- in pazienti affetti da insuff. renale, non si richiedono aggiustamenti posologici
##### Affetti avversi
>Oltre a quelli comuni alla classe
- **Nausea**
	- principale
	- si presenta in un terzo dei pazienti trattati
- **Vomito** (a volte)
>[!info]
>Solitamente, né nausea né vomito costringono a sospendere la terapia.
##### Usi clinici
- Approvata dalla FDA per la terapia di
	- **infezioni cutanee**
	- **infezioni intraddominali**
	- **polmonite acquisita in comunità**
- Non è efficace nelle infezioni delle vie urinarie e non è indicata per questo uso
	- le concentrazioni di farmaco attivo nelle urine sono piuttosto basse
- ==Attiva verso un'ampia varietà di patogeni nosocomiali multiresistenti a farmaci==
	- inclusi MRSA, ESBL e Acinetobacter[^1]
	- efficacia clinica in infezioni da microrganismi multiresistenti, confrontata con quella di altri farmaci, ampiamente sconosciuta
### Dosaggio
#### Via orale
- Dosaggio orale delle tetracicline rapidamente escrete (equivalenti a ==tetraciclina cloridrato==)
	- adulti → 0,25-0,5 g quattro volte al giorno
	- bambini (8 anni) → 20-40 mg/kg al giorno
	- dosaggio maggiore per infezioni sistemiche serie
- Dosaggi giornalieri per i singoli antibiotici:
	- ==demeclociclina== e ==metaciclina== → 600 mg
	- ==minociclina== → 100 mg
- La ==doxiciclina== è la tetraciclina di scelta:
	- può essere somministrata una volta al giorno
	- il suo assorbimento non è modificato in maniera significativa dagli alimenti
>[!warning]
>1. Tutte le tetracicline sono chelate dai metalli e non devono essere, quindi, assunte assieme a prodotti caseari, antiacidi e solfato di ferro.
>2. Per evitare la deposizione di tetracicline nelle ossa e nei denti in accrescimento, non si devono somministrare tetracicline
>	- durante la gravidanza,
>	- nei bambini di età < 8 anni.
#### Via parenterale
- Diverse tetracicline sono disponibili (negli USA) per impiego IV, a seconda dell'agente eziologico, a **dosi di 0,1-0,5 g ogni 6-12 h**
	- la ==doxiciclina== è l'agente preferito ad un dosaggio di 100 mg ogni 12-24 h
- Somministrazione IM sconsigliata per *dolore* e *flogosi* che compaiono al sito d'infezione
## Azioni sfavorevoli
- Le reazioni di [[Ipersensibilità immediata (tipo I)|ipersensibilità]] sono rare
- La maggior parte delle azioni sfavorevoli è legata alla ==tossicità diretta del farmaco== o ad alterazioni della flora batterica
### Azioni sfavorevoli gastro-intestinali
- **Nausea**, **vomito** e **diarrea**
	- reazioni più frequenti di sospensione dell'assunzione
	- effetti attribuibili ad ==irritazione locale del tratto intestinale==
- Possono essere controllate
	- somministrando l'antibiotico assieme ad *alimenti* o *carbossimetilcellulosa*
	- sospendendo la somministrazione del farmaco
- Modificano la normale flora con
	- soppressione dei microrganismi coliformi sensibili
	- crescita preferenziale di
		- Pseudomonas
		- Proteus
		- Stafilococchi
		- Coliformi resistenti
		- Clostridi
		- Candida
...
- Nelle ossa, causa **deformità** e **inibizione della crescita**
### Altra tossicità
#### Epatica
- Possono modificare la funzionalità epatica
	- durante la gravidanza (specialmente)
	- in pazienti con insuff. epatica preesistente
	- quando sia necessario somministrare IV dosi elevate
- ==Necrosi epatica== è stata riportata per dosi giornaliere IV di 4 g e più
#### Renale
- ==Acidosi renale tubulare== e altri danni renali che inducono ritenzione di composti azotati sono stati attribuiti alla **somministrazione di tetracicline scadute**
- Somministrazione contemporanea di tetracicline e diuretici
	- può causare **ritenzione di composti azotati**
- Si possono accumulare in pazienti con insuff. renale (ad eccezione della ==doxaciclina==)
#### Vascolare
- Iniezioni IV possono condurre a [[Emostasi e trombosi#Morfologia|trombosi venosa]]
#### Cutanea
- La somministrazione sistemica, specialmente di ==demeclociclina==, può indurre **sensibilizzazione alla luce solare o UV** (in particolare in persone con la pelle chiara)
#### SNC
- **Stordimento**, **vertigini** e **nausea** sono riportati
	- particolarmente con ==doxiciclina== a dosi superiori a 100 mg
	- con dosi di 200-400 mg al dì di ==minociclina== (nel 35-70% dei pazienti)
# Macrolidi
- Gruppo di composti strettamente correlati dal punto di vista strutturale
	- caratterizzati dalla presenza di un *anello lattonico macrociclico* (di solito 14-16 atomi) a cui sono attaccati zuccheri
- ==Eritromicina==
	- farmaco prototipo
	- costituita da due molecole di zuccheri unite ad un anello lattonico da 14 atomi
	- ottenuta nel 1952 dallo *Streptomyces erythreus*
- ==Claritromicina== e ==azitromicina==
	- derivati semisintetici dell'eritromicina
## [[Eritromicina]]
## Claritromicina
### Chimica
- Deriva dall'eritromicina, per aggiunta di un *gruppo metile*
- Possiede aumentata stabilità in ambiente acido e migliore assorbimento orale
### Spettro d'azione
>Medesimo meccanismo d'azione, (quasi) identico spettro antibatterico
- La claritromicina è
	- più attiva verso il *Mycobacterium avium*
	- attiva anche verso [[Mycobacterium leprae|M. leprae]], *Toxoplasma gondii* ed [[Haemophilus Influenzae]]
- Streptococchi e stafilococchi resistenti all'eritromicina sono resistenti anche alla claritromicina
### Farmacocinetica
#### Emivita e somministrazione
- Dose di 500 mg → concentrazione ematica di 2-3 $\mu$g/mL
- $t_{1/2}$ = 6h >>> [[Eritromicina#Emivita|eritromicina]] consente due sole somministrazioni quotidiane
	- dosaggio consigliato:
		- 250-500 mg due volte al giorno
		- 1000 mg nella formulazione a lento rilascio una volta al giorno
- Penetra in molti tessuti, raggiungendo concentrazioni eguali o superiori a quelle plasmatiche
#### Clearance
- Viene metabolizzata nel fegato
	- ==1,4-idrossiclaritromicina== → maggior metabolita, conserva attività antibiotica
- Una parte del farmaco è eliminata nelle urine
	- aggiustamento del dosaggio consigliato per pazienti con [[Patologia clinica - Rene#Clearance della creatinina|clearance della creatinina]] < 30 mL/min
		- es. 500 mg dose di carico, poi 250 mg una o due volte al dì
#### Interazioni farmacologiche
- Con farmaci simili a quelli dell'eritromicina
### Considerazioni
#### Vantaggi
- Rispetto all'eritromicina
	- minor frequenza di intolleranza gastrointestinale
	- possibilità di una minore frequenza di somministrazione
#### Svantaggi
- L'impiego in un contesto di esacerbazioni acute di **COPD** o di **polmoniti acquisite in comunità** è associata, soprattutto nei pazienti con COPD, con un ==maggior numero di eventi cardiovascolari==
## Azitromicina
### Chimica
- *Composto lattonico* con una nello macrolidico a 15 atomi
