2024-01-21 12:45
Stato: #Idealezione 
Tag: #ApparatoCardiocircolatorio #Anatomiapatologica #Patologia 
...
[[Poliangioite granulomatosa (o granulosi di Wegener)]]
### Vasculite infettiva
...
## Definizione
>[!info]
>**Vasculite**: gruppo eterogeneo di lesioni, per la maggior parte a ==patogenesi immunomediata==, caratterizzato da *manifestazione cliniche sistemiche aspecifiche* e, a livello istologico, da *fenomeni flogistici* della parete vasale che spesso si accompagnano a *necrosi* e *occlusione del vaso*, con conseguente ischemia dei tessuti a valle della lesione.
- Teoricamente, può essere colpito qualunque vaso di qualunque distretto anatomico
	- la distribuzione può essere *sistemica* o *localizzata*
	- talvolta si ha predominante localizzazione
		- polmonare
		- renale
		- nel SNC
- Insorgenza
	- *de novo*, come malattie primitive del vaso
	- nel contesto di alcune malattie sistemiche (*forme secondarie*)
>[!warning]
>Quando si parla di vasculiti, s'intendono spesso le *vasculiti primitive sistemiche*.
## Patogenesi
### Patogenesi multifattoriale
- Meccanismi patogenetici alla base delle vasculiti:
	1. infiammazione dovuta a processi immunitari (==vasculiti immunomediate==)
	2. danno diretto
		- minor numero di casi
		- può essere indotto da numerosi fattori
			- ambientali
				- trauma meccanico, radiazioni
			- infettivi (==vasculiti su base infettiva==)
			- tossici
				- reazione a tossine e ipersensibilità a farmaci
- È possibile che entrambi i meccanismi collaborino alla sviluppo della patologia
>[!info]- L'importanza dell'individuazione del meccanismo patogenetico
> Individuare il meccanismo patogenetico risulta molto importante dal punto di vista clinico:
> - ==terapia antinfiammatoria== → esclusiva delle vasculiti immunomediate
> - reazione da ipersensibilità a farmaci
> 	- responsabile di ca. il 10% delle vasculiti cutanee
> 	- risulta mediata dalla deposizione di complessi immuni
> 	- in caso di sospetta allergia a un farmaco, la sospensione del trattamento si associa spesso a un rapido miglioramento
>
	...
	- possono essere evidenziati mediante ==metodiche di immunofluorescenza indiretta su neutrofili fissati con etanolo==, con evidenza di
		...
		- pattern perinucleare (*p-ANCA*)
			...
			- osservato soprattutto nei pazienti con
				...
				- [[Poliarterite nodosa (PAN)|poliarterite nodosa]] (10%)
