...
- Associato ad ==emottisi==
	...
	- nella *parete* della caverna, vengono a formarsi dei piccoli [[Aneurismi e dissecazioni|aneurismi vasali]] (detti **aneurismi di Rasmussen**)
		- la loro rottura provoca abbondante sanguinamento (con espulsione attraverso il bronco comunicante con la caverna)
### Focolai tubercolari
>[!info]
> I cosiddetti focolai elementari sono lesioni contraddistinte da caratteristiche morfologiche e biologiche differenti, alle quali possono essere sostanzialmente ricondotte tutte le numerose presentazioni cliniche della tubercolosi. Queste, a loro volta, sono l'espressione di altrettante condizioni di interazioni immunitarie tra ospite e micobatterio.
#### Focolai isolato e nodulare
- Molto simili morfologicamente
	- caratterizzati entrambi da un *nucleo di necrosi caseosa* delimitato da una *rima di tessuto granulomatoso*
- Diversi sul piano clinico-evolutivo
##### Focolaio isolato
- Tende alla *circoscrizione* e all'*involuzione*
- Tipicamente rappresentato dal ***focolaio di Ghon del complesso primario*** (sembra il nome di un Gormito!)
##### Focolaio nodulare
- Tende all'*espansione* e alla *cavitazione* (formazione di caverna)
- Tipico delle lesioni della tubercolosi post-primaria
	- rappresenta, in particolare, il nodulo che, a seguito del drenaggio della necrosi caseosa, si escava e dà luogo alla caverna
#### Focolaio miliarico
- Corrisponde al classico "**tubercolo**"
	- da esso deriva anche il nome della malattia
- Esprime il granuloma con ==scarsa tendenza alla necrosi centrale==
	- tipico, invece, della miliare post-primaria
## Stadiazione
### Tubercolosi primaria
#### Definizione
>[!info]
> Con la definizione di tubercolosi primaria si indicano le modificazioni che avvengono, generalmente, nell'organismo a seguito del primo contatto con il bacillo tubercolare.
- Localizzazione, di norma, al polmone
	- dà luogo al cosiddetto *complesso primario*
	- raramente "complessi primari" possono presentarsi in altre sedi (es. intestino)
#### Morfologia
- Il tipico complesso primario polmonare è rappresentato da
##### Focolaio isolato parenchimale
- Generalmente subpleurico, di d=15 mm ca.
- Potenzialmente riscontrabile in qualsiasi punto dei lobi polmonari (solitamente nei campi polmonari medi)
- Denominato ==*focolaio di Gohn*==
###### Istologicamente
- Area di consolidamento infiammatorio di tipo fibrinoso o essudativo
	- può evolvere in granuloma (sempre con le caratteristiche del focolaio isolato)
##### Linfangite consensuale
- Generalmente caratterizzata da piccoli granulomi disseminati lungo il percorso dei linfatici
##### Linfoadenopatia ilare
- (S'intende l'ilo polmonare ovviamente)
- Caratterizzata da ==flogosi granulomatosa== con consistente ==necrosi caseosa==
	- espressione morfologica dell'attivazione dell'[[Malattie del sistema immunitario#Immunità cellulo-mediata (o cellulare)|immunità cellulo-mediata]] a seguito della presentazione dell'antigene da parte dei macrofagi
#### Correlazioni anatomocliniche
##### Complesso primario
- Generalmente colpisce l'infanzia
- Di norma poco sintomatico, talvolta asintomatico
...
- Disseminazione, in entrambi i campi polmonari, di numerosi piccoli noduli
	...
	- ciascuno dei quali con le caratteristiche morfologiche del granuloma tubercolare
