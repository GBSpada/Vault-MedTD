...
6. Post dissociazione di $H_2CO_3$,
...
- Relativamente *impermeabile all'acqua*, ma **permeabile ad alcuni soluti**
...
- **Cellule principali**: siti più importanti deputati al trasporto di $Na^+$, $K^+$ e $H_2O$
	1. presentano canali ionici distinti per $Na^+$ e $K^+$, che, escludendo gli anioni, determinano un movimento netto di cariche attraverso la membrana
...
>- Gli agenti antagonisti dell'ADH rappresentano una nuova classe di farmaci, i ==vaptani== (vedi [[Farmaci che interferiscono sull'escrezione di acqua (acquaretici)|acquaretici]]).
## Autacoidi renali
>[!info]
>*Autacoidi* (o *fattori paracrini*): sostanze chimiche, prodotte localmente da cellule/tessuti dell'organismo, che esercitano un'azione biologica a breve distanza dalla sua sede di produzione, senza entrare nella circolazione sistemica in modo significativo.
### Adenosina
- *Ribonucleoside non fosforilato* le cui concentrazioni aumentano in risposta all'ipossia e al consumo di ATP
#### Funzionalità
- Nel rene funzionante:
	1. ipossia → **vasodilatazione compensatoria** + **incremento del flusso ematico**
	2. aumento del flusso ematico → aumento della GFR + maggiore apporto di soluto ai tubuli
	3. maggiore apporto di soluto → maggiore lavoro tubulare + consumo di ATP
- Nel rene ipossico, l'adenosina:
	1. riduce il flusso ematico e la GFR
	2. ipossia$_{midollare}$ > ipossia$_{corticale}$ → ↑ riassorbimento di $Na^+$ corticale → ↓ carico di lavoro midollare
#### Recettori
- Ve ne sono quattro ($A_1$, $A_{2a}$, $A_{2b}$ e $A_3$), tutti rinvenuti a livello del rene
- Probabilmente, solo l'$A_1$
	- riveste importanza nella farmacologia dei diuretici
	- è localizzato in
		- arteriola afferente pre-glomerulare
		- tubulo contorto prossimale (PCT)
		- maggior parte degli altri segmenti glomerulari
#### Effetti dell'adenosina
1. ==Influenza il trasporto ionico== nel PCT, nel TAL dell'ansa e nei tubuli collettori
2. Riduce il flusso ematico al glomerulo (e la GFR)
	- rappresenta la molecola di segnale più rilevante nel processo di regolazione tubulo-glomerulare
3. ==Influenza il trasporto di $Na^+$== in numerosi segmenti:
	- nel PCT possiede un *effetto bifasico sull'attività NH3*:
		- aumento a basse concentrazioni
		- inibizione a concentrazioni molto elevate
	- gli ==antagonisti del recettore dell'adenosina== bloccano l'aumento dell'attività di NH3
		1. riducono la secrezione di $K^+$ dal tubulo collettore corticale
		2. a differenza degli altri diuretici, non determinano depauperamento di $K^+$
### Prostaglandine
>Vedi [[Gli eicosanoidi - prostaglandine, trombossani, leucotrieni e composti correlati|eicosanoidi]]
- Cinque sottotipi prostaglandinici ($PGE_2$, $PGI_2$, $PGD_2$, $PGF_{2\alpha}$, $TXA_2$) sono sintetizzati nel rene ed hanno recettori in quest'organo
#### $PGE_2$
- Agisce sui recettori $EP_1$, $EP_3$ ed $EP_2$ (probabilmente)
- Attenua
	- il riassorbimento di $Na^+$ nel TAL dell'ansa
	- il trasporto di acqua mediato da ADH nei tubuli collettori
>[!info]
...
- Mostrano notevoli effetti vascolari sistemici:
	- *recettori* $ANP_A$ e $ANP_B$[^1]: molecole transmembrana dotate di *attività catalitica guanilato-ciclasica* a livello del dominio citoplasmatico
	- funzioni espletate:
...
>[!info]
>Il ==metolazone== è il farmaco tiazido-simile impiegato in pazienti refrattari all'uso dei diuretici dell'ansa da soli. Risulta disponibile solo in preparazioni *per os*, mentre la ==clorotiazide== può essere somministrata per via parenterale.
...
>Nel trattare con diuretici un paziente con insufficienza cardiaca, dev'essere sempre ricordato che
...
- I pazienti presentano spesso **complessi problemi della gestione del volume**
	- possono presentare ritenzione sottoforma di *ascite* o *edema*, ma hanno ridotto volume plasmatico dovuto a riduzione delle pressioni oncotiche plasmatiche
		- in tali pazienti (con "alterazioni minime"), l'uso di diuretici può causare *ulteriore riduzione del volume plasmatico*, con
			1. possibili alterazioni della GFR
...
- ==Tiazidi==: utili nel trattamento di tutti i pazienti
	...
	- è ancora dibattuto se debbano essere utilizzate come terapia iniziale:
		- efficacia relativa in monoterapia
