...
### Forme "limitate"
- Circoscritte al tratto respiratorio
### Forma diffusa
- Occhi
- Cute
...
## Generalità
>[!info]
>**Poliangioite granulomatosa**: vasculite necrotizzante granulomatosa, distruttiva, che colpisce le arterie di medio e piccolo calibro e che si associa alla presenza di ==granulomi necrotizzanti==, e a ==lesioni renali caratteristiche==.
- Lesioni granulomatose e vasculitiche localizzate di preferenza in
	- distretto otolaringoiatrico
	- polmone
	- rene
- La malattia colpisce pazienti di tutte le età
	- picco d'incidenza nel V decennio di vita
	- lieve predilezione per il sesso maschile
## Patogenesi
- Eziologia ignota
- S'ipotizza un meccanismo [[Ipersensibilità cellulo-mediata (tipo IV)|cellulo-mediato]]:
...
- Sintomi respiratori associati a ==febbre== e ==perdita di peso==
##### Granulomatosi con lesioni cutanee e mucose
### Quadro microscopico
#### Granulomi necrotizzanti intra- ed extravasali
- Caratterizzati da ==ampie aree di necrosi di tipo ischemico==
	- circondate da un denso infiltrato di
		- linfociti
		- plasmacellule
		- granulociti neutrofili
		- cellule giganti multinucleate di tipo Langhans
