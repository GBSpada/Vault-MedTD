...
2. Macrofagi e DC esprimono recettori che riconoscono componenti del patogeno definiti *profili molecolari associati a patogeni* (*PAMP*)
	- recettori fra cui
		...
		- recettori *nucleotide-binding oligomerization domain* (NOD)-*like* (NLR)
		- recettori *scavenger*
...
- Sono necessari almeno due segnali per l'attivazione dei linfociti T:
	...
	2. legame di molecole costimolatorie, localizzate sulle APC, ai rispettivi ligandi[^1]:
		- *CD40* → *CD40L*
		- *CD80* o *CD86* → *CD28*
- L'attivazione delle cellule T è regolata attraverso una ==retro-inibizione negativa== che coinvolge un'altra molecola nota come *antigene 4 associato ai linfociti T* (*CTLA-4*):
...
## Glucocorticoidi
>Anche detti, in testi di lingua inglese, *corticosteroidi*
### Meccanismo d'azione
>Per informazioni nel dettaglio, vedi [[Gli steroidi corticosurrenalici e antagonisti#Meccanismo d'azione|qui]]
- Primi agenti ormonali di cui è stata riconosciuta ==azione linfocitolitica==
- La somministrazione di un qualsiasi glucocorticoide determina
	- riduzione del numero delle dimensioni delle cellule linfoidi in linfonodi e milza
	- ==assenza di effetti tossici sulle HSC== in proliferazione nel midollo osseo
- Si pensa che interferiscano col ciclo riproduttivo delle cellule linfoidi attivate
	- citotossici per alcune sottopopolazioni di CTL
	- i loro effetti sul sistema immunitario sono probabilmente dovuti alla loro capacità di modificare diverse funzioni cellulari piuttosto che alla citotossicità diretta
- Influenza sull'immunità umorale >>> influenza sull'immunità cellulare, eppure
	- risposta anticorpale:
		- primaria → può essere attenuata
		- già stabilite → mediante uso prolungato, possono essere ridotte
	- la somministrazione continua di corticosteroidi porta ad ==aumento della velocità di catabolismo== delle IgG (↓↓ concentrazione degli anticorpi specifici)
### Usi clinici
- Usati come farmaci di prima scelta in diverse condizioni per via delle loro azioni immunosoppressiva ed antinfiammatoria
- ==Modulano le reazioni allergiche==
	- utili nel trattamento di malattie quali l'[[asma bronchiale]]
	- utili come premedicazione prima dell'impiego di altri agenti (es. ==emoderivati==, ==chemioterapici==) in grado di causare risposte immuni indesiderate
	- ==trattamento immunosoppressivo di prima linea== nei trapianti sia di organi solidi che di midollo ematopoietico con risultati variabili[^2]
### Effetti tossici
>Vedi [[Gli steroidi corticosurrenalici e antagonisti#Farmacocinetica|farmacocinetica dei corticosurrenalici]] e [[farmacologia clinica dei glucocorticoidi]]
## Inibitori della calcineurina
### [[Ciclosporina]]
### [[Tacrolimus]]

## Inibitori di mTOR
- Comprendono ==sirolimus== (rapamicina) e i suoi analoghi, quali ==everolimus== e ==temsirolimus==
### Sirolimus
- Antibiotico [[Tetracicline, macrolidi, clindamicina, cloramfenicolo, streptogramine e oxazolidinoni#Macrolidi|macrolide]] immunosoppressore prodotto dallo *Streptomyces hygroscopicus*, strutturalmente simile a [[tacrolimus]]
#### Meccanismo d'azione
1. Si lega all'immunofillina circolante *FK506-binding protein 12*
2. Il complesso attivo formato inibisce l'attività chinasica del bersaglio mammario della rapamicina       (*mammalian target of rapamycin*, mTOR)
	- componente chiave di una complessa via di trasduzione del segnale coinvolta in processi cellulari quali crescita e proliferazione, angiogenesi e metabolismo
3. Blocco di mTOR → ==inibizione della proliferazione dei CTL== stimolata da interleuchine
#### Farmacocinetica di sirolimus ed everolimus
- $t_{1/2}\text{ everolimus}$ ≈ 43 h; $t_{1/2}\text{ sirolimus}$ ≈ 60 h
- Entrambi sono rapidamente assorbiti
- Eliminazione simile a quella di ciclosporina e tacrolimus
	- substrati di *CYP 3A* e della *glicoproteina-P*
	- si verificano, di frequente, interazioni farmacologiche:
		- associazione con ciclosporina → aumento dei livelli plasmatici di sirolimus ed everolimus
		- ==è necessario monitorare i dosaggi sulla base dell'indicazione clinica==
#### Usi clinici
##### Sirolimus
...
- Altri effetti indesiderati:
	...
	- vomito
	- tossicità cardiaca
	- [[Fisiopatologia#Ambiente cellulare liquidi ed elettroliti, acidi e basi|disordini dell'equilibrio idro-elettrolitico]]
### Leflunomide e teriflunomide
#### Leflunomide
- Profarmaco di un inibitore della sintesi delle pirimidine anziché delle purine
##### Farmacocinetica
>Vedi [[Immunofarmacologia#Teriflunomide|qui]]
- Attivo dopo somministrazione orale
	- il metabolita attivo, la *teriflunomide*, ha una $t_{1/2}$ di alcune settimane
- Terapia
	- dovrebbe essere iniziata con una [[Farmacocinetica e farmacodinamica#La dose di carico|dose di carico]]
	- dopo il raggiungimento dello stato stazionario, può essere somministrato una volta al giorno
##### Usi clinici
- Al momento, approvato solo per l'[[artrite reumatoide]]
- Sono in corso studi che lo combinano col [[Immunofarmacologia#Micofenolato mofetile (MMF)|MMF]] in
	- trattamento di diverse patologie cutanee su base autoimmune e infiammatoria
	- prevenzione del rigetto di trapianti d'organo allogenici
- Sembrerebbe avere anche un'azione antivirale
##### Tossicità
- Comprende
	- aumento degli enzimi epatici (con un certo rischio di danno epatico)
	- danno renale
	- effetti teratogeni
- Nel corso delle sperimentazioni, sono stati riportati rari effetti cardiovascolari ([[Angina pectoris|angina]], tachicardia)
#### Teriflunomide
- Metabolita attivo della leflunomide
##### Meccanismo d'azione
1. Inibisce reversibilmente la *diidrofolato deidrogenasi*
	- enzima mitocondriale chiave implicato nella sintesi di nuove pirimidine per la replicazione del DNA
2. Riduce l'attivazione delle cellule T e B, la loro proliferazione e funzione in risposta ad autoantigeni
>[!info]- Vantaggi
>- Consente, però, replicazione e funzione di cellule che si dividono lentamente e che utilizzano fonti esogene di pirimidin-nucleotidi attraverso la cosiddetta via di salvataggio.
>- Sperimentata in modelli murini di encefalomielite autoimmune, si è dimostrata capace di
>	- ritardare l'inizio della malattia,
>	- ridurre le ricadute,
>	- migliorare i sintomi neurologici.
##### Usi clinici
- Dopo Favorevoli successi ottenuti nella [[sclerosi multipla]] (iniziali e poi in studi di fase II), è stata registrata dalla FDA alla dose di 7 o 14 mg una volta al dì per via orale, con significativa riduzione di
	- frequenza delle recidive
	- progressione della disabilità (alla dose più elevata)
	- evidenza alla MRI dell'attività della SM (vedi anche [[Immunofarmacologia#Appendice la sclerosi multipla|qui]])
#### Farmacocinetica
- $t_{1/2}$ lunga:
	- 18 gg per la dose di 7 mg
	- 19 gg per la dose di 14 mg
#### Azioni sfavorevoli
- A parte i disturbi ricordati per la teriflunomide, sono state segnalate
	- diarrea
	- nausea
	- alopecia
	- neutropenia
...
- Trattamento di malattie infettive da [[Orthomyxovirus e Paramyxovirus#Virus respiratorio sinciziale|virus respiratorio sinciziale]], [[Herpesvirus#Citomegalovirus|citomegalovirus]], [[Herpesvirus#Virus della varicella e dell'*herpes zoster*|varicella-zoster]], HHV-3 e [[I virus responsabili di epatiti primarie#Il virus dell'epatite B|HBV]]
	- nonché rabbia[^3], tetano[^4] o sovradosaggio da digossina
...
- Modalità d'azione
	...
	- in altri casi, le citochine possono esplicare effetti ==antiproliferativi==, ==antimicrobici== e ==antitumorali==
- Scoperta:
	1. le prime scoperte furono gli *IFN*
	2. seguite dai *CSF* (*Colony Stimulating Factors*)
		- regolano la proliferazione e la differenziazione delle HSC
	3. molte delle citochine di più recente scoperta sono state classificate come *interleuchine* (*IL*) e numerate progressivamente in ragione della loro scoperta
		- prodotte con tecniche di clonazione genica
- Cenni di farmacocinetica
	- la maggior parte presenta una $t_{1/2}$ sierica molto breve (pochi min)
		- inclusi *TNF-α* *IFN-γ* *IL-2* *G-CSF* e *GM-CSF*
	- ==somministrazione sottocutanea== → più lento rilascio in circolo → più lunga durata d'azione
	- ogni citochina ha una propria caratteristica tossicità, ma alcuni effetti indesiderati sono comuni
		- IFN-α , IFN-β, IFN-γ, IL-2 e TNF-α inducono **febbre**, **sintomi simil-influenzali**, **anoressia**, **affaticamento** e **senso di malessere**
#### Interferoni
- Proteine generalmente raggruppate in tre famiglie: **IFN-α**, **IFN-β** e **IFN-γ**
##### Categorie
###### IFN di tipo I
- Comprendono le famiglie di IFN-$\alpha$ e IFN-$\beta$
- Caratteristiche:
	- proteine ==resistenti agli acidi==
	- agiscono interagendo con lo stesso tipo di recettore sulle cellule bersaglio
	- di solito, ==indotti dalle infezioni virali==
- Produzione:
	- leucociti → IFN-$\alpha$
	- fibroblasti e cellule epiteliali → IFN-$\beta$
###### IFN di tipo II
- IFN-$\gamma$
- Caratteristiche:
	- inattivato dagli acidi
	- agisce attraverso un recettore diverso presente sulle cellule bersaglio
- Produzione ad opera di linfociti T attivati
##### Funzioni
###### Proprietà immunostimolanti
- In particolar modo l'IFN$\gamma$
- Comprendono aumentata
	- presentazione dell'antigene
	- attivazione di macrofagi, cellule NK e CTL CD8+
###### Inibizione della proliferazione cellulare
- IFN-$\alpha$ e IFN-$\beta$ sono più potenti dell'IFN-$\gamma$
###### Aumentata espressione delle molecole MHC sulla superficie cellulare
- Mentre tutti e tre i tipi di IFN inducono molecole di MHC-I, ==solo l'IFN-$\gamma$ induce l'espressione di quelle di classe II==
- Cellule gliali: IFN-$\gamma$ → diminuzione della presentazione dell'antigene del SN
##### Usi clinici
###### IFN-$\alpha$
- Trattamento di varie forme di neoplasie
	- leucemia a cellule capellute
	- leucemia mieloide cronica
	- melanoma maligno
	- sarcoma di Kaposi
- Impiego nell'epatite B e C
- Si è dimostrato efficace come farmaco antitumorale in
	- carcinoma renale
...
###### IFN-$\beta$
- Trattamento della malattia cronica granulomatosa
##### Azioni sfavorevoli
- Comprendono **febbre**, **mialgia**, **mielosoppressione**, **cefalea** e **depressione**
- Ne possono fortemente limitare l'uso clinico
#### TNF-$\alpha$
- Sperimentato estesamente nella terapia di varie neoplasie maligne, ma con risultati scoraggianti (**tossicità dose-limitante**)
	- le uniche eccezioni sono l'uso intra-arterioso ad alte dosi nel [[melanoma]] e nel ==sarcoma dei tessuti molli delle estremità== (risposte > 80%)
#### Adiuvanti per i vaccini
- IFN e IL-2 hanno dimostrato effetti positivi nell'uomo nella risposta al vaccino per l'[[I virus responsabili di epatiti primarie#Il virus dell'epatite B|HBV]]
- IL ==denileukin difititox==
	- proteina di fusione fra IL-2 e la tossina difterica
	- usato per il trattamento di pazienti con ==linfoma cutaneo a cellule T CD25+==
>[!warning]
>È importante sottolineare che l'interazione delle citochine con le cellule bersaglio causa spesso la liberazione a cascata di diverse citochine endogene, che esplicano i loro effetti in maniera sequenziale o simultanea.
>- Es. l'esposizione all'IFN-$\gamma$ aumenta il numero di recettori per il TNF-$\alpha$ sulla superficie della cellula bersaglio;
>- Es. la terapia con IL-2 induce la produzione di TNF-$\alpha$, mentre quella con IL-12 induce la produzione di IFN-$\gamma$.
##### GM-CSF
>Anche *IL-12* e *GM-CSF* (==sargramostim==) si sono mostrati in grado di esplicare un effetto adiuvante
- Risulta di particolare interesse per la sua capacità di stimolare l'attivazione di APC specializzate
- Si ritiene sia in grado di indurre una risposta immunitaria antitumorale con regressione del tumore in
	- [[melanoma]]
	- [[Prostata#Patologia neoplastica|cancro della prostata]]
### Inibitori di citochine
- Utilizzati per il trattamento di malattie infiammatorie e dello shock settico
- ==Anakinra==
	- forma ricombinante dell'antagonista recettoriale di IL-1 (normalmente presente nell'uomo) che impedisce il legame di IL-1 al suo recettore, bloccando la cascata delle citochine rilasciate in seguito all'interazione di IL-1 con IL-1R
	- approvata per l'uso nei pazienti che non hanno risposto al trattamento con uno o più farmaci antireumatici che modificano il decorso della malattia
- ==Canakinumab==
	- anticorpo monoclonale ricombinante umano anti-IL-1$\beta$
	- si lega alla IL-1$\beta$, impedendone il legame ai suoi recettori
- ==Rinolacept==
	- proteina di fusione dimerica costituita da
		- domini di legame col ligando presenti nelle porzioni extracellulari dell'*IL-1RI* e dell'          *IL-1RAcP*[^12] uniti alla porzione Fc di una IgG$_1$ umana
	- trattamento delle sindromi periodiche associate alla ==criopirina==[^13]
>[!warning]
>I pazienti che stanno assumendo anche un farmaco anti-TNF-$\alpha$, che hanno un'infezione cronica o che sono immunodepressi, devono essere costantemente controllati per la possibile insorgenza di infezioni gravi o di neoplasie.
# Reazioni immunitarie ai farmaci e farmacoallergia
## Farmacoallergia immediata (tipo I)
![Immunofarmacologia, meccanismo dell'ipersensibilità di tipo I.](https://i.imgur.com/DBMPGTM.png)
### Farmaci per il trattamento dell'allergia immediata
...
- Trattamento:
	- i glucocorticoidi risultano utili per attenuare gravi reazioni a farmaci
