...
## [[Nitrati e nitriti]]
## Altri nitro-vasodilatatori
### Nicorandil
- Estere nitrato della *nicotinamide* con proprietà vasodilatatrici in arterie coronarie normali, ma effetti più complessi nei pazienti con angina
- Effetti
	- riduzione di precarico e postcarico
	- protezione miocardica per attivazione dei canali K$_{ATP}$ cardiaci[^4]
- Commercializzato in EU e Giappone
	- induce riduzione significativa del rischio relativo di eventi coronarici fatali e non fatali
#### Effetti tossici
- L'impiego può essere seguito dalla comparsa di **ulcere orali**, **genitali** e **perianali**
	- dolorose ed intrattabili se non con la cessazione del farmaco
## [[Farmaci bloccanti i canali del calcio (calcio-antagonisti)#Come antianginosi|Farmaci bloccanti i canali del calcio (calcio-antagonisti)]]
## Farmaci bloccanti i recettori $\beta$-adrenergici
>Vedi anche [[Farmaci antagonisti sui recettori adrenergici|qui]]
- Sebbene non siano vasodilatatori[^5], sono estremamente utili nel trattamento dell'*angina pectoris da sforzo*:
	1. effetti favorevoli legati, in primo luogo, alla loro ==azione emodinamica==, che riduce le richieste miocardiche di ossigeno (sia a riposo che sotto sforzo)
	2. la riduzione di frequenza è anche associata ad ==aumento del tempo di perfusione diastolica==
- Possono essere d'aiuto nel trattamento dell'*angina silente od ambulatoriale*
	- non provoca dolore → di norma svelata dalla comparsa di tipici segni di ischemia all'ECG
- La durata totale giornaliera del "tempo ischemico" è ridotta da una terapia cronica con $\beta$-bloccante
	- questo miglioramento induce riduzione dell'incidenza del reinfarto e della mortalità
### Effetti indesiderati
- **Aumento** del **volume telediastolico** e del **tempo di eiezione**
	- effetti controbilanciabili mediante l'impiego contemporaneo di [[Nitrati e nitriti|nitrati]]
- Controindicazioni:
	- [[Asma bronchiale|asma]] e altre affezioni broncospastiche
	- grave bradicardia
	- blocco atrioventricolare
	- sindrome bradicardia-tachicardia
	- grave instabile insufficienza ventricolare sx
- Possibili complicazioni:
	- senso di affaticamento
	- alterata tolleranza allo sforzo
	- insonnia
	- sonni spiacevoli
	- peggioramento di claudicazione
	- disfunzione erettile
## Nuovi farmaci antianginosi
![Nuovi farmaci antianginosi (tabella).](https://i.imgur.com/5hWAGl0.png)
### Ranolazina
- Più nuovo, sembra agisca riducendo una corrente tardiva di sodio (I$_{Na}$) che facilita l'ingresso del calcio attraverso lo scambiatore $Na^+$/$Ca^{2+}$ (*NCX*)
	- la riduzione delle concentrazioni di $Ca^{2+}$ intracitoplasmatico risultante riduce contrattilità e lavoro cardiaci
- Approvata per l'impiego nell'angina negli USA e in Italia
### Inibitori pFOX
- Inibiscono parzialmente la via di ossidazione degli acidi grassi nel miocardio
- Nel miocardio ischemico, il metabolismo devia verso la ==produzione di acidi grassi==; dunque il fabbisogno di $O_2$ per unità di ATP prodotto aumenta
...
- Terapia di mantenimento dell'angina stabile cronica → scelta tra i tre farmaci enunciati
	- ==pazienti ipertesi==: è adeguata una monoterapia con bloccanti del $Ca^{2+}$ o $\beta$-bloccanti
