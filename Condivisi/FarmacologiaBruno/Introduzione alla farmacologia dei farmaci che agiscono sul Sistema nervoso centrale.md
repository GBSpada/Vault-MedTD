...
# Canali ionici e recettori per i neurotrasmettitori
## Canali
...
- Eventi coinvolti nella trasmissione sinaptica:
	...
	3. il trasmettitore contenuto nelle vescicole viene liberato nello spazio sinaptico e giunge ai recettori siti sulla membrana postsinaptica
...
>- senza questa separazione, sarebbe impossibile modificare selettivamente le funzioni del SNC.
...
- Mediatore della **trasmissione eccitatoria**
	- presente in elevate concentrazioni (≈ 100 mM) nelle vescicole sinaptiche eccitatorie
...
###### Suddivisione
- Gruppo I
	- localizzati **postsinapticamente**: si pensa possano causare ==eccitazione neuronale per mezzo dell'attivazione di canali cationici non selettivi==
	- attivano anche la *PLC* → rilascio intracellulare di $Ca^{2+}$ indotto da $IP_3$
- Gruppi II e III
	- tipicamente localizzati sulle **terminazioni presinaptiche**
	- agiscono come inibitori: inattivano i canali del $Ca^{2+}$
	- attivazione:
		- avviene solo quando le concentrazioni di glutammato raggiungono livelli elevati in seguito a ripetuta stimolazione delle sinapsi
		- causa ==inibizione dell'*adenilciclasi*== → ridotta formazione di cAMP
#### Costituzione della membrana postsinaptica
- Spessa, chiamata zona ad alta densità postsinaptica (**postsynaptic density**, PSD)
- Struttura altamente complessa, contenente
	- recettori del glutammato
	- proteine di segnalazione
	- proteine *scaffolding*[^4]
	- proteine citoscheletriche
- Una tipica sinapsi contiene recettori
	- AMPA (tendono a localizzarsi più perifericamente nella sinapsi)
	- NMDA (sono concentrati nel centro)
- Gli altri recettori
	- KA → presenti in specifiche sinapsi eccitatorie, ma la loro esatta localizzazione non è nota
	- metabotropi (gruppo I) → localizzati appena al di fuori dalla PSD
		- anche presenti in determinate sinapsi eccitatorie
### GABA e glicina
#### Funzione
- Mediatori della **trasmissione inibitoria**
- Generalmente rilasciati dagl'interneuroni locali
	- glicina → confinati nel midollo spinale e nel tronco encefalico
	- GABA → presenti in tutto il SNC, escluso il midollo spinale
>[!warning]
> Alcuni interneuroni spinali possono rilasciarli entrambi.
#### Recettori
##### Glicina
- Strutture pentameriche selettivamente permeabili agli ioni $Cl^-$
>[!info]
> La ==stricnina==, potente convulsivante midollare utilizzata a scopo ratticida, blocca selettivamente questi recettori.
##### GABA
- Sono di due tipi:
	- $GABA_A$ → componente rapida del IPSP
	- $GABA_B$ → componente lenta del IPSP
- La diversità cinetica dei potenziali dipende dalle differenze nell'accoppiamento dei recettori ai canali ionici
###### $GABA_A$
- Sono **recettori ionotropici**
- Come i recettori della glicina, sono strutture pentameriche selettivamente permeabili agli ioni $Cl^-$
- Numerose subunità sono state clonate
	- ciò ne giustifica l'ampia variabilità farmacologica, rendendoli bersagli chiave per utili agenti terapeutici
	- sono antagonizzati selettivamente da ==picrotossina== e ==bicucullina==, due sostanze che causano convulsioni generalizzate
###### $GABA_B$
- Sono **recettori metabotropi**
- Sono accoppiati alle proteine G, che, in base alla loro localizzazione cellulare:
	- inibiscono i canali del $Ca^{2+}$
	- attivano i canali del $K^+$
- Funzione
	- componente $GABA_B$ delle IPSP
		- dovuta ad ==aumento selettivo della conduttanza al potassio==
		- ==gli IPSP prodotti sono durevoli e lenti==: l'accoppiamento dell'attivazione recettoriale all'apertura dei canali del potassio è indiretto e ritardato
	- localizzazione
		- regioni perisinaptiche → l'attivazione necessita di uno *spillover*[^5] del GABA
		- terminazioni assonali di molte sinapsi eccitatorie ed inibitorie
			- in questo caso, il GABA raggiunge per spillover questi recettori presinaptici, producendo inibizione del rilascio trasmettitoriale per inibizione dei canali del $Ca^{2+}$
	- oltre a regolare i canali ionici, ==possono anche inibire l'adenilciclasi==
- Possono essere selettivamente attivati dal farmaco antispastico ==baclofene==
## Acetilcolina
### Storicamente
- Primo composto ad essere identificato farmacologicamente come trasmettitore del SNC
- Eccles mostrò (inizio anni '50) che
	- l'eccitazione delle cellule di Renshaw da collaterali assonici motori veniva bloccata da antagonisti nicotinici
	- le cellule di Renshaw erano estremamente sensibili agli antagonisti nicotinici
- Gli esperimenti furono di notevole interesse per due ragioni:
	1. questo iniziale successo fu seguito da una delusione: rimase il solo circuito per cui fosse noto il trasmettitore fino ai tardi anni '60, quando divennero disponibili dati comparabili su GABA e glicina
	2. poiché la sinapsi collaterale assonica motoria rimane uno degli esempi meglio documentati di sinapsi nicotinica colinergica del SNC (nonostante la diffusa distribuzione dei recettori nicotinici)
### Recettori muscarinici
- La maggioranza delle risposte è mediata da un'ampia famiglia di *recettori muscarinici* accoppiati a proteina G
#### Recettori $M_1$
- Mediano una lenta eccitazione neuronale
- Gli effetti muscarinici sono molto più lenti degli effetti nicotinici sulle cellule di Reinshaw o di quelli degli amminoacidi eccitatori
	- ==eccitazione== insolita: l'Ach la ==provoca riducendo la permeabilità ionica della membrana al $K^+$== (opposto della normale trasmissione)
#### Recettori $M_2$
- Media una lenta inibizione del neurone aprendo i canali del $K^+$
### Circuiti
- Numerosi circuiti contengono Ach, inclusi
	- neuroni del neostriato
	- nucleo mediano settale
	- formazione reticolare
- Sembrano svolgere un importante ==ruolo nelle funzioni cognitive== (in particolare nella memoria)
>[!info]
>È stato provato che la demenza presenile del tipo di [[Malattia di Alzheimer|Alzheimer]] sia associata con una notevole perdita di neuroni colinergici.
>- La specificità di questa perdita è stata posta in discussione: anche i livelli di altri trasmettitori putativi (es. *somatostatina*) risultano ridotti.
## Monoammine
- Le vie in cui vengono localizzate sono il sito d'azione di molti farmaci (es. gli stimolanti del SNC) che si ritiene agiscano primariamente a livello delle sinapsi catecolaminergiche
	- ==cocaina== → blocco della ricaptazione di dopamina e NA
	- ==amfetamine== → rilascio di trasmettitori dai terminali presinaptici
### Dopamina
#### Localizzazione
- I maggiori circuiti contenenti dopamina sono costituiti da
	- proiezione che unisce la *substantia nigra* al neostriato
		- area associata all'azione farmacologica della ==l-dopa==
	- proiezione che unisce la regione tegmentale ventrale alle strutture limbiche (in particolare alla corteccia limbica)
		- area associata all'azione terapeutica dei ==farmaci antipsicotici==
- I neuroni contenenti dopamina sono presenti anche nell'ipotalamo tubero-basale
	- svolgono un'importante funzione nella regolazione di funzioni ipotalamo-ipofisarie
#### Recettori
- Ne sono stati identificati cinque sottotipi e sono suddivisi in due classi:
	- $D_1$-simili ($D_1$ e $D_5$)
	- $D_2$-simili ($D_2$, $D_3$, $D_4$)
- Sono **tutti metabotropi**
- La loro attivazione esercita una ==lenta azione inibitoria== sui neuroni del SNC
	- effetto meglio caratterizzato sui neuroni della substantia nigra, dove l'attivazione dei recettori $D_2$ provoca l'apertura dei canali del $K^+$ attraverso l'interazione con proteine $G_i$
### Noradrenalina
#### Localizzazione
- La maggior parte dei neuroni NA è localizzata in
	- *locus coeruleus*
	- area tegmentale laterale della formazione reticolare
- Sebbene la densità delle fibre vari in modo considerevole, la maggior parte delle regioni riceve diffusi impulsi noradrenergici
#### Recettori
- La maggior parte sono **metabotropi**
- $\alpha_2$ → mediano iperpolarizzazione, aumentando la conduttanza al $K^+$
	- effetto caratterizzato in dettaglio nei neuroni del *locus coeruleus*
#### Meccanismo d'azione
- Aumento degl'impulsi eccitatori mediante meccanismi
	- diretti = blocco della conducibilità al $K^+$ (freno sulla scarica neuronale)
	- indiretti = disinibizione[^6]
		- a seconda del tipo di neurone, quest'effetto può essere mediato da *recettori α* o *β*
- La facilitazione della trasmissione eccitatoria sinaptica è in accordo con molti dei processi comportamentali che si suppone coinvolgano circuiti noradrenergici (es. attenzione e risveglio)
### 5-idrossitriptamina
#### Localizzazione
- La maggior parte dei circuiti a 5-HT origina da neuroni situati in
	- **rafe**
	- regioni mediane del ponte e al di sopra del tronco encefalico
- Contenuta in fibre amieliniche che innervano in modo diffuso numerose regioni del SNC, ma varia la densità dell'innervazione
#### Recettori
- Agisce su più di una dozzina di recettori
	- tutti **metabotropi**
	- l'unica eccezione è costituita dal *recettore* $5-HT_3$: svolge una rapida azione eccitatoria su di un limitatissimo numero di aree nel SNC
- Recettori $5-HT_{1A}$
	- mediano una potente azione inibitoria nella maggior parte delle aree del SNC
	- agiscono mediante ==iperpolarizzazione della membrana== riconducibile all'==aumento della conducibilità al $K^+$==
		- è stato scoperto che condividono il medesimo canale per il $K^+$ coi recettori $GABA_B$
- Recettori $5-HT_2$ o $5-HT_4$
	- ==lenta eccitazione== dovuta ad un ==blocco dei canali del $K^+$==
>[!info]
>Entrambe le azioni eccitatorie ed inibitorie si possono verificare sullo stesso neurone.
#### Funzioni
- È stato spesso ipotizzato un possibile ruolo dei circuiti serotoninergici nelle allucinazioni indotte da ==LSD== (==acido lisergico==)
	- questo composto può antagonizzare le azioni periferiche della 5-HT
	- tuttavia
		- non sembra essere un antagonista della 5-HT nel SNC
		- il tipico comportamento LSD-indotto è ancora rilevabile negli animali dopo distruzione dei nuclei del rafe
