...
#### Altri effetti
- Effetti secondari includono ==miosi== e ==senso di ostruzione nasale==
- Blocco dei recettori $\alpha_1$ della base della vescica e della prostata → ==diminuita resistenza al flusso urinario==
	- gli $\alpha$-bloccanti sono usati in terapia per il trattamento della *ritenzione urinaria* conseguente a **iperplasia prostatica**
## Principali farmaci
![Farmaci antagonisti sui recettori adrenergici: selettività relativa degli agonisti sui recettori adrenergici (tabella).](https://i.imgur.com/J1RaVSp.png)
### Fenossibenzamina
#### Farmacodinamica
- Legame covalente coi recettori $\alpha$ → ==blocco irreversibile di lunga durata== (14-48h o più)
	- selettiva per i recettori $\alpha_1$, ma meno della prazosina
		- inibisce anche recettori $H_1$, $HT_2$ e colinergici
	- inibisce la ricaptazione della NE
- Azioni espletate[^2]
	- ==attenuazione della vasocostrizione indotta da catecolamine==
		- abbassamento pressorio relativamente piccolo nei soggetti sani supini
		- riduce decisamente la pressione quando il tono simpatico è elevato (es. a seguito di passaggio alla posizione eretta o a causa di ipovolemia)
	- si può avere ==aumento della gittata cardiaca==
		- sia di natura riflessa
		- sia come risultante del blocco dei recettori $\alpha_2$ presinaptici sui nervi simpatici cardiaci
#### Farmacocinetica
- Assorbita dopo somministrazione orale, sebbene
	- la [[Farmacocinetica e farmacodinamica#Biodisponibilità|biodisponibilità]] sia bassa
	- le sue caratteristiche farmacocinetiche non siano ben note
- Posologia:
	- somministrato *per os*:
		1. inizio con una bassa dose (10 mg/die)
		2. progressivo aumento fino a raggiungere l'effetto desiderato
	- dose < 100 mg/die → sufficiente ad ottenere un blocco adeguato
#### Usi clinici
- Soprattutto nel trattamento del **feocromocitoma**
#### Effetti sfavorevoli
- Tutti derivanti dalla sua azione di blocco
	- i più importanti sono *ipotensione posturale* e *tachicardia*
	- possono manifestarsi anche *occlusione nasale* e *inibizione dell'eiaculazione*
	- penetrando nel SNC → *affaticamento*, *sedazione*, *nausea* (sintomi meno specifici)
>[!warning]
>In quanto [[Agenti alchilanti|agente alchilante]], può manifestare altri effetti indesiderati non ancora caratterizzati (non è disponibile in Italia).
### Fentolamina
#### Farmacodinamica
- Potente antagonista competitivo su
	- recettori $\alpha_1$ → abbassamento delle resistenze periferiche
	- recettori $\alpha_2$
		- (probabile azione a livello vascolare, che contribuisce all'abbassamento delle resistenze)
		- può portare ad aumento del rilascio di NE dai nervi del SNC
- Stimolazione cardiaca data da ==attivazione del SNC==
	- risultato di meccanismi riflessi mediati dai barocettori
- Ha anche
	- modesti effetti inibitori a livello dei recettori della serotonina
	- effetti agonistici sui recettori muscarinici e su quelli $H_1$ e $H_2$ dell'istamina
#### Effetti indesiderati
- Collegati alla stimolazione cardiaca; dunque *grave tachicardia*,*aritmie* ed *ischemia miocardica*
#### Usi clinici
- Trattamento del **feocromocitoma**
- Talvolta utilizzata per ==velocizzare la ripresa dall'anestesia locale nei tessuti molli==
>[!info]
>Gli anestetici locali sono spesso somministrati in associazione a vasocostrittori (soprattutto *adrenalina*), che, rallentandone il passaggio in circolo, ne ==riducono l'allontanamento dal sito di somministrazione==.
>- La fentolamina, somministrata per infiltrazione locale[^3], è utilizzata alla fine della procedura medica per antagonizzare l'azione dei vasocostrittori e porre fine alla loro azione (difficilmente reperibile in USA, non disponibile in Italia).
### Prazosina
- *Piperazinil-chinazolina* efficace nel trattamento dell'ipertensione (vedi [[Farmaci antipertensivi#Prazosina ed altri $ alpha$-bloccanti|qui]])
- ==Altamente selettiva== per i recettori $\alpha_1$
	- affinità > 1000 volte rispetto agli $\alpha_2$ → ==relativa assenza di tachicardia==
	- portando a ==rilasciamento della muscolatura==
		- arteriosa
		- venosa
		- prostatica
- ==Notevolmente metabolizzata dal fegato==
	- solo il 50% risulta disponibile dopo somministrazione orale
	- $t_{1/2}$ ≈ 3h
- **Non** è disponibile in Italia
### Terazosina
- Altro antagonista reversibile $\alpha_1$-selettivo efficace nell'*ipertensione* e nell'*iperplasia prostatica benigna*
- Elevata biodisponibilità
	- pur essendo largamente metabolizzata nel fegato
	- una piccola parte è escreta con le urine
- $t_{1/2}$ = 9-12h
### Tamsulosina
- Antagonista competitivo sui recettori $\alpha_1$ (con struttura del tutto differente dagli altri)
	- maggiore affinità per $\alpha_{1A}$ e $\alpha_{1D}$ che per gli $\alpha_{1B}$
- Parametri farmacocinetici:
	- biodisponibilità elevata
	- $t_{1/2}$ = 9-15h
	- estesamente metabolizzata nel fegato
- Effetti clinici:
	- ==maggiore efficacia== nell'inibizione della contrazione del muscolo liscio *prostatico* piuttosto che quello *vasale*[^4]
	- effetti minori sulla pressione arteriosa dei pazienti in ortostatismo
>[!warning] Complicanze operatorie legate all'assunzione di tamsulosina
>I pazienti che la assumono, se sottoposti ad intervento chirurgico per **cataratta**, sono a maggior rischio di sviluppare la cosiddetta sindrome intraoperatoria dell'iride a bandiera (*intraoperative floppy iris syndrome*, IFIS), caratterizzata da
>- iride flaccida e fluttuante, tendente al prolasso,
>- miosi intraoperatoria progressiva.
## Altri antagonisti $\alpha$-adrenergici
### Alfuzosina
- *Derivato chinazolinico* con selettività $\alpha_1$, anch'esso approvato per il ==trattamento dell'*iperplasia prostatica benigna*==
- Parametri farmacocinetici:
	- biodisponibilità di ca. il 60%
	- $t_{1/2}$ ≈ 5h
- Può aumentare il rischio di **prolungamento dell'intervallo QTc** in soggetti predisposti
### Indoramina
- Agonista $\alpha_1$-selettivo efficace nell'*ipertensione arteriosa*
- Non disponibile sia in USA che in Italia
### Urapidil
- $\alpha_1$-antagonista con debole attività
	- agonista sui recettori $\alpha_2$ e $5-HT_{1A}$
	- antagonista sui recettori $\beta_1$
- Utilizzato in EU come agente *antipertensivo* e per il trattamento dell'*iperplasia prostatica benigna*
### Labetalolo
- Blocca sia i recettori $\alpha_1$ che quelli $\beta$
- See you soon
### Farmaci neurolettici
- Es. ==clorpromazina== e ==aloperidolo== sono potenti antagonisti ai recettori dopaminergici, ma possono anche antagonizzare i recettori $\alpha$
	- tra gli effetti avversi, di fatti, vi è l'**ipotensione** ([[Aspetti speciali di farmacologia geriatrica#Antipsicotici|attenzione ai vecchietti]])
### Trazodone
- [[Antidepressivi|Antidepressivo]] bloccante i recettori $\alpha_1$
### Alcaloidi della segale cornuta
- Es. ==ergotamina== e ==diidroergotamina==
- Causano un blocco reversibile dei recettori $\alpha$-adrenergici (probabilmente per azione agonista parziale)
### Ioimbina
- Alcaloide a *struttura indolica*[^5], antagonista $\alpha_2$-selettivo
- Usi clinici:
	- talvolta usato nel trattamento dell'*ipotensione ortostatica*: promuove la liberazione di NE attraverso il blocco dei recettori $\alpha_2$ presinaptici sia centrali che periferici
	- un tempo, era largamente usata per ==migliorare la disfunzione erettile maschile==, ma è stata poi soppiantata dagl'[[Nitrati e nitriti#Appendice farmaci usati nel trattamento della disfunzione erettile|inibitori della fosfodiesterasi V]]
>[!Avvertenze] 
>- Può causare
>	- aumenti della pressione arteriosa in pazienti assumenti inibitori della ricaptazione della NE,
>	- blocco dell'effetto antipertensivo di agonisti $\alpha_2$-adrenergici (es. ==clonidina==).
>- È stata ritirata dalla vendita negli USA esclusivamente per ragioni commerciali, ma è ancora disponibile come integratore dietetico (non in Italia).
# Farmacologia clinica degli antagonisti sui recettori $\alpha$-adrenergici
## [[Feocromocitoma#Farmacologia|Feocromocitoma]]
## Emergenze ipertensive
- Gli $\alpha$-antagonisti hanno un uso limitato (salvo il ==labetalolo==)
- Teoricamente, sono utili in modo particolare quando l'aumento di pressione riflette un
	- eccesso di $\alpha$-agonisti in circolo
		- *feocromocitoma* o ipertensione da *tiramina* in pazienti trattati con ==inibitori delle MAO==
		- sovradosaggio da simpaticomimetici
		- sindrome da sospensione brusca di clonidina o intossicazione da organofosfati *trattati con atropina*
- Sono preferibili altri farmaci: ==è necessaria notevole esperienza per usare in modo sicuro farmaci del genere nelle suddette condizioni==
	- (il libro specifica che solo pochi medici la hanno)
## Ipertensione cronica
- ==Antagonisti $\alpha_1$-selettivi==
	- della famiglia della ==prazosina==
	- efficaci nella terapia dell'ipertensione sistemica di grado lieve/moderato
	- ben tollerati, ma il loro ==uso in monoterapia== ==non== è ==raccomandato==: altre classi sono più efficaci nel prevenire l'insufficienza cardiaca
	- effetto indesiderato maggiore = **ipotensione posturale**
		- è interessante notare come non siano determinate modifiche del profilo delle lipoproteine (non si sa come mai[^7])
- ==$\alpha$-antagonisti non selettivi==
	- utilizzati nell'*ipertensione sistemica essenziale*
	- ==prazosina== e farmaci correlati possono essere associati a **sensazioni di vertigini**
>[!warning]
>Le variazioni della pressione arteriosa dovute a cambi di postura dovrebbero essere controllate su base routinaria in tutti i pazienti trattati per ipertensione arteriosa.
## Malattie vascolari periferiche
>[!warning]
>Non è stato dimostrato che gli $\alpha$-bloccanti svolgano effetti significativi quando variazioni morfologiche limitano il flusso ematico nei vasi.
>- Occasionalmente, individui affetti dalla [[Disturbi da iperreattività dei vasi sanguigni#Fenomeno di Raynaud|sindrome di Raynaud]] o altre condizioni caratterizzate da vasospasmo reversibile traggono beneficio da ==prazosina== o ==fenossibenzamina==, ma i ==bloccanti del calcio== sono preferibili.
## Ostruzione urinaria
- [[Prostata#Patologia iperplastica|Iperplasia prostatica benigna]] (IPB)
	- patologia frequente negli anziani
	- ==terapia farmacologica inefficace in molti pazienti==
- Trattamento
	- coinvolge l'==inibizione parziale della contrazione della muscolatura liscia nella prostata iperplastica e alla base della vescica==
		- anche altre azioni esercitate da alcuni $\alpha_1$-antagonisti possono contribuire
	- sono efficaci ==prazosina==, ==doxazosina== e ==terazosina== (soprattutto nei pazienti ipertesi)
	- antagonisti $\alpha_{1A}$-selettivi potrebbero portare ad un aumento dell'efficacia e della sicurezza del trattamento (già detto per la [[#Tamsulosina|tamsulosina]])
		- ==silodosina==: nuovo $\alpha_1$-antagonista con maggiore selettività per il sottotipo $\alpha_{1A}$ recentemente approvato
## Disfunzione erettile
- Iniezione dell'associazione ==fentolamina== + ==papaverina== → erezione in uomini con disfunzione
	- rispettivamente $\alpha$-antagonista e vasodilatatore non specifico
	- c'è la possibilità che insorgano *reazioni fibrotiche* (soprattutto nel trattamento a lungo termine[^8])
	- assorbimento sistemico → ipotensione ortostatica
	- **priapismo**: può necessitare un trattamento con un agonista (es. ==fenilefrina==)
- Terapie alternative comprendono
	- [[Gli eicosanoidi - prostaglandine, trombossani, leucotrieni e composti correlati#Effetti di prostaglandine e trombossani|prostaglandine]]
	- [[Nitrati e nitriti#Appendice farmaci usati nel trattamento della disfunzione erettile|inibitori della fosfodiesterasi V]]
## Applicazioni degli $\alpha_2$-antagonisti
- ==Uso clinico relativamente scarso==
	- beneficio limitato nel trattamento della *disfunzione erettile*
	- c'è interesse sperimentale nello sviluppo di antagonisti altamente specifici per il [[Diabete#Tipo II|diabete di tipo II]][^9] e nella depressione maggiore
# Farmacologia di base degli antagonisti sui recettori $\beta$-adrenergici
- Occupano i recettori β-adrenergici e ==riducono in modo competitivo l'occupazione da parte di catecolamine e altri β-agonisti==
	- la maggioranza sono **antagonisti puri** → l'occupazione recettoriale non causa attivazione
	- alcuni sono *[[Recettori dei farmaci e farmacodinamica#Agonisti parziali|agonisti parziali]]* → inducono attivazione parziale, ma in misura inferiore ad agonisti pieni
	- alcuni sono *[[Introduzione - farmacologia#Farmaci agonisti inversi|agonisti inversi]]* → agiscono in senso inibitorio su recettori $\beta$ costitutivamente attivi
- Rilevante è la differenza tra le affinità relativa per i recettori $\beta_1$ e $\beta_2$
	- dato che nessuno ha selettività assoluta per i $\beta_1$, ==la selettività è correlata alla dose==
- Altre differenze riguardano
	- caratteristiche farmacocinetiche
	- effetti stabilizzanti di membrana alla base dell'azione anestetica locale
>[!info]- Strutture chimiche
...
- Effetti sul sistema vascolare
	...
	- nello specifico:
		...
		4. aumento rapido delle resistenze periferiche (dunque del postcarico)
...
- ==Sotalolo==
	...
	- presenta marcate proprietà come [[Farmaci impiegati nelle aritmie cardiache#Farmaci che prolungano il periodo refrattario effettivo prolungando il potenziale d'azione (classe III)|antiaritmico di classe III]] (blocca i canali del $K^+$)
## Principali farmaci
### Propanololo
...
- Attività recettoriale:
	...
	- blocca i recettori $\beta$ con potenza lievemente meno bassa del ==propanololo==
- L'**ipotensione indotta** è accompagnata da *tachicardia* di grado minore a quello rilevato nel caso di ==fentolamina== e analoghi
### Carvedilolo, medroxalolo, bucindololo
- $\beta$-antagonisti non selettivi, con qualche effetto anche $\alpha_1$-bloccante
#### Carvedilolo
- Più potente nell'antagonizzare le azioni delle catecolamine sui recettori $\beta$ che $\alpha_1$
- Farmacocinetica:
	- $t_{1/2}$ = 6-8h
	- largamente metabolizzato nel fegato e si osserva metabolismo stereoselettivo dei suoi due isomeri
		- il metabolismo dello (*R*)-carvedilolo è influenzato da *polimorfismi del CYP2D6*, possono verificarsi interazioni farmacologiche (es. ==chinidina== e ==fluoxetina==)
- Aspetti contribuenti ai benefici clinici nell'insufficienza cardiaca cronica:
	- ==attenuazione della **perossidazione lipidica** innescata dai ROS==
	- ==inibizione della **mitogenesi del muscolo liscio vasale** in maniera indipendente dal blocco dei recettori adrenergici==
### Esmololo
- Antagonista $\beta_1$-selettivo a durata d'azione ultrabreve
- Biotrasformazione: la struttura contiene un *estere*:
	1. le *esterasi* delle emazie lo metabolizzano rapidamente
	2. diviene, così, un ==metabolita a bassa affinità per i recettori β==
	3. $t_{1/2}$ ≈ 10 min
	4. nel corso dell'infusione continua:
		- concentrazioni allo stato stazionario → raggiunte rapidamente
		- attività terapeutiche → si esauriscono rapidamente quando s'interrompe l'infusione
- ==Molto più sicuro da usare== di un antagonista a lunga durata d'azione
- Può essere utile nel controllo di
	- aritmie sopraventricolari
	- aritmie associate a tireotossicosi
	- ipertensione perioperatoria
	- ischemia miocardica acuta
### Butossamina
- Farmaco $\beta_2$-selettivo utilizzato nella ricerca sperimentale
>[!warning]
>Nessun $\beta_2$-bloccante ha applicazioni cliniche ovvie né è disponibile per l'utilizzo clinico.
# Farmacologia clinica degli antagonisti sui recettori $\beta$-adrenergici
### Ipertensione arteriosa
>[!warning]
>Anche se molti pazienti ipertesi rispondono ai $\beta$-bloccanti usati da soli, questi farmaci sono più spesso usati in associazione ad un [[Diuretici|diuretico]] o un vasodilatatore.
- Nonostante la breve $t_{1/2}$ di molti agonisti, essi possono essere ==somministrati una volta o due al dì==, mantenendo un effetto terapeutico adeguato
	- ==labetalolo==: antagonista sia $\alpha$ che $\beta$, efficace, anche se il suo ruolo è ancora da definire
	- vi è qualche indicazione che siano ==meno efficaci negli afroamericani e negli anziani==
- Per una visione più dettagliata, [[Farmaci antipertensivi#Bloccanti $ beta$-adrenergici|vavatinni a fanculo]]
### Malattia ischemica cardiaca
- I $\beta$-bloccanti riducono la frequenza cardiaca degli episodi anginosi e migliorano la tolleranza all'esercizio fisico in molti pazienti affetti da *[[angina pectoris]]*
	- blocco dei recettori $\beta$ → ↓ lavoro cardiaco + ↓ domanda di $O_2$
		- rallentamento e regolarizzazione del battito possono contribuire al beneficio clinico
		- ![Farmaci antagonisti sui recettori adrenergici: frequenza cardiaca misurata tramite telemetria in un paziente con cardiopatia ischemica, mentre guardava la televisione.](https://i.imgur.com/zoc7GpD.png)
	- l'uso a lungo termine di ==timololo==, ==propanololo== o ==metoprololo== in pazienti che hanno avuto un infarto può prolungare la sopravvivenza
		- ![Farmaci antagonisti sui recettori adrenergici: effetti della terapia con un $\beta$-bloccante sul tasso cumulativo di mortalità dovuta a tutte le cause.](https://i.imgur.com/SEzY3Gy.png)
...
- Se ne conoscono due tipi principali:
	...
	- ==angolo chiuso==: camera anteriore di dimensioni ridotte, in cui un'iride dilatata può occludere le vie di drenaggio
...
>[!warning]
>Dal momento che alcune azioni di un $\beta$-agonista possono dipendere da meccanismi diversi dal blocco dei recettori $\beta$, non è bene considerare questi farmaci come intercambiabili per ogni tipo di applicazione clinica.
