...
#### Omocisteina
> Aminoacido solforato che deriva dalla demetilazione della metionina
...
- ![](https://i.imgur.com/t7RtUUe.png)
 - ![](https://i.imgur.com/iOjYdAK.png)
...
- Associata ad aterosclerosi e patologia cardiovascolare
	...
	- Diminuisce l'efficienza del sistema fibrinolitico
#### Indici di funzione fibrinolitica 
##### PAI-1
- Principale inibitore del sistema fibrinolitico
	- impedisce la conversione di *plasminogeno* in *plasmina*
	- ![Sistema fibrinolitico](https://i.imgur.com/1Obsumz.png)
![](https://i.imgur.com/ytJkz78.png)
##### D-dimero
![](https://i.imgur.com/IBqAm1Z.png)
#### Indici di infiammazione
##### PCR
- Fortemente aspecifica
	- non risulta molto elevata nelle malattie infiammatorie
	- aumenta in maniera spropositata nei processi infiammatori di natura batterica
...
- Nei soggetti in cui si sospetta un evento lesivo
	- [CK-MB] > 6 microg/dL
	- CK-MB/CK tot > 2,5
##### Mioglobina
###### Tempistiche
...
- Durata 7g
##### Miosina
- Catene MLC (isoforme alfa e beta nel miocardio)
	- Durata 10gg
- MLC1 - MLC2
	- Durata 14 gg
##### AST/GOT
