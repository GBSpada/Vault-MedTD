...
- NO preferenza sessuale
	- però è diagnosticata due-tre volte più comunemente nelle donne
		- forse le mestruazioni aumentano il fabbisogno di ferro e vitamine (?)
...
- Sierologia positiva
- NO atrofia dei villi
#### Malattia celiaca sintomatica
- Spesso associata a
	- ==anemia==
	- ==diarrea cronica==
	- ==meteorismo==
	- affaticamento cronico
### Malattia celiaca pediatrica
- Colpisce allo stesso modo bambini e bambine
- Presentazione
	- malassorbimento
	- sintomi atipici
		- coinvolgono quasi tutti gli organi
#### Sintomi classici
- Insorgenza tra i 6 e i 24 mesi
	- a seguito dell'introduzione del glutine nella dieta
- Sintomi
	- irritabilità
	- meteorismo
	- ==anoressia==
...
- Si palesa più avanti nel tempo
- Sintomi
	- ==dolore addominale==
	- nausea
	- vomito
...
- Caratteristica lesione cutanea bollosa e pruriginosa
- Presente fino al 10% dei pazienti
...
- ![Malattia celiaca, meccanismi patogenetici: la gliadina viene processata dall’enzima transglutaminasi con formazione di neoepitopi; questi vengono presentati dalle molecole HLA al T-cell receptor, attivando la risposta immunitaria e causando il danno degli enterociti](https://i.imgur.com/PLXBWWt.png)
### Malattie virali
...
## Caratteristiche cliniche
- Quadro clinico estremamente variegato
### Sintomi tipici
- Diarrea
- Perdita di peso
