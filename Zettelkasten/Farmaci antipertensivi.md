...
- La *vasopressina* rilasciata dalla post-ipofisi svolge un ruolo nel mantenimento pressorio attraverso la capacità di ==regolare l'assorbimento di acqua da parte del rene==
...
- Studi indicano che la regolazione normale della pressione debba coinvolgere i **neuroni centrali adrenergici**, che modulano i riflessi barorecettoriali
	- i farmaci si legano sia ai recettori adrenergici $\alpha_{2a}$[^5] che a quelli $\alpha_1$
	- potrebbero agire anche
		- sull'encefalo, riducendo il rilascio di NE a livello di siti recettoriali correlati
		- direttamente a livello degli $\alpha_2$-adrenocettori postsinaptici
- Il ==guanabenz== e la ==guanfacina== condividono gli effetti stimolanti centrali $\alpha$-adrenergici posseduti dalla clonidina, ma non sembrano offrire vantaggi rispetto ad essa e sono usati di rado
### $\alpha$-metildopa
>*L-α-metil-3,4-diidrossi-fenilalanina*
- Analogo della *L-dopa*, viene trasformato in *α-metil-dopamina* e *α-metil-noradrenalina* (via metabolica direttamente parallela a [[Introduzione alla farmacologia del sistema nervoso autonomo#Sintesi adrenergica|questa]]):
	1. l'*α-metil-noradrenalina* viene immagazzinata nei granuli adrenergici delle terminazioni nervose, dove stechiometricamente rimpiazza la NE
	2. viene liberata in seguito a stimolazione nervosa per interagire coi recettori adrenergici postsinaptici
- La sostituzione della NE con un falso neurotrasmettitore nei neuroni periferici **non** è responsabile dell'effetto antipertensivo: risulta essere un **valido antagonista**
	- l'azione antipertensiva sembra essere dovuta a ==stimolazione dei recettori centrali α-adrenergici==
#### Utilità clinica
- Largamente impiegata in passato, ma attualmente soprattutto per l'*ipertensione durante la gravidanza*
	- utile nel trattamento dell'ipertensione sia lieve che moderatamente grave
	- abbassa la pressione arteriosa per ==riduzione delle resistenze vascolari periferiche==, con riduzioni variabili della frequenza e della gittata cardiaca
		- risulta un potenziale vantaggio la riduzione delle resistenze vascolari renali
- La massima parte dei riflessi cardiovascolari rimane immodificata dopo la sua somministrazione e la riduzione della pressione arteriosa non risulta significativamente dipendente dalla postura
	- talvolta può verificarsi **ipotensione posturale** (**ortostatica**), specialmente nei pazienti con ridotto volume ematico circolante
- ![α-Metildopa, struttura chimica.](https://i.imgur.com/bBbNiu7.png)
#### Farmacocinetica e posologia
- Entra nel cervello attraverso un *trasportatore di amminoacidi aromatici*
- Dose orale → max effetto in 4-6h (può persistere fino a 24h)
	- dipende dall'accumulo e dal deposito dell'α-metil-noradrenalina nelle vescicole terminali nervose, per cui l'azione persiste anche dopo la sua scomparsa dalla circolazione
#### Tossicità
>La sospensione del farmaco elimina prontamente gli effetti indesiderati.
- Il più comune effetto indesiderato è una **marcata sedazione**
	- nei trattamenti di lunga durata, i pazienti possono lamentare *stanchezza mentale persistente* e *difficoltà nella concentrazione*
	- si possono anche verificare *incubi*, *depressione psichica*, *vertigini*, *segni extrapiramidali*
		- probabilmente per inibizione dei meccanismi dopaminergici ipotalamici
- Sviluppo di un **test di Coombs positivo**[^6]
	- 10-20% dei pazienti sottoposti a terapia per più di 12 mesi
	- di rado associato ad anemia emolitica, epatite o febbre da fieno
### Clonidina
- Derivato 2-imidazolinico, scoperta nel corso di ricerche per trovare un farmaco da impiegare per un uso locale come decongestionante nasale
- Somministrata per IV, provoca ==iniziale aumento pressorio==, cui fa seguito un ==più prolungato effetto ipotensivo==
	- stimolazione α-agonista a livello bulbare
	- ==riduzione del tono simpatico e aumento di quello parasimpatico==, cui conseguono abbassamento della pressione arteriosa e diminuzione della frequenza cardiaca
	- in sostanza, **sensibilizza** i centri pressori all'azione inibitoria dei barorecettori
- Si lega anche ad altri siti di tipo non adrenergico (es. *recettore imidazolinico*)
	- potrebbero modularne ulteriormente l'attività antipertensiva
#### Utilità clinica
...
>[!warning]
>Poiché, per l'attività ipotensiva della guanetidina, è necessaria la sua captazione neuronale, farmaci bloccanti il processo di captazione catecolaminergico o spiazzanti le ammine dai terminali nervosi **ne bloccano la captazione e gli effetti** (es. ==cocaina==, ==antidepressivi triciclici==, ==fenotiazine==, ==fenossibenzamina==).
##### Farmacocinetica e posologia
- $t_{1/2}$ ≈ 5 gg
...
#### Nadololo, carteololo, betaxololo e bisoprololo
##### Farmacocinetica
- Nadololo e carteololo, antagonisti $\beta$-adrenergici non selettivi
	- non vengono metabolizzati in misura apprezzabile
	- vengono escreti in quantità considerevole con le urine
- Betaxololo e bisoprololo sono bloccanti $\beta_1$-selettivi
	- ma hanno lunga $t_{1/2}$ plasmatica e biologica
	- possono essere somministrati una sola volta al giorno
##### Posologia
- Dosi iniziali per il trattamento:
	- nadololo → 40 mg/die
	- carteololo → 2,5 mg/die
	- betaxololo → 10 mg/die
	- bisoprololo → 5 mg/die
- L'aumento delle dosi, al fine di ottenere una soddisfacente risposta terapeutica, dovrebbe effettuarsi ad intervalli di tempo non più frequenti di 4-5 gg
	- pazienti con funzionalità renale ridotta dovrebbero ricevere dosi proporzionalmente ridotte di nadololo e carteololo
#### Pindololo, acebutololo e penbutololo
- $\beta$-bloccanti con attività simpaticomimetica intrinseca:
	- abbassano la $p_{arteriosa}$ diminuendo le resistenze vascolari
	- deprimono la gittata o la frequenza cardiaca meno di altri $\beta$-bloccanti[^8]
- Utili nel trattamento di pazienti con bradiaritmia o disturbi vascolari periferici, che deve iniziare con
	- pindololo → 10 mg/die
	- acebutololo → 400 mg/die
	- penbutololo → 20 mg/die
#### Labetalolo, carvedilolo e nebivololo
##### Labetalolo
###### Chimica
- Formulato come miscela racemica di 4 isomeri:
	- due (isomeri S,S e R,S) sono inattivi
	- un terzo (S,R)- è un potente $\alpha$-bloccante
	- l'ultimo (R,R)- è un potente $\beta$-bloccante
- Post somministrazione orale, il blocco dei recettori $\beta$ : $\alpha$ è in rapporto 3 : 1
###### Utilità clinica
- La pressione arteriosa risulta diminuita per ==riduzione delle resistenze vascolari periferiche==, senza significative modifiche della frequenza e della gittata cardiache
- A causa della sua attività bloccante $\alpha$ e $\beta$, risulta utile in
	- trattamento dell'ipertensione da [[feocromocitoma]]
	- emergenze ipertensive → somministrazione per IV in bolo, a dosi anche ripetute di 20-80 mg
- Dosi giornaliere per os: 200 < x < 2400 mg/die
##### Carvedilolo
###### Chimica
- Somministrato come miscela racemica
	- isomero S(-) = bloccante non selettivo dei recettori $\beta$-adrenergici
	- sia l'isomero S(-) che quello R(+) hanno eguale potenza nel bloccare i recettori $\alpha$-adrenergici
###### Farmacocinetica
- Gl'isomeri sono metabolizzati nel fegato in maniera stereoselettiva: le loro $t_{1/2}$ di eliminazione possono differire l'una dall'altra
- $t_{1/2media}$ = 7-10h
- Dosaggio iniziale per l'ipertensione: 6,25 mg due volte al dì
	- può esser raggiunta gradualmente, se necessaria, una posologia di 50 mg al dì frazionati in due prese
###### Utilità clinica
- Riduce la mortalità in pazienti con insufficienza cardiaca
- Particolarmente utile nei pazienti presentanti contemporaneamente insufficienza cardiaca ed ipertensione
##### Nebivololo
- Bloccante $\beta_1$-selettivo con proprietà vasodilatatrici (*non* mediate da proprietà $\alpha$-bloccanti)
###### Meccanismo d'azione
- Differenza tra i due isomeri
	- ==D-nebivololo== → effetti bloccanti selettivi $\beta_1$
	- ==L-nebivololo== → effetto vasodilatatore per stimolazione dell'eNOS e rilascio di [[ossido nitrico]]
- Gli effetti emodinamici differiscono da quelli dei β-bloccanti puri: ==riduzione acuta della resistenza vascolare periferica==
###### Farmacocinetica
- Largamente metabolizzato ed ha metaboliti attivi
- $t_{1/2}$ = 10-12 h
###### Posologia
- Può essere somministrato una volta al giorno:
	- si inizia con una posologia di 5 mg al dì
	- può essere gradualmente portata a 40 mg, se necessario
###### Efficacia clinica
- L'efficacia è simile a quella di altri antipertensivi, ma diversi studi indicano minori effetti collaterali
#### Esmololo
- $\beta_1$-bloccante selettivo rapidamente metabolizzato per idrolisi da *esterasi delle emazie*
- $t_{1/2}$ breve (9-10 min)
- Somministrato per infusione IV:
	1. inizia con una [[Farmacocinetica e farmacodinamica#La dose di carico|dose di carico]] di 0,5-1 mg/kg
	2. si prosegue con dosi di 50-150 $\mu$g/kg/min
	3. si aumenta la dose ogni 5 min fino a 300 $\mu$g/kg/min
- Impiegato per il trattamento dell'ipertensione intra- e postoperatoria e, talora, per le emergenze ipertensive, specie quando l'ipertensione sia associata a tachicardia
### Prazosina ed altri $\alpha$-bloccanti
#### Meccanismo e siti d'azione
##### Farmaci e meccanismi d'azione
- ==Prazosina==, ==terazosina== e ==doxazosina== esplicano la maggior parte dei loro effetti bloccando i recettori $\alpha_1$-adrenergici delle arteriole e delle venule
	- selettività = minore tachicardia riflessa rispetto a quelli non selettivi
	- la selettività permette alla NE di esplicare senza ostacoli una retroinibizione (mediata da recettori $\alpha_2$-presinaptici) sul proprio rilascio
- ==Fentolamina==: blocca i recettori $\alpha$ pre- e post-sinaptici:
	1. la stimolazione riflessa dei neuroni simpatici determina (per l'ipotensione indotta) un maggiore rilascio di trasmettitore a livello dei $\beta$-recettori
	2. si ha conseguente ==cardioaccelerazione più marcata== ($\beta_1$-mediata)
##### Effetti
- Riduzione della pressione arteriosa dilatando sia i vasi di resistenza che quelli di capacitanza
	- ne consegue una **riduzione della pressione arteriosa maggiore nella posizione eretta che in quella supina**
- **Ritenzione idrica e salina** si verifica quando vengono somministrati senza [[Diuretici|diuretico]]
	- chiaramente più efficaci in associazione a diuretici o $\beta$-bloccanti che da soli
##### Nella prostata
- Impiegati in primo luogo in pazienti con contemporanee *ipertensione ed iperplasia prostatica benigna*
#### Farmacocinetica e posologia
##### Farmacocinetica
- Per la prazosina vedere la [[Farmaci antipertensivi#Farmacologia di base dei farmaci antipertensivi|tabella]]
- La ==terazosina==[^9] è anche intensamente metabolizzata, ma con minore effetto di primo passaggio epatico e con $t_{1/2}$ = 12h
- La ==doxazosina== ha una biodisponibilità intermedia, con $t_{1/2}$ = 22h
##### Somministrazione
- ==Terazosina==: somministrazione una volta al giorno con dosi gradualmente crescenti, fino a un massimo di 5-20 mg/die
...
#### Azioni sfavorevoli
- Le principali sono **tachicardia riflessa**, **cefalea**, **caldane**
- Aumenta la pressione intraoculare e dovrebbe essere evitato in pazienti con [[glaucoma]]
### [[Farmaci bloccanti i canali del calcio#Come antipertensivi|Bloccanti i canali del calcio]]
# [[Inibitori dell'angiotensina]]
# Farmacologia clinica dei farmaci antipertensivi
## Diagnosi
### Accertamento
- L'ipertensione rappresenta un problema particolare per la terapia:
	- di norma **dura tutta la vita** e **la sintomatologia è di scarso rilievo** (almeno fino a uno stadio avanzato)
	- per un efficace trattamento, si devono assumere ogni giorno medicine di alto costo e che, spesso, inducono effetti indesiderati
>[!info]
>- Il medico deve stabilire con certezza che l'ipertensione sia persistente e richieda un trattamento:
>	- ==vanno escluse cause secondarie== che potrebbero essere trattate mediante intervento;
>	- l'==esistenza== di uno stato ipotensivo dev'essere ==accertata== mediante rilevazioni dello stato pressorio ==in almeno 3 differenti visite ambulatoriali==
>- Il controllo ambulatoriale della pressione può rappresentare il miglior indice predittivo del rischio e, conseguentemente, della necessità di un'eventuale terapia.
### Approccio al paziente
1. Una volta accertata l'esistenza, bisogna decidere il trattamento, prendendo in considerazione
	- età
	- sesso del paziente
	- gravità di eventuali danni ad organi dovuti all'elevata pressione arteriosa
	- fattori di rischio cardiovascolare
	- funzione renale e presenza di proteinuria
2. Il paziente dev'essere edotto sulla natura dell'ipertensione e sull'importanza del trattamento (consenso informato alla terapia)
3. Bisogna mettere a punto un programma terapeutico sulla base del livello della pressione arteriosa e della presenza e gravità di danni ad organi terminali
	- forme gravi → ==trattamento rapido==
	- ipertensione essenziale, con pressione alta da mesi o anni → ==approccio graduale==
>[!warning]- Approcci che non dovrebbero mai mancare
>- Informazione sull'evoluzione naturale dell'ipertensione e sull'importanza dell'aderenza al trattamento, così come sui possibili effetti collaterali.
>- Dovrebbe essere trattata l'obesità e dovrebbero essere eliminati farmaci che aumentano la pressione arteriosa[^10].
>- Visite successive di controllo dovrebbero essere abbastanza frequenti da convincere il paziente che il medico ritiene seria la sua malattia. In ognuna di queste, dovrebbe essere sottolineata l'importanza del trattamento e stimolata la discussione sul dosaggio o sugli effetti collaterali.
## Terapia dell'ipertensione nel paziente ambulatoriale
### Stile di vita
1. Restrizione del sodio nella dieta:
	- dieta media americana (ciccioni schifosi) → 200 mEq giornalieri
	- obiettivo → 70-100 mEq giornalieri
2. Diminuzione del peso corporeo: ha portato a normalizzazione pressoria fino al 75% dei pazienti
3. Regolare esercizio fisico
### Controllo farmacologico
#### Monofarmacoterapia
- Se di grado lieve, si può ricorrere tranquillamente alla monofarmacoterapia
	- diuretici tiazidici, $\beta$-bloccanti, ACE-inibitori, antagonisti ai recettori dell'AT, $Ca^{2+}$-antagonisti
...
- Diuretici come la ==furosemide== vanno somministrati per prevenire l'espansione del volume ematico (tipica durante la somministrazione di potenti vasodilatatori)
# Sommario
